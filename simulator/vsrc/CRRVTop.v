...
module FetchStage(	// @[<stdin>:183:10]
  ...
  always @(posedge clock) begin	// @[<stdin>:184:11]
    if (reset)	// @[<stdin>:184:11]
      pc <= 32'h80000000;	// @[CRRV/src/core/pipeline/FetchStage.scala:17:20]
...
module SimpleArbiter(	// @[<stdin>:2845:10]
  ...
  assign io_simpleInst_out_ready = _io_simpleInst_out_ready_output;	// @[<stdin>:2845:10, CRRV/src/bus/SimpleArbiter.scala:49:38]
  assign io_simpleInst_in_rdata = io_simpleOut_in_rdata;	// @[<stdin>:2845:10]
  assign io_simpleData_out_ready = _io_simpleData_out_ready_output;	// @[<stdin>:2845:10, CRRV/src/bus/SimpleArbiter.scala:52:38]
  assign io_simpleData_in_rdata = io_simpleOut_in_rdata;	// @[<stdin>:2845:10]
  assign io_simpleOut_out_valid = _io_simpleOut_out_valid_T | _io_simpleOut_out_valid_T_1;	// @[<stdin>:2845:10, CRRV/src/bus/SimpleArbiter.scala:46:24, :47:24, :55:52]
  assign io_simpleOut_out_bits_addr =
    selData ? io_simpleData_out_bits_addr : io_simpleInst_out_bits_addr;	// @[<stdin>:2845:10, CRRV/src/bus/SimpleArbiter.scala:47:35, :57:39]
  assign io_simpleOut_out_bits_writeEn = selData & io_simpleData_out_bits_writeEn;	// @[<stdin>:2845:10, CRRV/src/bus/SimpleArbiter.scala:47:35, :58:39]
  assign io_simpleOut_out_bits_size = selData ? io_simpleData_out_bits_size : 2'h2;	// @[<stdin>:2845:10, CRRV/src/bus/SimpleArbiter.scala:13:14, :47:35, :56:39]
  assign io_simpleOut_out_bits_wdata = selData ? io_simpleData_out_bits_wdata : 32'h0;	// @[<stdin>:2845:10, CRRV/src/bus/SimpleArbiter.scala:13:14, :47:35, :59:39]
endmodule

module SimpleMux2(	// @[<stdin>:2904:10]
  input         clock,	// @[<stdin>:2905:11]
  ...
  always @(posedge clock)	// @[<stdin>:2905:11]
    readSel <= io_sel2;	// @[CRRV/src/bus/SimpleUtils.scala:16:24]
  assign io_in_out_ready = io_sel2 | io_out1_out_ready;	// @[<stdin>:2904:10, CRRV/src/bus/SimpleUtils.scala:20:25]
  assign io_in_in_rdata = readSel ? io_out2_in_rdata : io_out1_in_rdata;	// @[<stdin>:2904:10, CRRV/src/bus/SimpleUtils.scala:16:24, :18:24]
  assign io_out1_out_valid = io_in_out_valid & ~io_sel2;	// @[<stdin>:2904:10, CRRV/src/bus/SimpleUtils.scala:22:{40,43}]
  assign io_out1_out_bits_addr = io_in_out_bits_addr;	// @[<stdin>:2904:10]
  assign io_out1_out_bits_writeEn = io_in_out_bits_writeEn;	// @[<stdin>:2904:10]
  assign io_out1_out_bits_size = io_in_out_bits_size;	// @[<stdin>:2904:10]
  assign io_out1_out_bits_wdata = io_in_out_bits_wdata;	// @[<stdin>:2904:10]
  assign io_out2_out_valid = io_in_out_valid & io_sel2;	// @[<stdin>:2904:10, CRRV/src/bus/SimpleUtils.scala:25:40]
  assign io_out2_out_bits_addr = io_in_out_bits_addr;	// @[<stdin>:2904:10]
  assign io_out2_out_bits_writeEn = io_in_out_bits_writeEn;	// @[<stdin>:2904:10]
  assign io_out2_out_bits_wdata = io_in_out_bits_wdata;	// @[<stdin>:2904:10]
endmodule

module SimpleXbar(	// @[<stdin>:2924:10]
  input         clock,	// @[<stdin>:2925:11]
...
module CLINT(	// @[<stdin>:2945:10]
  input         clock,	// @[<stdin>:2946:11]
                reset,	// @[<stdin>:2947:11]
  ...
  always @(posedge clock) begin	// @[<stdin>:2946:11]
    if (reset) begin	// @[<stdin>:2946:11]
  ...
  assign io_core_in_rdata = outputData;	// @[<stdin>:2945:10, CRRV/src/bus/CLINT.scala:37:27]
  assign io_intr = (|timermatch) & mtime >= timermatch;	// @[<stdin>:2945:10, CRRV/src/bus/CLINT.scala:21:28, :24:24, :48:{33,42,52}]
endmodule

module SimpleAlignment(	// @[<stdin>:2997:10]
  input         clock,	// @[<stdin>:2998:11]
                reset,	// @[<stdin>:2999:11]
  ...
  always @(posedge clock) begin	// @[<stdin>:2998:11]
    if (reset) begin	// @[<stdin>:2998:11]
  ...
  assign io_in_out_ready = direct ? io_out_out_ready : state == 3'h3;	// @[<stdin>:2997:10, CRRV/src/bus/SimpleAlignment.scala:24:42, :35:36, :60:15, :84:{26,59}]
  assign io_in_in_rdata =
    direct ? io_out_in_rdata >> {27'h0, lastRaddr[1:0], 3'h0} : nowRdata;	// @[<stdin>:2997:10, CRRV/src/bus/SimpleAlignment.scala:18:26, :20:{35,42,52}, :31:42, :35:36, :81:24]
  assign io_out_out_valid = direct ? io_in_out_valid : nowValid;	// @[<stdin>:2997:10, CRRV/src/bus/SimpleAlignment.scala:27:42, :35:36, :83:26]
  assign io_out_out_bits_addr = direct ? io_in_out_bits_addr : nowAddr;	// @[<stdin>:2997:10, CRRV/src/bus/SimpleAlignment.scala:28:42, :35:36, :85:26]
  assign io_out_out_bits_writeEn = direct ? io_in_out_bits_writeEn : nowWen;	// @[<stdin>:2997:10, CRRV/src/bus/SimpleAlignment.scala:29:42, :35:36, :87:26]
  assign io_out_out_bits_size = direct ? io_in_out_bits_size : 2'h0;	// @[<stdin>:2997:10, CRRV/src/bus/SimpleAlignment.scala:35:36, :86:26]
  assign io_out_out_bits_wdata = direct ? io_in_out_bits_wdata : nowWdata;	// @[<stdin>:2997:10, CRRV/src/bus/SimpleAlignment.scala:30:42, :35:36, :88:26]
endmodule

// external module Debug

// external module SimMemory

module CRRVTop(	// @[<stdin>:3121:10]
  input clock,	// @[<stdin>:3122:11]
        reset	// @[<stdin>:3123:11]
);

  wire        _mem_simple_out_ready;	// @[CRRV/src/CRRVTop.scala:100:21]
  wire [31:0] _mem_simple_in_rdata;	// @[CRRV/src/CRRVTop.scala:100:21]
  wire        _simpleAlignment_io_in_out_ready;	// @[CRRV/src/CRRVTop.scala:97:33]
  wire [31:0] _simpleAlignment_io_in_in_rdata;	// @[CRRV/src/CRRVTop.scala:97:33]
  wire        _simpleAlignment_io_out_out_valid;	// @[CRRV/src/CRRVTop.scala:97:33]
  wire [31:0] _simpleAlignment_io_out_out_bits_addr;	// @[CRRV/src/CRRVTop.scala:97:33]
  wire        _simpleAlignment_io_out_out_bits_writeEn;	// @[CRRV/src/CRRVTop.scala:97:33]
  wire [1:0]  _simpleAlignment_io_out_out_bits_size;	// @[CRRV/src/CRRVTop.scala:97:33]
  wire [31:0] _simpleAlignment_io_out_out_bits_wdata;	// @[CRRV/src/CRRVTop.scala:97:33]
  wire [31:0] _clint_io_core_in_rdata;	// @[CRRV/src/CRRVTop.scala:96:33]
  wire        _clint_io_intr;	// @[CRRV/src/CRRVTop.scala:96:33]
  wire        _xbar_io_simpleIn_out_ready;	// @[CRRV/src/CRRVTop.scala:95:33]
  wire [31:0] _xbar_io_simpleIn_in_rdata;	// @[CRRV/src/CRRVTop.scala:95:33]
  wire        _xbar_io_simpleOut_out_valid;	// @[CRRV/src/CRRVTop.scala:95:33]
  wire [31:0] _xbar_io_simpleOut_out_bits_addr;	// @[CRRV/src/CRRVTop.scala:95:33]
  wire        _xbar_io_simpleOut_out_bits_writeEn;	// @[CRRV/src/CRRVTop.scala:95:33]
  wire [1:0]  _xbar_io_simpleOut_out_bits_size;	// @[CRRV/src/CRRVTop.scala:95:33]
  wire [31:0] _xbar_io_simpleOut_out_bits_wdata;	// @[CRRV/src/CRRVTop.scala:95:33]
  wire        _xbar_io_simpleCLINT_out_valid;	// @[CRRV/src/CRRVTop.scala:95:33]
  wire [31:0] _xbar_io_simpleCLINT_out_bits_addr;	// @[CRRV/src/CRRVTop.scala:95:33]
  wire        _xbar_io_simpleCLINT_out_bits_writeEn;	// @[CRRV/src/CRRVTop.scala:95:33]
  wire [31:0] _xbar_io_simpleCLINT_out_bits_wdata;	// @[CRRV/src/CRRVTop.scala:95:33]
  wire        _arbiter_io_simpleInst_out_ready;	// @[CRRV/src/CRRVTop.scala:94:33]
  wire [31:0] _arbiter_io_simpleInst_in_rdata;	// @[CRRV/src/CRRVTop.scala:94:33]
  wire        _arbiter_io_simpleData_out_ready;	// @[CRRV/src/CRRVTop.scala:94:33]
  wire [31:0] _arbiter_io_simpleData_in_rdata;	// @[CRRV/src/CRRVTop.scala:94:33]
  wire        _arbiter_io_simpleOut_out_valid;	// @[CRRV/src/CRRVTop.scala:94:33]
  wire [31:0] _arbiter_io_simpleOut_out_bits_addr;	// @[CRRV/src/CRRVTop.scala:94:33]
  wire        _arbiter_io_simpleOut_out_bits_writeEn;	// @[CRRV/src/CRRVTop.scala:94:33]
  wire [1:0]  _arbiter_io_simpleOut_out_bits_size;	// @[CRRV/src/CRRVTop.scala:94:33]
  wire [31:0] _arbiter_io_simpleOut_out_bits_wdata;	// @[CRRV/src/CRRVTop.scala:94:33]
  wire [31:0] _core_io_inst_out_bits_addr;	// @[CRRV/src/CRRVTop.scala:93:33]
  wire        _core_io_data_out_valid;	// @[CRRV/src/CRRVTop.scala:93:33]
  wire [31:0] _core_io_data_out_bits_addr;	// @[CRRV/src/CRRVTop.scala:93:33]
  wire        _core_io_data_out_bits_writeEn;	// @[CRRV/src/CRRVTop.scala:93:33]
  wire [1:0]  _core_io_data_out_bits_size;	// @[CRRV/src/CRRVTop.scala:93:33]
  wire [31:0] _core_io_data_out_bits_wdata;	// @[CRRV/src/CRRVTop.scala:93:33]
  wire        _core_io_debug_debugInfo_valid;	// @[CRRV/src/CRRVTop.scala:93:33]
  wire        _core_io_debug_debugInfo_halt;	// @[CRRV/src/CRRVTop.scala:93:33]
  wire        _core_io_debug_debugInfo_deviceAccess;	// @[CRRV/src/CRRVTop.scala:93:33]
  wire [31:0] _core_io_debug_debugInfo_deviceAddr;	// @[CRRV/src/CRRVTop.scala:93:33]
  wire [31:0] _core_io_debug_debugInfo_pc;	// @[CRRV/src/CRRVTop.scala:93:33]
  wire [31:0] _core_io_debug_regs_regs_0;	// @[CRRV/src/CRRVTop.scala:93:33]
  wire [31:0] _core_io_debug_regs_regs_1;	// @[CRRV/src/CRRVTop.scala:93:33]
  wire [31:0] _core_io_debug_regs_regs_2;	// @[CRRV/src/CRRVTop.scala:93:33]
  wire [31:0] _core_io_debug_regs_regs_3;	// @[CRRV/src/CRRVTop.scala:93:33]
  wire [31:0] _core_io_debug_regs_regs_4;	// @[CRRV/src/CRRVTop.scala:93:33]
  wire [31:0] _core_io_debug_regs_regs_5;	// @[CRRV/src/CRRVTop.scala:93:33]
  wire [31:0] _core_io_debug_regs_regs_6;	// @[CRRV/src/CRRVTop.scala:93:33]
  wire [31:0] _core_io_debug_regs_regs_7;	// @[CRRV/src/CRRVTop.scala:93:33]
  wire [31:0] _core_io_debug_regs_regs_8;	// @[CRRV/src/CRRVTop.scala:93:33]
  wire [31:0] _core_io_debug_regs_regs_9;	// @[CRRV/src/CRRVTop.scala:93:33]
  wire [31:0] _core_io_debug_regs_regs_10;	// @[CRRV/src/CRRVTop.scala:93:33]
  wire [31:0] _core_io_debug_regs_regs_11;	// @[CRRV/src/CRRVTop.scala:93:33]
  wire [31:0] _core_io_debug_regs_regs_12;	// @[CRRV/src/CRRVTop.scala:93:33]
  wire [31:0] _core_io_debug_regs_regs_13;	// @[CRRV/src/CRRVTop.scala:93:33]
  wire [31:0] _core_io_debug_regs_regs_14;	// @[CRRV/src/CRRVTop.scala:93:33]
  wire [31:0] _core_io_debug_regs_regs_15;	// @[CRRV/src/CRRVTop.scala:93:33]
  wire [31:0] _core_io_debug_regs_regs_16;	// @[CRRV/src/CRRVTop.scala:93:33]
  wire [31:0] _core_io_debug_regs_regs_17;	// @[CRRV/src/CRRVTop.scala:93:33]
  wire [31:0] _core_io_debug_regs_regs_18;	// @[CRRV/src/CRRVTop.scala:93:33]
  wire [31:0] _core_io_debug_regs_regs_19;	// @[CRRV/src/CRRVTop.scala:93:33]
  wire [31:0] _core_io_debug_regs_regs_20;	// @[CRRV/src/CRRVTop.scala:93:33]
  wire [31:0] _core_io_debug_regs_regs_21;	// @[CRRV/src/CRRVTop.scala:93:33]
  wire [31:0] _core_io_debug_regs_regs_22;	// @[CRRV/src/CRRVTop.scala:93:33]
  wire [31:0] _core_io_debug_regs_regs_23;	// @[CRRV/src/CRRVTop.scala:93:33]
  wire [31:0] _core_io_debug_regs_regs_24;	// @[CRRV/src/CRRVTop.scala:93:33]
  wire [31:0] _core_io_debug_regs_regs_25;	// @[CRRV/src/CRRVTop.scala:93:33]
  wire [31:0] _core_io_debug_regs_regs_26;	// @[CRRV/src/CRRVTop.scala:93:33]
  wire [31:0] _core_io_debug_regs_regs_27;	// @[CRRV/src/CRRVTop.scala:93:33]
  wire [31:0] _core_io_debug_regs_regs_28;	// @[CRRV/src/CRRVTop.scala:93:33]
  wire [31:0] _core_io_debug_regs_regs_29;	// @[CRRV/src/CRRVTop.scala:93:33]
  wire [31:0] _core_io_debug_regs_regs_30;	// @[CRRV/src/CRRVTop.scala:93:33]
  wire [31:0] _core_io_debug_regs_regs_31;	// @[CRRV/src/CRRVTop.scala:93:33]
  wire [31:0] _core_io_debug_csr_mstatus;	// @[CRRV/src/CRRVTop.scala:93:33]
  wire [31:0] _core_io_debug_csr_mcause;	// @[CRRV/src/CRRVTop.scala:93:33]
  wire [31:0] _core_io_debug_csr_mtvec;	// @[CRRV/src/CRRVTop.scala:93:33]
  wire [31:0] _core_io_debug_csr_mepc;	// @[CRRV/src/CRRVTop.scala:93:33]
  wire [31:0] _core_io_debug_csr_mscratch;	// @[CRRV/src/CRRVTop.scala:93:33]
  wire [31:0] _core_io_debug_csr_mie;	// @[CRRV/src/CRRVTop.scala:93:33]
  wire [31:0] _core_io_debug_csr_mip;	// @[CRRV/src/CRRVTop.scala:93:33]
  wire [31:0] _core_io_debug_csr_mtval;	// @[CRRV/src/CRRVTop.scala:93:33]
  wire        _core_io_debug_intr;	// @[CRRV/src/CRRVTop.scala:93:33]
  Core core (	// @[CRRV/src/CRRVTop.scala:93:33]
    .clock                           (clock),
    .reset                           (reset),
    .io_inst_out_ready               (_arbiter_io_simpleInst_out_ready),	// @[CRRV/src/CRRVTop.scala:94:33]
    .io_inst_in_rdata                (_arbiter_io_simpleInst_in_rdata),	// @[CRRV/src/CRRVTop.scala:94:33]
    .io_data_out_ready               (_simpleAlignment_io_in_out_ready),	// @[CRRV/src/CRRVTop.scala:97:33]
    .io_data_in_rdata                (_simpleAlignment_io_in_in_rdata),	// @[CRRV/src/CRRVTop.scala:97:33]
    .io_intr_timer                   (_clint_io_intr),	// @[CRRV/src/CRRVTop.scala:96:33]
  ...
  SimpleArbiter arbiter (	// @[CRRV/src/CRRVTop.scala:94:33]
    .clock                          (clock),
    .reset                          (reset),
    .io_simpleInst_out_bits_addr    (_core_io_inst_out_bits_addr),	// @[CRRV/src/CRRVTop.scala:93:33]
    .io_simpleData_out_valid        (_xbar_io_simpleOut_out_valid),	// @[CRRV/src/CRRVTop.scala:95:33]
    .io_simpleData_out_bits_addr    (_xbar_io_simpleOut_out_bits_addr),	// @[CRRV/src/CRRVTop.scala:95:33]
    .io_simpleData_out_bits_writeEn (_xbar_io_simpleOut_out_bits_writeEn),	// @[CRRV/src/CRRVTop.scala:95:33]
    .io_simpleData_out_bits_size    (_xbar_io_simpleOut_out_bits_size),	// @[CRRV/src/CRRVTop.scala:95:33]
    .io_simpleData_out_bits_wdata   (_xbar_io_simpleOut_out_bits_wdata),	// @[CRRV/src/CRRVTop.scala:95:33]
    .io_simpleOut_out_ready         (_mem_simple_out_ready),	// @[CRRV/src/CRRVTop.scala:100:21]
    .io_simpleOut_in_rdata          (_mem_simple_in_rdata),	// @[CRRV/src/CRRVTop.scala:100:21]
  ...
  SimpleXbar xbar (	// @[CRRV/src/CRRVTop.scala:95:33]
    .clock                           (clock),
    .io_simpleIn_out_valid           (_simpleAlignment_io_out_out_valid),	// @[CRRV/src/CRRVTop.scala:97:33]
    .io_simpleIn_out_bits_addr       (_simpleAlignment_io_out_out_bits_addr),	// @[CRRV/src/CRRVTop.scala:97:33]
    .io_simpleIn_out_bits_writeEn    (_simpleAlignment_io_out_out_bits_writeEn),	// @[CRRV/src/CRRVTop.scala:97:33]
    .io_simpleIn_out_bits_size       (_simpleAlignment_io_out_out_bits_size),	// @[CRRV/src/CRRVTop.scala:97:33]
    .io_simpleIn_out_bits_wdata      (_simpleAlignment_io_out_out_bits_wdata),	// @[CRRV/src/CRRVTop.scala:97:33]
    .io_simpleOut_out_ready          (_arbiter_io_simpleData_out_ready),	// @[CRRV/src/CRRVTop.scala:94:33]
    .io_simpleOut_in_rdata           (_arbiter_io_simpleData_in_rdata),	// @[CRRV/src/CRRVTop.scala:94:33]
    .io_simpleCLINT_in_rdata         (_clint_io_core_in_rdata),	// @[CRRV/src/CRRVTop.scala:96:33]
  ...
  CLINT clint (	// @[CRRV/src/CRRVTop.scala:96:33]
    .clock                    (clock),
    .reset                    (reset),
    .io_core_out_valid        (_xbar_io_simpleCLINT_out_valid),	// @[CRRV/src/CRRVTop.scala:95:33]
    .io_core_out_bits_addr    (_xbar_io_simpleCLINT_out_bits_addr),	// @[CRRV/src/CRRVTop.scala:95:33]
    .io_core_out_bits_writeEn (_xbar_io_simpleCLINT_out_bits_writeEn),	// @[CRRV/src/CRRVTop.scala:95:33]
    .io_core_out_bits_wdata   (_xbar_io_simpleCLINT_out_bits_wdata),	// @[CRRV/src/CRRVTop.scala:95:33]
    .io_core_in_rdata         (_clint_io_core_in_rdata),
    .io_intr                  (_clint_io_intr)
  );
  SimpleAlignment simpleAlignment (	// @[CRRV/src/CRRVTop.scala:97:33]
    .clock                   (clock),
    .reset                   (reset),
    .io_in_out_valid         (_core_io_data_out_valid),	// @[CRRV/src/CRRVTop.scala:93:33]
    .io_in_out_bits_addr     (_core_io_data_out_bits_addr),	// @[CRRV/src/CRRVTop.scala:93:33]
    .io_in_out_bits_writeEn  (_core_io_data_out_bits_writeEn),	// @[CRRV/src/CRRVTop.scala:93:33]
    .io_in_out_bits_size     (_core_io_data_out_bits_size),	// @[CRRV/src/CRRVTop.scala:93:33]
    .io_in_out_bits_wdata    (_core_io_data_out_bits_wdata),	// @[CRRV/src/CRRVTop.scala:93:33]
    .io_out_out_ready        (_xbar_io_simpleIn_out_ready),	// @[CRRV/src/CRRVTop.scala:95:33]
    .io_out_in_rdata         (_xbar_io_simpleIn_in_rdata),	// @[CRRV/src/CRRVTop.scala:95:33]
  ...
  Debug debug (	// @[CRRV/src/CRRVTop.scala:98:33]
    .clock                        (clock),
    .reset                        (reset),
    .debug_debugInfo_valid        (_core_io_debug_debugInfo_valid),	// @[CRRV/src/CRRVTop.scala:93:33]
    .debug_debugInfo_halt         (_core_io_debug_debugInfo_halt),	// @[CRRV/src/CRRVTop.scala:93:33]
    .debug_debugInfo_deviceAccess (_core_io_debug_debugInfo_deviceAccess),	// @[CRRV/src/CRRVTop.scala:93:33]
    .debug_debugInfo_deviceAddr   (_core_io_debug_debugInfo_deviceAddr),	// @[CRRV/src/CRRVTop.scala:93:33]
    .debug_debugInfo_pc           (_core_io_debug_debugInfo_pc),	// @[CRRV/src/CRRVTop.scala:93:33]
    .debug_regs_regs_0            (_core_io_debug_regs_regs_0),	// @[CRRV/src/CRRVTop.scala:93:33]
    .debug_regs_regs_1            (_core_io_debug_regs_regs_1),	// @[CRRV/src/CRRVTop.scala:93:33]
    .debug_regs_regs_2            (_core_io_debug_regs_regs_2),	// @[CRRV/src/CRRVTop.scala:93:33]
    .debug_regs_regs_3            (_core_io_debug_regs_regs_3),	// @[CRRV/src/CRRVTop.scala:93:33]
    .debug_regs_regs_4            (_core_io_debug_regs_regs_4),	// @[CRRV/src/CRRVTop.scala:93:33]
    .debug_regs_regs_5            (_core_io_debug_regs_regs_5),	// @[CRRV/src/CRRVTop.scala:93:33]
    .debug_regs_regs_6            (_core_io_debug_regs_regs_6),	// @[CRRV/src/CRRVTop.scala:93:33]
    .debug_regs_regs_7            (_core_io_debug_regs_regs_7),	// @[CRRV/src/CRRVTop.scala:93:33]
    .debug_regs_regs_8            (_core_io_debug_regs_regs_8),	// @[CRRV/src/CRRVTop.scala:93:33]
    .debug_regs_regs_9            (_core_io_debug_regs_regs_9),	// @[CRRV/src/CRRVTop.scala:93:33]
    .debug_regs_regs_10           (_core_io_debug_regs_regs_10),	// @[CRRV/src/CRRVTop.scala:93:33]
    .debug_regs_regs_11           (_core_io_debug_regs_regs_11),	// @[CRRV/src/CRRVTop.scala:93:33]
    .debug_regs_regs_12           (_core_io_debug_regs_regs_12),	// @[CRRV/src/CRRVTop.scala:93:33]
    .debug_regs_regs_13           (_core_io_debug_regs_regs_13),	// @[CRRV/src/CRRVTop.scala:93:33]
    .debug_regs_regs_14           (_core_io_debug_regs_regs_14),	// @[CRRV/src/CRRVTop.scala:93:33]
    .debug_regs_regs_15           (_core_io_debug_regs_regs_15),	// @[CRRV/src/CRRVTop.scala:93:33]
    .debug_regs_regs_16           (_core_io_debug_regs_regs_16),	// @[CRRV/src/CRRVTop.scala:93:33]
    .debug_regs_regs_17           (_core_io_debug_regs_regs_17),	// @[CRRV/src/CRRVTop.scala:93:33]
    .debug_regs_regs_18           (_core_io_debug_regs_regs_18),	// @[CRRV/src/CRRVTop.scala:93:33]
    .debug_regs_regs_19           (_core_io_debug_regs_regs_19),	// @[CRRV/src/CRRVTop.scala:93:33]
    .debug_regs_regs_20           (_core_io_debug_regs_regs_20),	// @[CRRV/src/CRRVTop.scala:93:33]
    .debug_regs_regs_21           (_core_io_debug_regs_regs_21),	// @[CRRV/src/CRRVTop.scala:93:33]
    .debug_regs_regs_22           (_core_io_debug_regs_regs_22),	// @[CRRV/src/CRRVTop.scala:93:33]
    .debug_regs_regs_23           (_core_io_debug_regs_regs_23),	// @[CRRV/src/CRRVTop.scala:93:33]
    .debug_regs_regs_24           (_core_io_debug_regs_regs_24),	// @[CRRV/src/CRRVTop.scala:93:33]
    .debug_regs_regs_25           (_core_io_debug_regs_regs_25),	// @[CRRV/src/CRRVTop.scala:93:33]
    .debug_regs_regs_26           (_core_io_debug_regs_regs_26),	// @[CRRV/src/CRRVTop.scala:93:33]
    .debug_regs_regs_27           (_core_io_debug_regs_regs_27),	// @[CRRV/src/CRRVTop.scala:93:33]
    .debug_regs_regs_28           (_core_io_debug_regs_regs_28),	// @[CRRV/src/CRRVTop.scala:93:33]
    .debug_regs_regs_29           (_core_io_debug_regs_regs_29),	// @[CRRV/src/CRRVTop.scala:93:33]
    .debug_regs_regs_30           (_core_io_debug_regs_regs_30),	// @[CRRV/src/CRRVTop.scala:93:33]
    .debug_regs_regs_31           (_core_io_debug_regs_regs_31),	// @[CRRV/src/CRRVTop.scala:93:33]
    .debug_csr_mstatus            (_core_io_debug_csr_mstatus),	// @[CRRV/src/CRRVTop.scala:93:33]
    .debug_csr_mcause             (_core_io_debug_csr_mcause),	// @[CRRV/src/CRRVTop.scala:93:33]
    .debug_csr_mtvec              (_core_io_debug_csr_mtvec),	// @[CRRV/src/CRRVTop.scala:93:33]
    .debug_csr_mepc               (_core_io_debug_csr_mepc),	// @[CRRV/src/CRRVTop.scala:93:33]
    .debug_csr_mscratch           (_core_io_debug_csr_mscratch),	// @[CRRV/src/CRRVTop.scala:93:33]
    .debug_csr_mie                (_core_io_debug_csr_mie),	// @[CRRV/src/CRRVTop.scala:93:33]
    .debug_csr_mip                (_core_io_debug_csr_mip),	// @[CRRV/src/CRRVTop.scala:93:33]
    .debug_csr_mtval              (_core_io_debug_csr_mtval),	// @[CRRV/src/CRRVTop.scala:93:33]
    .debug_intr                   (_core_io_debug_intr)	// @[CRRV/src/CRRVTop.scala:93:33]
  );
  SimMemory mem (	// @[CRRV/src/CRRVTop.scala:100:21]
    .clock                   (clock),
    .reset                   (reset),
    .simple_out_valid        (_arbiter_io_simpleOut_out_valid),	// @[CRRV/src/CRRVTop.scala:94:33]
    .simple_out_bits_addr    (_arbiter_io_simpleOut_out_bits_addr),	// @[CRRV/src/CRRVTop.scala:94:33]
    .simple_out_bits_writeEn (_arbiter_io_simpleOut_out_bits_writeEn),	// @[CRRV/src/CRRVTop.scala:94:33]
    .simple_out_bits_size    (_arbiter_io_simpleOut_out_bits_size),	// @[CRRV/src/CRRVTop.scala:94:33]
    .simple_out_bits_wdata   (_arbiter_io_simpleOut_out_bits_wdata),	// @[CRRV/src/CRRVTop.scala:94:33]
    .simple_out_ready        (_mem_simple_out_ready),
    .simple_in_rdata         (_mem_simple_in_rdata)
  );
endmodule
