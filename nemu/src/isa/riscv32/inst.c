...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */)             \
    ...
    // -----------------------   A   ------------------------------
    INSTPAT("00010?? ????? ????? 010 ????? 01011 11", lr.w, R, TODO()); 
    INSTPAT("00011?? ????? ????? 010 ????? 01011 11", sc.w, R, TODO()); 
    INSTPAT("00001?? ????? ????? 010 ????? 01011 11", amoswap.w, R, TODO());
    INSTPAT("00000?? ????? ????? 010 ????? 01011 11", amoadd.w, R, TODO()); 
    INSTPAT("01100?? ????? ????? 010 ????? 01011 11", amoand.w, R, TODO()); 
    INSTPAT("01000?? ????? ????? 010 ????? 01011 11", amoor.w, R, TODO()); 
    INSTPAT("00100?? ????? ????? 010 ????? 01011 11", amoxor.w, R, TODO()); 
    INSTPAT("10100?? ????? ????? 010 ????? 01011 11", amomax.w, R, TODO()); 
    INSTPAT("10000?? ????? ????? 010 ????? 01011 11", amomin.w, R, TODO()); 
    INSTPAT("11000?? ????? ????? 010 ????? 01011 11", amominu.w, R, TODO()); 
    INSTPAT("11100?? ????? ????? 010 ????? 01011 11", amomaxu.w, R, TODO()); 
    
    // ----------------------- Zfence ------------------------------
    INSTPAT("??????? ????? ????? 000 ????? 00011 11", fence, N, TODO()); 
    INSTPAT("??????? ????? ????? 001 ????? 00011 11", fence.i, N, while(0)); 
