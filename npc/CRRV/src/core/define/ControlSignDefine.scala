...
object ControlSignDefine {
  ...
  val TABLE = Array(
    ...
    CSRRW     ->  List(Y, N, Y, OPR_ZERO, OPR_ZERO, ALU_ADD,  BR_NOP,   LSU_NOP,  CSR_RW,   MDU_NOP,    EXC_NONE),
    CSRRS     ->  List(Y, N, Y, OPR_ZERO, OPR_ZERO, ALU_ADD,  BR_NOP,   LSU_NOP,  CSR_RS,   MDU_NOP,    EXC_NONE),
    CSRRC     ->  List(Y, N, Y, OPR_ZERO, OPR_ZERO, ALU_ADD,  BR_NOP,   LSU_NOP,  CSR_RC,   MDU_NOP,    EXC_NONE),
    CSRRWI    ->  List(N, N, Y, OPR_ZERO, OPR_ZERO, ALU_ADD,  BR_NOP,   LSU_NOP,  CSR_RW,   MDU_NOP,    EXC_NONE),
    CSRRSI    ->  List(N, N, Y, OPR_ZERO, OPR_ZERO, ALU_ADD,  BR_NOP,   LSU_NOP,  CSR_RS,   MDU_NOP,    EXC_NONE),
    CSRRCI    ->  List(N, N, Y, OPR_ZERO, OPR_ZERO, ALU_ADD,  BR_NOP,   LSU_NOP,  CSR_RC,   MDU_NOP,    EXC_NONE),
    MUL       ->  List(Y, Y, Y, OPR_REG1, OPR_REG2, ALU_ADD,  BR_NOP,   LSU_NOP,  CSR_NOP,  MDU_MUL,    EXC_NONE),
    MULH      ->  List(Y, Y, Y, OPR_REG1, OPR_REG2, ALU_ADD,  BR_NOP,   LSU_NOP,  CSR_NOP,  MDU_MULH,   EXC_NONE),
    MULHSU    ->  List(Y, Y, Y, OPR_REG1, OPR_REG2, ALU_ADD,  BR_NOP,   LSU_NOP,  CSR_NOP,  MDU_MULHSU, EXC_NONE),
    MULHU     ->  List(Y, Y, Y, OPR_REG1, OPR_REG2, ALU_ADD,  BR_NOP,   LSU_NOP,  CSR_NOP,  MDU_MULHU,  EXC_NONE),
    DIV       ->  List(Y, Y, Y, OPR_REG1, OPR_REG2, ALU_ADD,  BR_NOP,   LSU_NOP,  CSR_NOP,  MDU_DIV,    EXC_NONE),
    DIVU      ->  List(Y, Y, Y, OPR_REG1, OPR_REG2, ALU_ADD,  BR_NOP,   LSU_NOP,  CSR_NOP,  MDU_DIVU,   EXC_NONE),
    REM       ->  List(Y, Y, Y, OPR_REG1, OPR_REG2, ALU_ADD,  BR_NOP,   LSU_NOP,  CSR_NOP,  MDU_REM,    EXC_NONE),
    REMU      ->  List(Y, Y, Y, OPR_REG1, OPR_REG2, ALU_ADD,  BR_NOP,   LSU_NOP,  CSR_NOP,  MDU_REMU,   EXC_NONE),
