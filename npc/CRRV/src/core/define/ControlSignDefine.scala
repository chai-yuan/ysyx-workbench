...
object ControlSignDefine {
  ...
  val TABLE = Array(
    ...
    FENCE     ->  List(N, N, N, OPR_ZERO, OPR_IMMI, ALU_OR,   BR_NOP,   LSU_FENC, CSR_NOP,  MDU_NOP,    EXC_NONE),
    FENCEI    ->  List(N, N, N, OPR_ZERO, OPR_ZERO, ALU_ADD,  BR_NOP,   LSU_FENI, CSR_NOP,  MDU_NOP,    EXC_NONE),
