...
module Control(	// @[<stdin>:50:10]
  ...
  wire        _io_outControl_instType_T_2 = io_inst[6:0] == 7'h3;	// @[src/src/core/ID/Control.scala:30:23, :47:15]
  ...
  wire        _io_outControl_instType_T = io_inst[6:0] == 7'h33;	// @[src/src/core/ID/Control.scala:30:23, :109:42]
        ...
        | io_inst[6:0] == 7'h73
          ...
          : _io_outControl_instType_T_8
              ...
              : io_inst[6:0] == 7'h63
                  ...
                  : io_inst[6:0] == 7'h6F
                      ? 4'h5
                      : {1'h0, io_inst[6:0] == 7'h37 | io_inst[6:0] == 7'h17, 2'h0};	// @[<stdin>:50:10, src/main/scala/chisel3/util/Lookup.scala:34:39, src/main/scala/chisel3/util/Mux.scala:141:16, src/src/core/ID/Control.scala:30:23, :39:{13,29}, :46:15, :47:{15,42}, :109:42, :118:{69,86,96}, :120:15, :121:15, :122:{15,32,42}]
  assign io_outControl_src1Op =
    io_inst[6:0] == 7'h17
      ? 2'h1
      : io_inst[6:0] == 7'h6F | _GEN == 10'h67 ? 2'h2 : {2{io_inst[6:0] == 7'h37}};	// @[<stdin>:50:10, src/main/scala/chisel3/util/Mux.scala:141:16, src/src/core/ID/Control.scala:38:13, :39:{13,21,29}, :40:13, :122:{15,42}]
  assign io_outControl_src2Op =
    {2{_io_outControl_instType_T_1 | _io_outControl_instType_T_2
         | _io_outControl_instType_T_8 | io_inst[6:0] == 7'h17}};	// @[<stdin>:50:10, src/main/scala/chisel3/util/Mux.scala:141:16, src/src/core/ID/Control.scala:38:13, :46:15, :47:{15,42}, :48:13, :122:42]
                              ...
                              : _GEN_0 == 17'hB3 | _GEN_0 == 17'h93
                                  ...
                                  : _GEN_0 == 17'h2B3 | _GEN_0 == 17'h293
                                      ...
                                      : _GEN_0 == 17'h82B3 | _GEN_0 == 17'h8293
                                          ? 4'h9
                                          : 4'h0;	// @[<stdin>:50:10, src/main/scala/chisel3/util/Lookup.scala:31:38, :34:39, src/src/core/ID/Control.scala:38:13, :39:29, :122:42]
    ...
    _io_outControl_instType_T_2
      ...
      : {1'h0,
         _io_outControl_instType_T_1 | _io_outControl_instType_T | io_inst[6:0] == 7'h6F
           | _GEN == 10'h67 | io_inst[6:0] == 7'h37 | io_inst[6:0] == 7'h17};	// @[<stdin>:50:10, src/main/scala/chisel3/util/Mux.scala:141:16, src/src/core/ID/Control.scala:38:13, :39:{13,29}, :46:15, :47:15, :109:42, :110:{13,29,46,62}, :122:{15,42}]
  assign io_outControl_halt = io_inst == 32'h100073;	// @[<stdin>:50:10, src/src/core/ID/Control.scala:126:30]
endmodule

module Registers(	// @[<stdin>:239:10]
  ...
  assign io_rdata1 =
    (|io_raddr1)
      ...
      : 32'h0;	// @[<stdin>:239:10, src/src/core/ID/Registers.scala:19:20, :26:{19,30,38,50,64}, :29:15]
  assign io_rdata2 =
    (|io_raddr2)
      ? (io_raddr2 == io_waddr & io_wen ? io_wdata : _regfile_ext_R32_data)
      : 32'h0;	// @[<stdin>:239:10, src/src/core/ID/Registers.scala:19:20, :27:{19,30,38,50,64}, :29:15]
endmodule

module Forward(	// @[<stdin>:326:10]
  input         clock,	// @[<stdin>:327:11]
    ...
    io_addr1 == 5'h0
      ...
      : io_exeForward_enable & io_exeForward_wAddr == io_addr1
          ...
          : io_memForward_enable & io_memForward_wAddr == io_addr1
              ? io_memForward_wData
              : _regs_io_rdata1;	// @[<stdin>:326:10, src/main/scala/chisel3/util/Mux.scala:141:16, src/src/core/ID/Forward.scala:8:14, :21:20, :31:{29,53}, :32:{29,53}, :42:{18,28}]
  assign io_data2 =
    io_addr2 == 5'h0
      ? 32'h0
      : io_exeForward_enable & io_exeForward_wAddr == io_addr2
          ...
          : io_memForward_enable & io_memForward_wAddr == io_addr2
              ? io_memForward_wData
              : _regs_io_rdata2;	// @[<stdin>:326:10, src/main/scala/chisel3/util/Mux.scala:141:16, src/src/core/ID/Forward.scala:8:14, :21:20, :38:{29,53}, :39:{29,53}, :42:28, :43:{18,28}]
endmodule

module ImmGen(	// @[<stdin>:359:10]
              ...
              : io_instType == 4'h4
                  ...
                  : io_instType == 4'h5
                      ? {{12{io_inst[31]}},
                         ...
                         io_inst[30:21],
                         1'h0}
                      : 32'h0;	// @[<stdin>:359:10, src/main/scala/chisel3/util/Mux.scala:141:16, src/src/core/ID/ImmGen.scala:16:21, :19:14, :20:14, :23:17, :25:14, :26:14, :27:14, :28:14, :32:17, :34:14, :35:11, :41:14, :42:14, :43:14, :51:{20,46,51,60}, :52:{20,46,51,60}, :53:{20,46}, :54:20, :55:{20,46}]
endmodule

module Branch(	// @[<stdin>:415:10]
  ...
  assign io_nextPCsel = nextPC != _nextPC_T_1;	// @[<stdin>:415:10, src/main/scala/chisel3/util/Lookup.scala:34:39, src/src/core/ID/Branch.scala:27:8, :68:28]
  assign io_nextPC = nextPC;	// @[<stdin>:415:10, src/main/scala/chisel3/util/Lookup.scala:34:39]
endmodule

module ID(	// @[<stdin>:497:10]
  ...
  output [1:0]  io_id2exe_bits_iddata_control_src1Op,	// @[src/src/core/ID/ID.scala:11:14]
  ...
  `ifdef ENABLE_INITIAL_REG_	// @[<stdin>:497:10]
    ...
    `endif // FIRRTL_BEFORE_INITIAL
    logic [31:0] _RANDOM[0:2];	// @[<stdin>:497:10]
    initial begin	// @[<stdin>:497:10]
      ...
      `ifdef RANDOMIZE_REG_INIT	// @[<stdin>:497:10]
        ...
        idValid = _RANDOM[2'h0][0];	// @[<stdin>:497:10, src/src/core/ID/ID.scala:26:27]
        if2id_ifdata_pc = {_RANDOM[2'h0][31:1], _RANDOM[2'h1][0]};	// @[<stdin>:497:10, src/src/core/ID/ID.scala:26:27, :36:22]
        if2id_ifdata_inst = {_RANDOM[2'h1][31:1], _RANDOM[2'h2][0]};	// @[<stdin>:497:10, src/src/core/ID/ID.scala:36:22]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  Branch branch (	// @[src/src/core/ID/ID.scala:71:22]
    .io_inst      (if2id_ifdata_inst),	// @[src/src/core/ID/ID.scala:36:22]
  ...
  assign io_if2id_ready = idAllowin;	// @[<stdin>:497:10, src/src/core/ID/ID.scala:28:29]
  assign io_id2exe_valid = idValid & ~memLoadStall;	// @[<stdin>:497:10, src/src/core/ID/ID.scala:25:20, :26:27, :30:26, :48:40]
  assign io_id2exe_bits_ifdata_pc = if2id_ifdata_pc;	// @[<stdin>:497:10, src/src/core/ID/ID.scala:36:22]
  assign io_id2exe_bits_ifdata_inst = if2id_ifdata_inst;	// @[<stdin>:497:10, src/src/core/ID/ID.scala:36:22]
  assign io_id2exe_bits_iddata_reg1 = _forward_io_data1;	// @[<stdin>:497:10, src/src/core/ID/ID.scala:57:23]
  assign io_id2exe_bits_iddata_reg2 = _forward_io_data2;	// @[<stdin>:497:10, src/src/core/ID/ID.scala:57:23]
  assign io_id2exe_bits_iddata_imm = _immGen_io_imm;	// @[<stdin>:497:10, src/src/core/ID/ID.scala:66:22]
endmodule

module ALU(	// @[<stdin>:581:10]
  ...
  assign io_out = casez_tmp;	// @[<stdin>:581:10, src/main/scala/chisel3/util/Mux.scala:141:16]
endmodule

module DataMemWriteWrap(	// @[<stdin>:631:10]
  ...
  assign io_dataMem_addr = io_addr;	// @[<stdin>:631:10]
  assign io_dataMem_writeEn = io_control_memWriteEn;	// @[<stdin>:631:10]
  assign io_dataMem_writeData =
    _io_dataMem_writeData_T | _io_dataMem_writeData_T_1
      ...
      : _io_dataMem_writeData_T_6 | _io_dataMem_writeData_T_7
          ? {2{io_writeData[15:0]}}
          : _io_dataMem_writeData_T_11 ? io_writeData : 32'h0;	// @[<stdin>:631:10, src/main/scala/chisel3/util/Mux.scala:141:16, src/src/core/MEM/DataMemWrap.scala:32:{22,49}, :36:{22,49}, :40:22, :47:{32,69,82}, :48:{32,69,82}]
  assign io_dataMem_readEn = io_control_memReadEn;	// @[<stdin>:631:10]
  assign io_dataMem_mark =
    _io_dataMem_writeData_T | _io_dataMem_writeData_T_1
      ? 4'h1 << io_addr[1:0]
      : _io_dataMem_writeData_T_6 | _io_dataMem_writeData_T_7
          ? _mark_T_9[3:0]
          : {4{_io_dataMem_writeData_T_11}};	// @[<stdin>:631:10, src/main/scala/chisel3/util/Mux.scala:141:16, src/src/core/MEM/DataMemWrap.scala:32:{22,32,49,75,82}, :36:{22,32,49,75}, :40:22]
  assign io_rawReadData = io_dataMem_readData;	// @[<stdin>:631:10]
endmodule

module EXE(	// @[<stdin>:672:10]
  input         clock,	// @[<stdin>:673:11]
                reset,	// @[<stdin>:674:11]
  ...
  always @(posedge clock) begin	// @[<stdin>:673:11]
    if (reset) begin	// @[<stdin>:673:11]
      ...
      id2exe_iddata_control_memOp <= 3'h0;	// @[<stdin>:672:10, src/src/core/EXE/EXE.scala:30:23]
  ...
  `ifdef ENABLE_INITIAL_REG_	// @[<stdin>:672:10]
    `ifdef FIRRTL_BEFORE_INITIAL	// @[<stdin>:672:10]
      `FIRRTL_BEFORE_INITIAL	// @[<stdin>:672:10]
    `endif // FIRRTL_BEFORE_INITIAL
    logic [31:0] _RANDOM[0:5];	// @[<stdin>:672:10]
    initial begin	// @[<stdin>:672:10]
      `ifdef INIT_RANDOM_PROLOG_	// @[<stdin>:672:10]
        `INIT_RANDOM_PROLOG_	// @[<stdin>:672:10]
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// @[<stdin>:672:10]
        for (logic [2:0] i = 3'h0; i < 3'h6; i += 3'h1) begin
          _RANDOM[i] = `RANDOM;	// @[<stdin>:672:10]
        end	// @[<stdin>:672:10]
        wbValid = _RANDOM[3'h0][0];	// @[<stdin>:672:10, src/src/core/EXE/EXE.scala:20:27]
        id2exe_ifdata_pc = {_RANDOM[3'h0][31:1], _RANDOM[3'h1][0]};	// @[<stdin>:672:10, src/src/core/EXE/EXE.scala:20:27, :30:23]
        id2exe_ifdata_inst = {_RANDOM[3'h1][31:1], _RANDOM[3'h2][0]};	// @[<stdin>:672:10, src/src/core/EXE/EXE.scala:30:23]
        id2exe_iddata_control_src1Op = _RANDOM[3'h2][6:5];	// @[<stdin>:672:10, src/src/core/EXE/EXE.scala:30:23]
        id2exe_iddata_control_src2Op = _RANDOM[3'h2][8:7];	// @[<stdin>:672:10, src/src/core/EXE/EXE.scala:30:23]
        id2exe_iddata_control_aluOp = _RANDOM[3'h2][12:9];	// @[<stdin>:672:10, src/src/core/EXE/EXE.scala:30:23]
        id2exe_iddata_control_memOp = _RANDOM[3'h2][15:13];	// @[<stdin>:672:10, src/src/core/EXE/EXE.scala:30:23]
        id2exe_iddata_control_memReadEn = _RANDOM[3'h2][16];	// @[<stdin>:672:10, src/src/core/EXE/EXE.scala:30:23]
        id2exe_iddata_control_memWriteEn = _RANDOM[3'h2][17];	// @[<stdin>:672:10, src/src/core/EXE/EXE.scala:30:23]
        id2exe_iddata_control_wbOp = _RANDOM[3'h2][19:18];	// @[<stdin>:672:10, src/src/core/EXE/EXE.scala:30:23]
        id2exe_iddata_control_halt = _RANDOM[3'h2][20];	// @[<stdin>:672:10, src/src/core/EXE/EXE.scala:30:23]
        id2exe_iddata_reg1 = {_RANDOM[3'h2][31:21], _RANDOM[3'h3][20:0]};	// @[<stdin>:672:10, src/src/core/EXE/EXE.scala:30:23]
        id2exe_iddata_reg2 = {_RANDOM[3'h3][31:21], _RANDOM[3'h4][20:0]};	// @[<stdin>:672:10, src/src/core/EXE/EXE.scala:30:23]
        id2exe_iddata_imm = {_RANDOM[3'h4][31:21], _RANDOM[3'h5][20:0]};	// @[<stdin>:672:10, src/src/core/EXE/EXE.scala:30:23]
      `endif // RANDOMIZE_REG_INIT
    end // initial
    `ifdef FIRRTL_AFTER_INITIAL	// @[<stdin>:672:10]
      `FIRRTL_AFTER_INITIAL	// @[<stdin>:672:10]
    `endif // FIRRTL_AFTER_INITIAL
  `endif // ENABLE_INITIAL_REG_
  ...
  assign io_exe2mem_valid = wbValid;	// @[<stdin>:672:10, src/src/core/EXE/EXE.scala:20:27]
  assign io_exe2mem_bits_ifdata_pc = id2exe_ifdata_pc;	// @[<stdin>:672:10, src/src/core/EXE/EXE.scala:30:23]
  assign io_exe2mem_bits_ifdata_inst = id2exe_ifdata_inst;	// @[<stdin>:672:10, src/src/core/EXE/EXE.scala:30:23]
  assign io_exe2mem_bits_iddata_control_memOp = id2exe_iddata_control_memOp;	// @[<stdin>:672:10, src/src/core/EXE/EXE.scala:30:23]
  assign io_exe2mem_bits_iddata_control_wbOp = id2exe_iddata_control_wbOp;	// @[<stdin>:672:10, src/src/core/EXE/EXE.scala:30:23]
  assign io_exe2mem_bits_iddata_control_halt = id2exe_iddata_control_halt;	// @[<stdin>:672:10, src/src/core/EXE/EXE.scala:30:23]
  assign io_exe2mem_bits_exedata_aluResult = _alu_io_out;	// @[<stdin>:672:10, src/src/core/EXE/EXE.scala:46:19]
  assign io_exe2global_forward_enable = id2exe_iddata_control_wbOp == 2'h1 & wbValid;	// @[<stdin>:672:10, src/src/core/EXE/EXE.scala:20:27, :30:23, :51:23, :85:{49,73}]
  assign io_exe2global_forward_wAddr = id2exe_ifdata_inst[11:7];	// @[<stdin>:672:10, src/src/core/EXE/EXE.scala:30:23, :86:39]
  assign io_exe2global_forward_wData = _alu_io_out;	// @[<stdin>:672:10, src/src/core/EXE/EXE.scala:46:19]
  assign io_exe2global_exeMemLoad_loadEn = id2exe_iddata_control_memReadEn;	// @[<stdin>:672:10, src/src/core/EXE/EXE.scala:30:23]
  assign io_exe2global_exeMemLoad_loadAddr = id2exe_ifdata_inst[11:7];	// @[<stdin>:672:10, src/src/core/EXE/EXE.scala:30:23, :86:39]
endmodule

module DataMemReadWrap(	// @[<stdin>:783:10]
    ...
    io_control_memOp == 3'h1
      ...
      : io_control_memOp == 3'h2
          ...
          : io_control_memOp == 3'h3
              ...
              : io_control_memOp == 3'h4 ? {16'h0, shiftData[15:0]} : shiftData;	// @[<stdin>:783:10, src/main/scala/chisel3/util/Mux.scala:141:16, src/src/core/MEM/DataMemWrap.scala:69:31, :73:{22,40,45,59,74}, :74:{22,41}, :75:{22,40,45,59,75}, :76:{22,41}]
endmodule

module MEM(	// @[<stdin>:817:10]
  ...
  always @(posedge clock) begin	// @[<stdin>:818:11]
    if (reset) begin	// @[<stdin>:818:11]
      ...
      exe2mem_iddata_control_memOp <= 3'h0;	// @[<stdin>:817:10, src/src/core/MEM/MEM.scala:31:24]
  ...
  `ifdef ENABLE_INITIAL_REG_	// @[<stdin>:817:10]
    `ifdef FIRRTL_BEFORE_INITIAL	// @[<stdin>:817:10]
      `FIRRTL_BEFORE_INITIAL	// @[<stdin>:817:10]
    `endif // FIRRTL_BEFORE_INITIAL
    logic [31:0] _RANDOM[0:6];	// @[<stdin>:817:10]
    initial begin	// @[<stdin>:817:10]
      `ifdef INIT_RANDOM_PROLOG_	// @[<stdin>:817:10]
        `INIT_RANDOM_PROLOG_	// @[<stdin>:817:10]
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// @[<stdin>:817:10]
        for (logic [2:0] i = 3'h0; i < 3'h7; i += 3'h1) begin
          _RANDOM[i] = `RANDOM;	// @[<stdin>:817:10]
        end	// @[<stdin>:817:10]
        wbValid = _RANDOM[3'h0][0];	// @[<stdin>:817:10, src/src/core/MEM/MEM.scala:21:27]
        exe2mem_ifdata_pc = {_RANDOM[3'h0][31:1], _RANDOM[3'h1][0]};	// @[<stdin>:817:10, src/src/core/MEM/MEM.scala:21:27, :31:24]
        exe2mem_ifdata_inst = {_RANDOM[3'h1][31:1], _RANDOM[3'h2][0]};	// @[<stdin>:817:10, src/src/core/MEM/MEM.scala:31:24]
        exe2mem_iddata_control_memOp = _RANDOM[3'h2][15:13];	// @[<stdin>:817:10, src/src/core/MEM/MEM.scala:31:24]
        exe2mem_iddata_control_wbOp = _RANDOM[3'h2][19:18];	// @[<stdin>:817:10, src/src/core/MEM/MEM.scala:31:24]
        exe2mem_iddata_control_halt = _RANDOM[3'h2][20];	// @[<stdin>:817:10, src/src/core/MEM/MEM.scala:31:24]
        exe2mem_exedata_aluResult = {_RANDOM[3'h5][31:21], _RANDOM[3'h6][20:0]};	// @[<stdin>:817:10, src/src/core/MEM/MEM.scala:31:24]
      `endif // RANDOMIZE_REG_INIT
    end // initial
    `ifdef FIRRTL_AFTER_INITIAL	// @[<stdin>:817:10]
      `FIRRTL_AFTER_INITIAL	// @[<stdin>:817:10]
    `endif // FIRRTL_AFTER_INITIAL
  `endif // ENABLE_INITIAL_REG_
  ...
  assign io_mem2wb_valid = wbValid;	// @[<stdin>:817:10, src/src/core/MEM/MEM.scala:21:27]
  assign io_mem2wb_bits_ifdata_pc = exe2mem_ifdata_pc;	// @[<stdin>:817:10, src/src/core/MEM/MEM.scala:31:24]
  assign io_mem2wb_bits_ifdata_inst = exe2mem_ifdata_inst;	// @[<stdin>:817:10, src/src/core/MEM/MEM.scala:31:24]
  assign io_mem2wb_bits_iddata_control_wbOp = exe2mem_iddata_control_wbOp;	// @[<stdin>:817:10, src/src/core/MEM/MEM.scala:31:24]
  assign io_mem2wb_bits_iddata_control_halt = exe2mem_iddata_control_halt;	// @[<stdin>:817:10, src/src/core/MEM/MEM.scala:31:24]
  assign io_mem2wb_bits_exedata_aluResult = exe2mem_exedata_aluResult;	// @[<stdin>:817:10, src/src/core/MEM/MEM.scala:31:24]
  assign io_mem2wb_bits_memdata_memData = _memReadWrap_io_readData;	// @[<stdin>:817:10, src/src/core/MEM/MEM.scala:43:27]
  assign io_mem2global_forward_enable = (|exe2mem_iddata_control_wbOp) & wbValid;	// @[<stdin>:817:10, src/src/core/MEM/MEM.scala:21:27, :31:24, :59:{49,73}]
  assign io_mem2global_forward_wAddr = exe2mem_ifdata_inst[11:7];	// @[<stdin>:817:10, src/src/core/MEM/MEM.scala:31:24, :60:39]
  assign io_mem2global_forward_wData =
    exe2mem_iddata_control_wbOp == 2'h1
      ? exe2mem_exedata_aluResult
      : exe2mem_iddata_control_wbOp == 2'h2 ? _memReadWrap_io_readData : 32'h0;	// @[<stdin>:817:10, src/main/scala/chisel3/util/Mux.scala:141:16, src/src/core/MEM/MEM.scala:31:{24,37}, :43:27, :64:21, :65:21]
endmodule

module WB(	// @[<stdin>:903:10]
  input         clock,	// @[<stdin>:904:11]
                reset,	// @[<stdin>:905:11]
  ...
  always @(posedge clock) begin	// @[<stdin>:904:11]
    if (reset) begin	// @[<stdin>:904:11]
  ...
  `ifdef ENABLE_INITIAL_REG_	// @[<stdin>:903:10]
    `ifdef FIRRTL_BEFORE_INITIAL	// @[<stdin>:903:10]
      `FIRRTL_BEFORE_INITIAL	// @[<stdin>:903:10]
    `endif // FIRRTL_BEFORE_INITIAL
    logic [31:0] _RANDOM[0:8];	// @[<stdin>:903:10]
    initial begin	// @[<stdin>:903:10]
      `ifdef INIT_RANDOM_PROLOG_	// @[<stdin>:903:10]
        `INIT_RANDOM_PROLOG_	// @[<stdin>:903:10]
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// @[<stdin>:903:10]
        for (logic [3:0] i = 4'h0; i < 4'h9; i += 4'h1) begin
          _RANDOM[i] = `RANDOM;	// @[<stdin>:903:10]
        end	// @[<stdin>:903:10]
        wbValid = _RANDOM[4'h0][0];	// @[<stdin>:903:10, src/src/core/WB/WB.scala:18:26]
        mem2wb_ifdata_pc = {_RANDOM[4'h0][31:1], _RANDOM[4'h1][0]};	// @[<stdin>:903:10, src/src/core/WB/WB.scala:18:26, :25:23]
        mem2wb_ifdata_inst = {_RANDOM[4'h1][31:1], _RANDOM[4'h2][0]};	// @[<stdin>:903:10, src/src/core/WB/WB.scala:25:23]
        mem2wb_iddata_control_wbOp = _RANDOM[4'h2][19:18];	// @[<stdin>:903:10, src/src/core/WB/WB.scala:25:23]
        mem2wb_iddata_control_halt = _RANDOM[4'h2][20];	// @[<stdin>:903:10, src/src/core/WB/WB.scala:25:23]
        mem2wb_exedata_aluResult = {_RANDOM[4'h5][31:21], _RANDOM[4'h6][20:0]};	// @[<stdin>:903:10, src/src/core/WB/WB.scala:25:23]
        mem2wb_memdata_memData = {_RANDOM[4'h6][31:21], _RANDOM[4'h7][20:0]};	// @[<stdin>:903:10, src/src/core/WB/WB.scala:25:23]
        io_wb2global_debug_inst_REG = {_RANDOM[4'h7][31:21], _RANDOM[4'h8][20:0]};	// @[<stdin>:903:10, src/src/core/WB/WB.scala:25:23, :52:38]
        io_wb2global_debug_halt_REG = _RANDOM[4'h8][21];	// @[<stdin>:903:10, src/src/core/WB/WB.scala:52:38, :53:38]
      `endif // RANDOMIZE_REG_INIT
    end // initial
    `ifdef FIRRTL_AFTER_INITIAL	// @[<stdin>:903:10]
      `FIRRTL_AFTER_INITIAL	// @[<stdin>:903:10]
    `endif // FIRRTL_AFTER_INITIAL
  `endif // ENABLE_INITIAL_REG_
  assign io_wb2global_debug_valid = wbValid;	// @[<stdin>:903:10, src/src/core/WB/WB.scala:18:26]
  assign io_wb2global_debug_pc = mem2wb_ifdata_pc;	// @[<stdin>:903:10, src/src/core/WB/WB.scala:25:23]
  assign io_wb2global_debug_inst = io_wb2global_debug_inst_REG;	// @[<stdin>:903:10, src/src/core/WB/WB.scala:52:38]
  assign io_wb2global_debug_halt = io_wb2global_debug_halt_REG;	// @[<stdin>:903:10, src/src/core/WB/WB.scala:53:38]
  assign io_wb2global_writeBack_enable = wbValid & (|mem2wb_iddata_control_wbOp);	// @[<stdin>:903:10, src/src/core/WB/WB.scala:18:26, :25:23, :40:{44,60}]
  assign io_wb2global_writeBack_wAddr = mem2wb_ifdata_inst[11:7];	// @[<stdin>:903:10, src/src/core/WB/WB.scala:25:23, :35:23]
  assign io_wb2global_writeBack_wData =
    mem2wb_iddata_control_wbOp == 2'h1
      ? mem2wb_exedata_aluResult
      : mem2wb_iddata_control_wbOp == 2'h2 ? mem2wb_memdata_memData : 32'h0;	// @[<stdin>:903:10, src/main/scala/chisel3/util/Mux.scala:141:16, src/src/core/WB/WB.scala:25:{23,36}, :45:21, :46:21]
endmodule

module CPUTop(	// @[<stdin>:978:10]
  ...
  assign io_inst_writeEn = 1'h0;	// @[<stdin>:978:10, src/src/core/CPUTop.scala:28:26]
  assign io_inst_writeData = 32'h0;	// @[<stdin>:978:10, src/src/core/CPUTop.scala:28:26, :30:26]
  assign io_inst_mark = 4'hF;	// @[<stdin>:978:10, src/src/core/CPUTop.scala:28:26]
  assign io_debug_regs_0 = 32'h0;	// @[<stdin>:978:10, src/src/core/CPUTop.scala:28:26, :30:26]
endmodule
