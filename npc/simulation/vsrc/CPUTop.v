...
module Control(	// @[<stdin>:50:10]
        ...
        | io_inst[6:0] == 7'h73
          ...
          : _io_outControl_instType_T_8
              ...
              : io_inst[6:0] == 7'h63
                  ...
                  : io_inst[6:0] == 7'h6F
                      ? 4'h5
                      : {1'h0, io_inst[6:0] == 7'h37 | io_inst[6:0] == 7'h17, 2'h0};	// @[<stdin>:50:10, src/main/scala/chisel3/util/Lookup.scala:34:39, src/main/scala/chisel3/util/Mux.scala:141:16, src/src/core/ID/Control.scala:30:23, :39:{13,29}, :47:15, :48:{15,42}, :110:42, :120:{69,86,96}, :122:15, :123:15, :124:{15,32,42}]
  assign io_outControl_src1Op =
    io_inst[6:0] == 7'h17
      ? 3'h1
      : io_inst[6:0] == 7'h6F | _GEN == 10'h67
          ? 3'h2
          : io_inst[6:0] == 7'h37 ? 3'h3 : {_GEN == 10'h173 | _GEN == 10'hF3, 2'h0};	// @[<stdin>:50:10, src/main/scala/chisel3/util/Mux.scala:141:16, src/src/core/ID/Control.scala:38:13, :39:{13,21,29}, :40:13, :41:{13,23,31}, :124:{15,42}]
  assign io_outControl_src2Op =
    ...
    | _io_outControl_instType_T_8 | io_inst[6:0] == 7'h17
      ? 3'h3
      : 3'h0;	// @[<stdin>:50:10, src/main/scala/chisel3/util/Mux.scala:141:16, src/src/core/ID/Control.scala:38:13, :47:15, :48:{15,42}, :49:13, :124:42]
                              ...
                              : _GEN_0 == 17'hB3 | _GEN_0 == 17'h93
                                  ...
                                  : _GEN_0 == 17'h2B3 | _GEN_0 == 17'h293
                                      ...
                                      : _GEN_0 == 17'h82B3 | _GEN_0 == 17'h8293
                                          ? 4'h9
                                          : 4'h0;	// @[<stdin>:50:10, src/main/scala/chisel3/util/Lookup.scala:31:38, :34:39, src/src/core/ID/Control.scala:38:13, :39:29, :124:42]
          ...
          : _GEN == 10'h83
              ...
              : _GEN == 10'h283
                  ...
                  : _GEN == 10'h103
                      ...
                      : _GEN == 10'h23
                          ? 3'h1
                          : _GEN == 10'hA3 ? 3'h3 : _GEN == 10'h123 ? 3'h5 : 3'h0;	// @[<stdin>:50:10, src/main/scala/chisel3/util/Lookup.scala:31:38, :34:39, src/main/scala/chisel3/util/Mux.scala:141:16, src/src/core/ID/Control.scala:39:29]
  assign io_outControl_memReadEn = _io_outControl_instType_T_2;	// @[<stdin>:50:10, src/src/core/ID/Control.scala:48:15]
  assign io_outControl_memWriteEn = _io_outControl_instType_T_8;	// @[<stdin>:50:10, src/src/core/ID/Control.scala:48:42]
    ...
    _io_outControl_instType_T_2
      ...
      : {1'h0,
         _io_outControl_instType_T_1 | _io_outControl_instType_T | io_inst[6:0] == 7'h6F
           ...
           | _GEN == 10'h173 | _GEN == 10'hF3};	// @[<stdin>:50:10, src/main/scala/chisel3/util/Mux.scala:141:16, src/src/core/ID/Control.scala:38:13, :39:{13,29}, :41:{13,31}, :47:15, :48:15, :110:42, :111:{13,29,46,62}, :112:{13,31}, :124:{15,42}]
  assign io_outControl_halt = io_inst == 32'h100073;	// @[<stdin>:50:10, src/src/core/ID/Control.scala:128:30]
endmodule

module Registers(	// @[<stdin>:251:10]
  input         clock,	// @[<stdin>:252:11]
  ...
  assign io_rdata1 =
    (|io_raddr1)
      ...
      : 32'h0;	// @[<stdin>:251:10, src/src/core/ID/Registers.scala:19:20, :26:{19,30,38,50,64}, :29:15]
  assign io_rdata2 =
    (|io_raddr2)
      ? (io_raddr2 == io_waddr & io_wen ? io_wdata : _regfile_ext_R32_data)
      : 32'h0;	// @[<stdin>:251:10, src/src/core/ID/Registers.scala:19:20, :27:{19,30,38,50,64}, :29:15]
endmodule

module Forward(	// @[<stdin>:338:10]
  input         clock,	// @[<stdin>:339:11]
    ...
    io_addr1 == 5'h0
      ...
      : io_exeForward_enable & io_exeForward_wAddr == io_addr1
          ...
          : io_memForward_enable & io_memForward_wAddr == io_addr1
              ? io_memForward_wData
              : _regs_io_rdata1;	// @[<stdin>:338:10, src/main/scala/chisel3/util/Mux.scala:141:16, src/src/core/ID/Forward.scala:8:14, :21:20, :31:{29,53}, :32:{29,53}, :42:{18,28}]
  assign io_data2 =
    io_addr2 == 5'h0
      ? 32'h0
      : io_exeForward_enable & io_exeForward_wAddr == io_addr2
          ...
          : io_memForward_enable & io_memForward_wAddr == io_addr2
              ? io_memForward_wData
              : _regs_io_rdata2;	// @[<stdin>:338:10, src/main/scala/chisel3/util/Mux.scala:141:16, src/src/core/ID/Forward.scala:8:14, :21:20, :38:{29,53}, :39:{29,53}, :42:28, :43:{18,28}]
endmodule
...
module CSR(	// @[<stdin>:427:10]
  ...
  always @(posedge clock) begin	// @[<stdin>:428:11]
    if (reset) begin	// @[<stdin>:428:11]
      ...
      else if (io_inst == 32'h73)	// @[src/src/core/ID/CSR.scala:29:13, :65:13]
        mstatus <= 32'h1800;	// @[src/main/scala/chisel3/util/Mux.scala:141:16, src/src/core/ID/CSR.scala:19:24]
      if (isZicsr & _mtvec_T) begin	// @[src/src/core/ID/CSR.scala:34:16, :38:38, :71:16]
        if (_newVal_T_1)	// @[src/src/core/ID/CSR.scala:42:13]
  ...
  `ifdef ENABLE_INITIAL_REG_	// @[<stdin>:427:10]
    `ifdef FIRRTL_BEFORE_INITIAL	// @[<stdin>:427:10]
      `FIRRTL_BEFORE_INITIAL	// @[<stdin>:427:10]
    `endif // FIRRTL_BEFORE_INITIAL
    logic [31:0] _RANDOM[0:3];	// @[<stdin>:427:10]
    initial begin	// @[<stdin>:427:10]
      `ifdef INIT_RANDOM_PROLOG_	// @[<stdin>:427:10]
        `INIT_RANDOM_PROLOG_	// @[<stdin>:427:10]
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// @[<stdin>:427:10]
        for (logic [2:0] i = 3'h0; i < 3'h4; i += 3'h1) begin
          _RANDOM[i[1:0]] = `RANDOM;	// @[<stdin>:427:10]
        end	// @[<stdin>:427:10]
        mepc = _RANDOM[2'h0];	// @[<stdin>:427:10, src/src/core/ID/CSR.scala:17:24]
        mcause = _RANDOM[2'h1];	// @[<stdin>:427:10, src/src/core/ID/CSR.scala:18:24]
        mstatus = _RANDOM[2'h2];	// @[<stdin>:427:10, src/src/core/ID/CSR.scala:19:24]
        mtvec = _RANDOM[2'h3];	// @[<stdin>:427:10, src/src/core/ID/CSR.scala:20:24]
      `endif // RANDOMIZE_REG_INIT
    end // initial
    `ifdef FIRRTL_AFTER_INITIAL	// @[<stdin>:427:10]
      `FIRRTL_AFTER_INITIAL	// @[<stdin>:427:10]
    `endif // FIRRTL_AFTER_INITIAL
  `endif // ENABLE_INITIAL_REG_
  assign io_csrRead = readData;	// @[<stdin>:427:10, src/main/scala/chisel3/util/Mux.scala:141:16]
endmodule

module Branch(	// @[<stdin>:493:10]
  ...
  assign io_nextPCsel = nextPC != _nextPC_T_1;	// @[<stdin>:493:10, src/main/scala/chisel3/util/Lookup.scala:34:39, src/src/core/ID/Branch.scala:29:8, :72:28]
  assign io_nextPC = nextPC;	// @[<stdin>:493:10, src/main/scala/chisel3/util/Lookup.scala:34:39]
endmodule

module ID(	// @[<stdin>:581:10]
  input         clock,	// @[<stdin>:582:11]
                reset,	// @[<stdin>:583:11]
  ...
  always @(posedge clock) begin	// @[<stdin>:582:11]
    if (reset) begin	// @[<stdin>:582:11]
  ...
  `ifdef ENABLE_INITIAL_REG_	// @[<stdin>:581:10]
    `ifdef FIRRTL_BEFORE_INITIAL	// @[<stdin>:581:10]
      `FIRRTL_BEFORE_INITIAL	// @[<stdin>:581:10]
    `endif // FIRRTL_BEFORE_INITIAL
    logic [31:0] _RANDOM[0:2];	// @[<stdin>:581:10]
    initial begin	// @[<stdin>:581:10]
      `ifdef INIT_RANDOM_PROLOG_	// @[<stdin>:581:10]
        `INIT_RANDOM_PROLOG_	// @[<stdin>:581:10]
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// @[<stdin>:581:10]
        for (logic [1:0] i = 2'h0; i < 2'h3; i += 2'h1) begin
          _RANDOM[i] = `RANDOM;	// @[<stdin>:581:10]
        end	// @[<stdin>:581:10]
        idValid = _RANDOM[2'h0][0];	// @[<stdin>:581:10, src/src/core/ID/ID.scala:26:27]
        if2id_ifdata_pc = {_RANDOM[2'h0][31:1], _RANDOM[2'h1][0]};	// @[<stdin>:581:10, src/src/core/ID/ID.scala:26:27, :36:22]
        if2id_ifdata_inst = {_RANDOM[2'h1][31:1], _RANDOM[2'h2][0]};	// @[<stdin>:581:10, src/src/core/ID/ID.scala:36:22]
      `endif // RANDOMIZE_REG_INIT
    end // initial
    `ifdef FIRRTL_AFTER_INITIAL	// @[<stdin>:581:10]
      `FIRRTL_AFTER_INITIAL	// @[<stdin>:581:10]
    `endif // FIRRTL_AFTER_INITIAL
  `endif // ENABLE_INITIAL_REG_
  ...
  assign io_if2id_ready = idAllowin;	// @[<stdin>:581:10, src/src/core/ID/ID.scala:28:29]
  assign io_id2exe_valid = idValid & ~memLoadStall;	// @[<stdin>:581:10, src/src/core/ID/ID.scala:25:20, :26:27, :30:26, :48:40]
  assign io_id2exe_bits_ifdata_pc = if2id_ifdata_pc;	// @[<stdin>:581:10, src/src/core/ID/ID.scala:36:22]
  assign io_id2exe_bits_ifdata_inst = if2id_ifdata_inst;	// @[<stdin>:581:10, src/src/core/ID/ID.scala:36:22]
  assign io_id2exe_bits_iddata_reg1 = _forward_io_data1;	// @[<stdin>:581:10, src/src/core/ID/ID.scala:57:23]
  assign io_id2exe_bits_iddata_reg2 = _forward_io_data2;	// @[<stdin>:581:10, src/src/core/ID/ID.scala:57:23]
  assign io_id2exe_bits_iddata_imm = _immGen_io_imm;	// @[<stdin>:581:10, src/src/core/ID/ID.scala:66:22]
  assign io_id2exe_bits_iddata_csr = _csr_io_csrRead;	// @[<stdin>:581:10, src/src/core/ID/ID.scala:71:19]
endmodule

module ALU(	// @[<stdin>:674:10]
  ...
  assign io_out = casez_tmp;	// @[<stdin>:674:10, src/main/scala/chisel3/util/Mux.scala:141:16]
endmodule

module DataMemWriteWrap(	// @[<stdin>:724:10]
  ...
  assign io_dataMem_addr = io_addr;	// @[<stdin>:724:10]
  assign io_dataMem_writeEn = io_control_memWriteEn;	// @[<stdin>:724:10]
  assign io_dataMem_writeData =
    _io_dataMem_writeData_T | _io_dataMem_writeData_T_1
      ...
      : _io_dataMem_writeData_T_6 | _io_dataMem_writeData_T_7
          ? {2{io_writeData[15:0]}}
          : _io_dataMem_writeData_T_11 ? io_writeData : 32'h0;	// @[<stdin>:724:10, src/main/scala/chisel3/util/Mux.scala:141:16, src/src/core/MEM/DataMemWrap.scala:32:{22,49}, :36:{22,49}, :40:22, :47:{32,69,82}, :48:{32,69,82}]
  assign io_dataMem_readEn = io_control_memReadEn;	// @[<stdin>:724:10]
  assign io_dataMem_mark =
    _io_dataMem_writeData_T | _io_dataMem_writeData_T_1
      ? 4'h1 << io_addr[1:0]
      : _io_dataMem_writeData_T_6 | _io_dataMem_writeData_T_7
          ? _mark_T_9[3:0]
          : {4{_io_dataMem_writeData_T_11}};	// @[<stdin>:724:10, src/main/scala/chisel3/util/Mux.scala:141:16, src/src/core/MEM/DataMemWrap.scala:32:{22,32,49,75,82}, :36:{22,32,49,75}, :40:22]
  assign io_rawReadData = io_dataMem_readData;	// @[<stdin>:724:10]
endmodule

module EXE(	// @[<stdin>:765:10]
  ...
  always @(posedge clock) begin	// @[<stdin>:766:11]
    if (reset) begin	// @[<stdin>:766:11]
      ...
      id2exe_iddata_control_src1Op <= 3'h0;	// @[<stdin>:765:10, src/src/core/EXE/EXE.scala:30:23]
      id2exe_iddata_control_src2Op <= 3'h0;	// @[<stdin>:765:10, src/src/core/EXE/EXE.scala:30:23]
      id2exe_iddata_control_aluOp <= 4'h0;	// @[src/src/core/EXE/EXE.scala:30:{23,36}]
      id2exe_iddata_control_memOp <= 3'h0;	// @[<stdin>:765:10, src/src/core/EXE/EXE.scala:30:23]
  ...
  `ifdef ENABLE_INITIAL_REG_	// @[<stdin>:765:10]
    `ifdef FIRRTL_BEFORE_INITIAL	// @[<stdin>:765:10]
      `FIRRTL_BEFORE_INITIAL	// @[<stdin>:765:10]
    `endif // FIRRTL_BEFORE_INITIAL
    logic [31:0] _RANDOM[0:6];	// @[<stdin>:765:10]
    initial begin	// @[<stdin>:765:10]
      `ifdef INIT_RANDOM_PROLOG_	// @[<stdin>:765:10]
        `INIT_RANDOM_PROLOG_	// @[<stdin>:765:10]
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// @[<stdin>:765:10]
        for (logic [2:0] i = 3'h0; i < 3'h7; i += 3'h1) begin
          _RANDOM[i] = `RANDOM;	// @[<stdin>:765:10]
        end	// @[<stdin>:765:10]
        wbValid = _RANDOM[3'h0][0];	// @[<stdin>:765:10, src/src/core/EXE/EXE.scala:20:27]
        id2exe_ifdata_pc = {_RANDOM[3'h0][31:1], _RANDOM[3'h1][0]};	// @[<stdin>:765:10, src/src/core/EXE/EXE.scala:20:27, :30:23]
        id2exe_ifdata_inst = {_RANDOM[3'h1][31:1], _RANDOM[3'h2][0]};	// @[<stdin>:765:10, src/src/core/EXE/EXE.scala:30:23]
        id2exe_iddata_control_src1Op = _RANDOM[3'h2][7:5];	// @[<stdin>:765:10, src/src/core/EXE/EXE.scala:30:23]
        id2exe_iddata_control_src2Op = _RANDOM[3'h2][10:8];	// @[<stdin>:765:10, src/src/core/EXE/EXE.scala:30:23]
        id2exe_iddata_control_aluOp = _RANDOM[3'h2][14:11];	// @[<stdin>:765:10, src/src/core/EXE/EXE.scala:30:23]
        id2exe_iddata_control_memOp = _RANDOM[3'h2][17:15];	// @[<stdin>:765:10, src/src/core/EXE/EXE.scala:30:23]
        id2exe_iddata_control_memReadEn = _RANDOM[3'h2][18];	// @[<stdin>:765:10, src/src/core/EXE/EXE.scala:30:23]
        id2exe_iddata_control_memWriteEn = _RANDOM[3'h2][19];	// @[<stdin>:765:10, src/src/core/EXE/EXE.scala:30:23]
        id2exe_iddata_control_wbOp = _RANDOM[3'h2][21:20];	// @[<stdin>:765:10, src/src/core/EXE/EXE.scala:30:23]
        id2exe_iddata_control_halt = _RANDOM[3'h2][22];	// @[<stdin>:765:10, src/src/core/EXE/EXE.scala:30:23]
        id2exe_iddata_reg1 = {_RANDOM[3'h2][31:23], _RANDOM[3'h3][22:0]};	// @[<stdin>:765:10, src/src/core/EXE/EXE.scala:30:23]
        id2exe_iddata_reg2 = {_RANDOM[3'h3][31:23], _RANDOM[3'h4][22:0]};	// @[<stdin>:765:10, src/src/core/EXE/EXE.scala:30:23]
        id2exe_iddata_imm = {_RANDOM[3'h4][31:23], _RANDOM[3'h5][22:0]};	// @[<stdin>:765:10, src/src/core/EXE/EXE.scala:30:23]
        id2exe_iddata_csr = {_RANDOM[3'h5][31:23], _RANDOM[3'h6][22:0]};	// @[<stdin>:765:10, src/src/core/EXE/EXE.scala:30:23]
      `endif // RANDOMIZE_REG_INIT
    end // initial
    `ifdef FIRRTL_AFTER_INITIAL	// @[<stdin>:765:10]
      `FIRRTL_AFTER_INITIAL	// @[<stdin>:765:10]
    `endif // FIRRTL_AFTER_INITIAL
  `endif // ENABLE_INITIAL_REG_
         ...
         : id2exe_iddata_control_src1Op == 3'h2
             ...
             : id2exe_iddata_control_src1Op == 3'h3
                 ...
                 : id2exe_iddata_control_src1Op == 3'h4
                     ? id2exe_iddata_csr
                     : id2exe_iddata_reg1),	// @[<stdin>:765:10, src/main/scala/chisel3/util/Mux.scala:141:16, src/src/core/EXE/EXE.scala:30:23, :52:23, :53:{23,53}, :54:23, :55:23]
    .io_src2
      (id2exe_iddata_control_src2Op == 3'h1
         ...
         : id2exe_iddata_control_src2Op == 3'h2
             ...
             : id2exe_iddata_control_src2Op == 3'h3
                 ? id2exe_iddata_imm
                 : id2exe_iddata_reg2),	// @[<stdin>:765:10, src/main/scala/chisel3/util/Mux.scala:141:16, src/src/core/EXE/EXE.scala:30:23, :53:53, :61:23, :62:23, :63:23]
    .io_out   (_alu_io_out)
  );
  ...
  assign io_exe2mem_valid = wbValid;	// @[<stdin>:765:10, src/src/core/EXE/EXE.scala:20:27]
  assign io_exe2mem_bits_ifdata_pc = id2exe_ifdata_pc;	// @[<stdin>:765:10, src/src/core/EXE/EXE.scala:30:23]
  assign io_exe2mem_bits_ifdata_inst = id2exe_ifdata_inst;	// @[<stdin>:765:10, src/src/core/EXE/EXE.scala:30:23]
  assign io_exe2mem_bits_iddata_control_memOp = id2exe_iddata_control_memOp;	// @[<stdin>:765:10, src/src/core/EXE/EXE.scala:30:23]
  assign io_exe2mem_bits_iddata_control_wbOp = id2exe_iddata_control_wbOp;	// @[<stdin>:765:10, src/src/core/EXE/EXE.scala:30:23]
  assign io_exe2mem_bits_iddata_control_halt = id2exe_iddata_control_halt;	// @[<stdin>:765:10, src/src/core/EXE/EXE.scala:30:23]
  assign io_exe2mem_bits_exedata_aluResult = _alu_io_out;	// @[<stdin>:765:10, src/src/core/EXE/EXE.scala:47:19]
  assign io_exe2global_forward_enable = id2exe_iddata_control_wbOp == 2'h1 & wbValid;	// @[<stdin>:765:10, src/src/core/EXE/EXE.scala:20:27, :30:23, :87:{49,73}]
  assign io_exe2global_forward_wAddr = id2exe_ifdata_inst[11:7];	// @[<stdin>:765:10, src/src/core/EXE/EXE.scala:30:23, :88:39]
  assign io_exe2global_forward_wData = _alu_io_out;	// @[<stdin>:765:10, src/src/core/EXE/EXE.scala:47:19]
  assign io_exe2global_exeMemLoad_loadEn = id2exe_iddata_control_memReadEn;	// @[<stdin>:765:10, src/src/core/EXE/EXE.scala:30:23]
  assign io_exe2global_exeMemLoad_loadAddr = id2exe_ifdata_inst[11:7];	// @[<stdin>:765:10, src/src/core/EXE/EXE.scala:30:23, :88:39]
endmodule

module DataMemReadWrap(	// @[<stdin>:880:10]
    ...
    io_control_memOp == 3'h1
      ...
      : io_control_memOp == 3'h2
          ...
          : io_control_memOp == 3'h3
              ...
              : io_control_memOp == 3'h4 ? {16'h0, shiftData[15:0]} : shiftData;	// @[<stdin>:880:10, src/main/scala/chisel3/util/Mux.scala:141:16, src/src/core/MEM/DataMemWrap.scala:69:31, :73:{22,40,45,59,74}, :74:{22,41}, :75:{22,40,45,59,75}, :76:{22,41}]
endmodule

module MEM(	// @[<stdin>:914:10]
  ...
  output [2:0]  io_mem2wb_bits_iddata_control_memOp,	// @[src/src/core/MEM/MEM.scala:11:14]
  ...
  always @(posedge clock) begin	// @[<stdin>:915:11]
    if (reset) begin	// @[<stdin>:915:11]
      ...
      exe2mem_iddata_control_memOp <= 3'h0;	// @[<stdin>:914:10, src/src/core/MEM/MEM.scala:31:24]
  ...
  `ifdef ENABLE_INITIAL_REG_	// @[<stdin>:914:10]
    ...
    `endif // FIRRTL_BEFORE_INITIAL
    logic [31:0] _RANDOM[0:7];	// @[<stdin>:914:10]
    initial begin	// @[<stdin>:914:10]
      ...
      `ifdef RANDOMIZE_REG_INIT	// @[<stdin>:914:10]
        for (logic [3:0] i = 4'h0; i < 4'h8; i += 4'h1) begin
          _RANDOM[i[2:0]] = `RANDOM;	// @[<stdin>:914:10]
        end	// @[<stdin>:914:10]
        wbValid = _RANDOM[3'h0][0];	// @[<stdin>:914:10, src/src/core/MEM/MEM.scala:21:27]
        exe2mem_ifdata_pc = {_RANDOM[3'h0][31:1], _RANDOM[3'h1][0]};	// @[<stdin>:914:10, src/src/core/MEM/MEM.scala:21:27, :31:24]
        exe2mem_ifdata_inst = {_RANDOM[3'h1][31:1], _RANDOM[3'h2][0]};	// @[<stdin>:914:10, src/src/core/MEM/MEM.scala:31:24]
        exe2mem_iddata_control_memOp = _RANDOM[3'h2][17:15];	// @[<stdin>:914:10, src/src/core/MEM/MEM.scala:31:24]
        exe2mem_iddata_control_wbOp = _RANDOM[3'h2][21:20];	// @[<stdin>:914:10, src/src/core/MEM/MEM.scala:31:24]
        exe2mem_iddata_control_halt = _RANDOM[3'h2][22];	// @[<stdin>:914:10, src/src/core/MEM/MEM.scala:31:24]
        exe2mem_exedata_aluResult = {_RANDOM[3'h6][31:23], _RANDOM[3'h7][22:0]};	// @[<stdin>:914:10, src/src/core/MEM/MEM.scala:31:24]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign io_mem2wb_valid = wbValid;	// @[<stdin>:914:10, src/src/core/MEM/MEM.scala:21:27]
  assign io_mem2wb_bits_ifdata_pc = exe2mem_ifdata_pc;	// @[<stdin>:914:10, src/src/core/MEM/MEM.scala:31:24]
  assign io_mem2wb_bits_ifdata_inst = exe2mem_ifdata_inst;	// @[<stdin>:914:10, src/src/core/MEM/MEM.scala:31:24]
  assign io_mem2wb_bits_iddata_control_memOp = exe2mem_iddata_control_memOp;	// @[<stdin>:914:10, src/src/core/MEM/MEM.scala:31:24]
  assign io_mem2wb_bits_iddata_control_wbOp = exe2mem_iddata_control_wbOp;	// @[<stdin>:914:10, src/src/core/MEM/MEM.scala:31:24]
  assign io_mem2wb_bits_iddata_control_halt = exe2mem_iddata_control_halt;	// @[<stdin>:914:10, src/src/core/MEM/MEM.scala:31:24]
  assign io_mem2wb_bits_exedata_aluResult = exe2mem_exedata_aluResult;	// @[<stdin>:914:10, src/src/core/MEM/MEM.scala:31:24]
  assign io_mem2wb_bits_memdata_memData = _memReadWrap_io_readData;	// @[<stdin>:914:10, src/src/core/MEM/MEM.scala:43:27]
  assign io_mem2global_forward_enable = (|exe2mem_iddata_control_wbOp) & wbValid;	// @[<stdin>:914:10, src/src/core/MEM/MEM.scala:21:27, :31:24, :59:{49,73}]
  assign io_mem2global_forward_wAddr = exe2mem_ifdata_inst[11:7];	// @[<stdin>:914:10, src/src/core/MEM/MEM.scala:31:24, :60:39]
  assign io_mem2global_forward_wData =
    exe2mem_iddata_control_wbOp == 2'h1
      ? exe2mem_exedata_aluResult
      : exe2mem_iddata_control_wbOp == 2'h2 ? _memReadWrap_io_readData : 32'h0;	// @[<stdin>:914:10, src/main/scala/chisel3/util/Mux.scala:141:16, src/src/core/MEM/MEM.scala:31:{24,37}, :43:27, :64:21, :65:21]
endmodule

module WB(	// @[<stdin>:1002:10]
  ...
  `ifdef ENABLE_INITIAL_REG_	// @[<stdin>:1002:10]
    `ifdef FIRRTL_BEFORE_INITIAL	// @[<stdin>:1002:10]
      `FIRRTL_BEFORE_INITIAL	// @[<stdin>:1002:10]
    `endif // FIRRTL_BEFORE_INITIAL
    logic [31:0] _RANDOM[0:9];	// @[<stdin>:1002:10]
    initial begin	// @[<stdin>:1002:10]
      `ifdef INIT_RANDOM_PROLOG_	// @[<stdin>:1002:10]
        `INIT_RANDOM_PROLOG_	// @[<stdin>:1002:10]
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// @[<stdin>:1002:10]
        for (logic [3:0] i = 4'h0; i < 4'hA; i += 4'h1) begin
          _RANDOM[i] = `RANDOM;	// @[<stdin>:1002:10]
        end	// @[<stdin>:1002:10]
        wbValid = _RANDOM[4'h0][0];	// @[<stdin>:1002:10, src/src/core/WB/WB.scala:19:26]
        mem2wb_ifdata_pc = {_RANDOM[4'h0][31:1], _RANDOM[4'h1][0]};	// @[<stdin>:1002:10, src/src/core/WB/WB.scala:19:26, :26:23]
        mem2wb_ifdata_inst = {_RANDOM[4'h1][31:1], _RANDOM[4'h2][0]};	// @[<stdin>:1002:10, src/src/core/WB/WB.scala:26:23]
        mem2wb_iddata_control_memOp = _RANDOM[4'h2][17:15];	// @[<stdin>:1002:10, src/src/core/WB/WB.scala:26:23]
        mem2wb_iddata_control_wbOp = _RANDOM[4'h2][21:20];	// @[<stdin>:1002:10, src/src/core/WB/WB.scala:26:23]
        mem2wb_iddata_control_halt = _RANDOM[4'h2][22];	// @[<stdin>:1002:10, src/src/core/WB/WB.scala:26:23]
        mem2wb_exedata_aluResult = {_RANDOM[4'h6][31:23], _RANDOM[4'h7][22:0]};	// @[<stdin>:1002:10, src/src/core/WB/WB.scala:26:23]
        mem2wb_memdata_memData = {_RANDOM[4'h7][31:23], _RANDOM[4'h8][22:0]};	// @[<stdin>:1002:10, src/src/core/WB/WB.scala:26:23]
        io_wb2global_debug_inst_REG = {_RANDOM[4'h8][31:23], _RANDOM[4'h9][22:0]};	// @[<stdin>:1002:10, src/src/core/WB/WB.scala:26:23, :55:39]
        io_wb2global_debug_device_REG = _RANDOM[4'h9][23];	// @[<stdin>:1002:10, src/src/core/WB/WB.scala:55:39, :56:39]
        io_wb2global_debug_halt_REG = _RANDOM[4'h9][24];	// @[<stdin>:1002:10, src/src/core/WB/WB.scala:55:39, :57:39]
      `endif // RANDOMIZE_REG_INIT
    end // initial
    `ifdef FIRRTL_AFTER_INITIAL	// @[<stdin>:1002:10]
      `FIRRTL_AFTER_INITIAL	// @[<stdin>:1002:10]
    `endif // FIRRTL_AFTER_INITIAL
  `endif // ENABLE_INITIAL_REG_
  assign io_wb2global_debug_valid = wbValid;	// @[<stdin>:1002:10, src/src/core/WB/WB.scala:19:26]
  assign io_wb2global_debug_pc = mem2wb_ifdata_pc;	// @[<stdin>:1002:10, src/src/core/WB/WB.scala:26:23]
  assign io_wb2global_debug_inst = io_wb2global_debug_inst_REG;	// @[<stdin>:1002:10, src/src/core/WB/WB.scala:55:39]
  assign io_wb2global_debug_device = io_wb2global_debug_device_REG;	// @[<stdin>:1002:10, src/src/core/WB/WB.scala:56:39]
  assign io_wb2global_debug_halt = io_wb2global_debug_halt_REG;	// @[<stdin>:1002:10, src/src/core/WB/WB.scala:57:39]
  assign io_wb2global_writeBack_enable = wbValid & (|mem2wb_iddata_control_wbOp);	// @[<stdin>:1002:10, src/src/core/WB/WB.scala:19:26, :26:23, :41:{44,60}]
  assign io_wb2global_writeBack_wAddr = mem2wb_ifdata_inst[11:7];	// @[<stdin>:1002:10, src/src/core/WB/WB.scala:26:23, :36:23]
  assign io_wb2global_writeBack_wData =
    mem2wb_iddata_control_wbOp == 2'h1
      ? mem2wb_exedata_aluResult
      : mem2wb_iddata_control_wbOp == 2'h2 ? mem2wb_memdata_memData : 32'h0;	// @[<stdin>:1002:10, src/main/scala/chisel3/util/Mux.scala:141:16, src/src/core/WB/WB.scala:26:{23,36}, :46:21, :47:21]
endmodule

module CPUTop(	// @[<stdin>:1086:10]
  ...
  output        io_debug_wbDebug_device,	// @[src/src/core/CPUTop.scala:22:14]
                io_debug_wbDebug_halt	// @[src/src/core/CPUTop.scala:22:14]
);
  ...
  wire [2:0]  _memStage_io_mem2wb_bits_iddata_control_memOp;	// @[src/src/core/CPUTop.scala:32:26]
  ...
  wire        _exeStage_io_exe2global_exeMemLoad_loadEn;	// @[src/src/core/CPUTop.scala:31:26]
  wire [4:0]  _exeStage_io_exe2global_exeMemLoad_loadAddr;	// @[src/src/core/CPUTop.scala:31:26]
  ...
  wire [2:0]  _idStage_io_id2exe_bits_iddata_control_src1Op;	// @[src/src/core/CPUTop.scala:30:26]
  wire [2:0]  _idStage_io_id2exe_bits_iddata_control_src2Op;	// @[src/src/core/CPUTop.scala:30:26]
  wire [3:0]  _idStage_io_id2exe_bits_iddata_control_aluOp;	// @[src/src/core/CPUTop.scala:30:26]
  ...
  wire [31:0] _idStage_io_id2exe_bits_iddata_csr;	// @[src/src/core/CPUTop.scala:30:26]
  ...
  ID idStage (	// @[src/src/core/CPUTop.scala:30:26]
    ...
    .io_exeMemLoad_loadEn                     (_exeStage_io_exe2global_exeMemLoad_loadEn),	// @[src/src/core/CPUTop.scala:31:26]
    .io_exeMemLoad_loadAddr
      (_exeStage_io_exe2global_exeMemLoad_loadAddr),	// @[src/src/core/CPUTop.scala:31:26]
  ...
  EXE exeStage (	// @[src/src/core/CPUTop.scala:31:26]
    ...
    .io_id2exe_bits_iddata_csr                (_idStage_io_id2exe_bits_iddata_csr),	// @[src/src/core/CPUTop.scala:30:26]
  ...
  WB wbStage (	// @[src/src/core/CPUTop.scala:33:26]
    ...
    .io_mem2wb_bits_iddata_control_memOp (_memStage_io_mem2wb_bits_iddata_control_memOp),	// @[src/src/core/CPUTop.scala:32:26]
  ...
  assign io_inst_writeEn = 1'h0;	// @[<stdin>:1086:10, src/src/core/CPUTop.scala:28:26]
  assign io_inst_writeData = 32'h0;	// @[<stdin>:1086:10, src/src/core/CPUTop.scala:28:26, :30:26]
  assign io_inst_mark = 4'hF;	// @[<stdin>:1086:10, src/src/core/CPUTop.scala:28:26]
  assign io_debug_regs_0 = 32'h0;	// @[<stdin>:1086:10, src/src/core/CPUTop.scala:28:26, :30:26]
endmodule
