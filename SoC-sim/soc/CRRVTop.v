...
module DecodeStage(	// @[<stdin>:49:10]
  ...
  wire [31:0] flushPC =
    casez_tmp
      ...
      : io_if2id_IF_pc + 32'h4;	// @[CRRV/src/core/pipeline/DecodeStage.scala:23:27, :40:{22,32,41,55}, :42:{32,46,56}, :49:57, :62:51, :73:39, :74:{25,51,65}, :75:25, :76:39, :77:25, :79:{25,62}, src/main/scala/chisel3/util/Lookup.scala:34:39, src/main/scala/chisel3/util/Mux.scala:141:16]
  ...
  assign io_control_flushPc = flushPC;	// @[<stdin>:49:10, CRRV/src/core/pipeline/DecodeStage.scala:79:25]
  ...
  assign io_id2exe_ID_nextpc = flushPC;	// @[<stdin>:49:10, CRRV/src/core/pipeline/DecodeStage.scala:79:25]
...
module PipelineStage_1(	// @[<stdin>:928:10]
  ...
  always @(posedge clock) begin	// @[<stdin>:929:11]
    if (reset) begin	// @[<stdin>:929:11]
      ...
      pipelineReg_ID_nextpc <= 32'h0;	// @[CRRV/src/core/pipeline/PipelineStage.scala:23:28, CRRV/src/io/PipelineStageIO.scala:11:31]
  ...
  assign io_next_ID_nextpc = pipelineReg_ID_nextpc;	// @[<stdin>:928:10, CRRV/src/core/pipeline/PipelineStage.scala:23:28]
...
module Divider(	// @[<stdin>:1071:10]
  ...
  assign io_valid = io_en & ~io_flush & state == 2'h2;	// @[<stdin>:1071:10, CRRV/src/core/muldiv/Divider.scala:38:51, :57:15, :67:{28,38,47}]
  assign io_divresult = opr1Neg ^ opr2Neg ? 32'h0 - quotient : quotient;	// @[<stdin>:1071:10, CRRV/src/core/muldiv/Divider.scala:26:30, :27:30, :28:30, :30:35, :35:47, :43:24, :68:{22,37}]
  assign io_remresult = opr1Neg ? 32'h0 - dividend[63:32] : dividend[63:32];	// @[<stdin>:1071:10, CRRV/src/core/muldiv/Divider.scala:26:30, :30:35, :33:47, :43:24, :65:27, :69:{22,37}]
endmodule

module MDU(	// @[<stdin>:1155:10]
  ...
  assign io_valid = mulEnable ? _multiplier_io_valid : ~divEnable | _divider_io_valid;	// @[<stdin>:1155:10, CRRV/src/core/muldiv/MDU.scala:31:26, :41:23, src/main/scala/chisel3/util/Lookup.scala:34:39, src/main/scala/chisel3/util/Mux.scala:141:16]
  assign io_result =
    mulEnable
      ? (~_GEN & (_GEN_7 | _GEN_2)
      ...
      : divEnable
          ...
          : 32'h0;	// @[<stdin>:1155:10, CRRV/src/core/muldiv/MDU.scala:31:26, :39:{8,36,90}, :41:23, :47:22, src/main/scala/chisel3/util/Lookup.scala:31:38, :34:39, src/main/scala/chisel3/util/Mux.scala:141:16]
endmodule

module ExecuteStage(	// @[<stdin>:1253:10]
  ...
  assign io_control_stallReq = ~_mdu_io_valid;	// @[<stdin>:1253:10, CRRV/src/core/pipeline/ExecuteStage.scala:44:19, :64:26]
  assign io_exe2mem_IF_instValid = io_id2exe_IF_instValid;	// @[<stdin>:1253:10]
  assign io_exe2mem_IF_pc = io_id2exe_IF_pc;	// @[<stdin>:1253:10]
  assign io_exe2mem_ID_inst = io_id2exe_ID_inst;	// @[<stdin>:1253:10]
  assign io_exe2mem_ID_nextpc = io_id2exe_ID_nextpc;	// @[<stdin>:1253:10]
  assign io_exe2mem_ID_lsuOp = io_id2exe_ID_lsuOp;	// @[<stdin>:1253:10]
  assign io_exe2mem_ID_lsuData = io_id2exe_ID_lsuData;	// @[<stdin>:1253:10]
  assign io_exe2mem_ID_regWen = io_id2exe_ID_regWen;	// @[<stdin>:1253:10]
  assign io_exe2mem_ID_regWaddr = io_id2exe_ID_regWaddr;	// @[<stdin>:1253:10]
  assign io_exe2mem_ID_csrOp = io_id2exe_ID_csrOp;	// @[<stdin>:1253:10]
  assign io_exe2mem_ID_csrAddr = io_id2exe_ID_csrAddr;	// @[<stdin>:1253:10]
  assign io_exe2mem_ID_csrWriteData = io_id2exe_ID_csrWriteData;	// @[<stdin>:1253:10]
  assign io_exe2mem_ID_exceptType = io_id2exe_ID_exceptType;	// @[<stdin>:1253:10]
  assign io_exe2mem_EXE_load = load;	// @[<stdin>:1253:10, CRRV/src/core/pipeline/ExecuteStage.scala:61:39]
  assign io_exe2mem_EXE_exeResult = _GEN_0;	// @[<stdin>:1253:10, src/main/scala/chisel3/util/Mux.scala:141:16]
  assign io_csrRead_op = io_id2exe_ID_csrOp;	// @[<stdin>:1253:10]
  assign io_csrRead_addr = io_id2exe_ID_csrAddr;	// @[<stdin>:1253:10]
  assign io_regForward_en = io_id2exe_ID_regWen;	// @[<stdin>:1253:10]
  assign io_regForward_addr = io_id2exe_ID_regWaddr;	// @[<stdin>:1253:10]
  assign io_regForward_data = _GEN_0;	// @[<stdin>:1253:10, src/main/scala/chisel3/util/Mux.scala:141:16]
  assign io_regForward_load = load;	// @[<stdin>:1253:10, CRRV/src/core/pipeline/ExecuteStage.scala:61:39]
endmodule

module PipelineStage_2(	// @[<stdin>:1325:10]
  ...
  assign io_next_IF_instValid = pipelineReg_IF_instValid;	// @[<stdin>:1325:10, CRRV/src/core/pipeline/PipelineStage.scala:23:28]
  assign io_next_IF_pc = pipelineReg_IF_pc;	// @[<stdin>:1325:10, CRRV/src/core/pipeline/PipelineStage.scala:23:28]
  assign io_next_ID_inst = pipelineReg_ID_inst;	// @[<stdin>:1325:10, CRRV/src/core/pipeline/PipelineStage.scala:23:28]
  assign io_next_ID_nextpc = pipelineReg_ID_nextpc;	// @[<stdin>:1325:10, CRRV/src/core/pipeline/PipelineStage.scala:23:28]
  assign io_next_ID_lsuOp = pipelineReg_ID_lsuOp;	// @[<stdin>:1325:10, CRRV/src/core/pipeline/PipelineStage.scala:23:28]
  assign io_next_ID_lsuData = pipelineReg_ID_lsuData;	// @[<stdin>:1325:10, CRRV/src/core/pipeline/PipelineStage.scala:23:28]
  assign io_next_ID_regWen = pipelineReg_ID_regWen;	// @[<stdin>:1325:10, CRRV/src/core/pipeline/PipelineStage.scala:23:28]
  assign io_next_ID_regWaddr = pipelineReg_ID_regWaddr;	// @[<stdin>:1325:10, CRRV/src/core/pipeline/PipelineStage.scala:23:28]
  assign io_next_ID_csrOp = pipelineReg_ID_csrOp;	// @[<stdin>:1325:10, CRRV/src/core/pipeline/PipelineStage.scala:23:28]
  assign io_next_ID_csrAddr = pipelineReg_ID_csrAddr;	// @[<stdin>:1325:10, CRRV/src/core/pipeline/PipelineStage.scala:23:28]
  assign io_next_ID_csrWriteData = pipelineReg_ID_csrWriteData;	// @[<stdin>:1325:10, CRRV/src/core/pipeline/PipelineStage.scala:23:28]
  assign io_next_ID_exceptType = pipelineReg_ID_exceptType;	// @[<stdin>:1325:10, CRRV/src/core/pipeline/PipelineStage.scala:23:28]
  assign io_next_EXE_load = pipelineReg_EXE_load;	// @[<stdin>:1325:10, CRRV/src/core/pipeline/PipelineStage.scala:23:28]
  assign io_next_EXE_exeResult = pipelineReg_EXE_exeResult;	// @[<stdin>:1325:10, CRRV/src/core/pipeline/PipelineStage.scala:23:28]
endmodule

module MemoryStage(	// @[<stdin>:1381:10]
  ...
  assign io_control_stallReq = ~io_dataRam_ready & en;	// @[<stdin>:1381:10, CRRV/src/core/pipeline/MemoryStage.scala:41:{19,38}, src/main/scala/chisel3/util/Lookup.scala:34:39]
  assign io_mem2wb_IF_instValid = io_exe2mem_IF_instValid;	// @[<stdin>:1381:10]
  assign io_mem2wb_IF_pc = io_exe2mem_IF_pc;	// @[<stdin>:1381:10]
  assign io_mem2wb_ID_inst = io_exe2mem_ID_inst;	// @[<stdin>:1381:10]
  assign io_mem2wb_ID_nextpc = io_exe2mem_ID_nextpc;	// @[<stdin>:1381:10]
  assign io_mem2wb_ID_lsuOp = io_exe2mem_ID_lsuOp;	// @[<stdin>:1381:10]
  assign io_mem2wb_ID_regWen = io_exe2mem_ID_regWen;	// @[<stdin>:1381:10]
  assign io_mem2wb_ID_regWaddr = io_exe2mem_ID_regWaddr;	// @[<stdin>:1381:10]
  assign io_mem2wb_ID_csrOp = io_exe2mem_ID_csrOp;	// @[<stdin>:1381:10]
  assign io_mem2wb_ID_csrAddr = io_exe2mem_ID_csrAddr;	// @[<stdin>:1381:10]
  assign io_mem2wb_ID_csrWriteData = io_exe2mem_ID_csrWriteData;	// @[<stdin>:1381:10]
  assign io_mem2wb_ID_exceptType = io_exe2mem_ID_exceptType;	// @[<stdin>:1381:10]
  assign io_mem2wb_EXE_exeResult = io_exe2mem_EXE_exeResult;	// @[<stdin>:1381:10]
  assign io_mem2wb_MEM_memAddr = io_exe2mem_EXE_exeResult;	// @[<stdin>:1381:10]
  assign io_dataRam_valid = en;	// @[<stdin>:1381:10, src/main/scala/chisel3/util/Lookup.scala:34:39]
  assign io_dataRam_bits_addr = io_exe2mem_EXE_exeResult;	// @[<stdin>:1381:10]
  assign io_dataRam_bits_writeEn =
    ~(_GEN | _GEN_0 | _GEN_1 | _GEN_2 | _GEN_3) & (_GEN_7 | _GEN_6);	// @[<stdin>:1381:10, src/main/scala/chisel3/util/Lookup.scala:31:38, :34:39]
  assign io_dataRam_bits_size = width;	// @[<stdin>:1381:10, src/main/scala/chisel3/util/Lookup.scala:34:39]
  assign io_dataRam_bits_wdata = casez_tmp;	// @[<stdin>:1381:10, CRRV/src/core/pipeline/MemoryStage.scala:33:41]
  assign io_memCsrStall_op = io_exe2mem_ID_csrOp;	// @[<stdin>:1381:10]
  assign io_memCsrStall_addr = io_exe2mem_ID_csrAddr;	// @[<stdin>:1381:10]
  assign io_regForward_en = io_exe2mem_ID_regWen;	// @[<stdin>:1381:10]
  assign io_regForward_addr = io_exe2mem_ID_regWaddr;	// @[<stdin>:1381:10]
  assign io_regForward_data = io_exe2mem_EXE_exeResult;	// @[<stdin>:1381:10]
  assign io_regForward_load = io_exe2mem_EXE_load;	// @[<stdin>:1381:10]
endmodule

module PipelineStage_3(	// @[<stdin>:1527:10]
  ...
  assign io_next_IF_instValid = pipelineReg_IF_instValid;	// @[<stdin>:1527:10, CRRV/src/core/pipeline/PipelineStage.scala:23:28]
  assign io_next_IF_pc = pipelineReg_IF_pc;	// @[<stdin>:1527:10, CRRV/src/core/pipeline/PipelineStage.scala:23:28]
  assign io_next_ID_inst = pipelineReg_ID_inst;	// @[<stdin>:1527:10, CRRV/src/core/pipeline/PipelineStage.scala:23:28]
  assign io_next_ID_nextpc = pipelineReg_ID_nextpc;	// @[<stdin>:1527:10, CRRV/src/core/pipeline/PipelineStage.scala:23:28]
  assign io_next_ID_lsuOp = pipelineReg_ID_lsuOp;	// @[<stdin>:1527:10, CRRV/src/core/pipeline/PipelineStage.scala:23:28]
  assign io_next_ID_regWen = pipelineReg_ID_regWen;	// @[<stdin>:1527:10, CRRV/src/core/pipeline/PipelineStage.scala:23:28]
  assign io_next_ID_regWaddr = pipelineReg_ID_regWaddr;	// @[<stdin>:1527:10, CRRV/src/core/pipeline/PipelineStage.scala:23:28]
  assign io_next_ID_csrOp = pipelineReg_ID_csrOp;	// @[<stdin>:1527:10, CRRV/src/core/pipeline/PipelineStage.scala:23:28]
  assign io_next_ID_csrAddr = pipelineReg_ID_csrAddr;	// @[<stdin>:1527:10, CRRV/src/core/pipeline/PipelineStage.scala:23:28]
  assign io_next_ID_csrWriteData = pipelineReg_ID_csrWriteData;	// @[<stdin>:1527:10, CRRV/src/core/pipeline/PipelineStage.scala:23:28]
  assign io_next_ID_exceptType = pipelineReg_ID_exceptType;	// @[<stdin>:1527:10, CRRV/src/core/pipeline/PipelineStage.scala:23:28]
  assign io_next_EXE_exeResult = pipelineReg_EXE_exeResult;	// @[<stdin>:1527:10, CRRV/src/core/pipeline/PipelineStage.scala:23:28]
  assign io_next_MEM_memAddr = pipelineReg_MEM_memAddr;	// @[<stdin>:1527:10, CRRV/src/core/pipeline/PipelineStage.scala:23:28]
endmodule

module WriteBackStage(	// @[<stdin>:1585:10]
  ...
  assign io_wb2csr_op = io_mem2wb_ID_csrOp;	// @[<stdin>:1585:10]
  assign io_wb2csr_addr = io_mem2wb_ID_csrAddr;	// @[<stdin>:1585:10]
  assign io_wb2csr_data = io_mem2wb_ID_csrWriteData;	// @[<stdin>:1585:10]
  assign io_wb2csr_exceptType = io_mem2wb_ID_exceptType;	// @[<stdin>:1585:10]
  assign io_wb2csr_exceptPc = io_mem2wb_IF_pc;	// @[<stdin>:1585:10]
  assign io_regForward_en = io_mem2wb_ID_regWen;	// @[<stdin>:1585:10]
  assign io_regForward_addr = io_mem2wb_ID_regWaddr;	// @[<stdin>:1585:10]
  assign io_regForward_data = regData;	// @[<stdin>:1585:10, CRRV/src/core/pipeline/WriteBackStage.scala:37:20]
  assign io_debug_valid = io_mem2wb_IF_instValid;	// @[<stdin>:1585:10]
  assign io_debug_halt = io_mem2wb_ID_inst == 32'h100073;	// @[<stdin>:1585:10, CRRV/src/core/pipeline/WriteBackStage.scala:52:32]
  assign io_debug_deviceAccess = |io_mem2wb_ID_lsuOp;	// @[<stdin>:1585:10, CRRV/src/core/pipeline/WriteBackStage.scala:37:33]
  assign io_debug_deviceAddr = io_mem2wb_EXE_exeResult;	// @[<stdin>:1585:10]
  assign io_debug_pc = io_mem2wb_ID_nextpc;	// @[<stdin>:1585:10]
  assign io_debug_regWen = io_mem2wb_ID_regWen;	// @[<stdin>:1585:10]
  assign io_debug_regWaddr = io_mem2wb_ID_regWaddr;	// @[<stdin>:1585:10]
  assign io_debug_regWdata = regData;	// @[<stdin>:1585:10, CRRV/src/core/pipeline/WriteBackStage.scala:37:20]
endmodule

module PipelineControl(	// @[<stdin>:1640:10]
  ...
  assign io_stallIF = stall[4];	// @[<stdin>:1640:10, CRRV/src/core/pipeline/PipelineControl.scala:69:23, src/main/scala/chisel3/util/Mux.scala:141:16]
  assign io_stallID = stall[3];	// @[<stdin>:1640:10, CRRV/src/core/pipeline/PipelineControl.scala:70:23, src/main/scala/chisel3/util/Mux.scala:141:16]
  assign io_stallEXE = stall[2];	// @[<stdin>:1640:10, CRRV/src/core/pipeline/PipelineControl.scala:71:23, src/main/scala/chisel3/util/Mux.scala:141:16]
  assign io_stallMEM = stall[1];	// @[<stdin>:1640:10, CRRV/src/core/pipeline/PipelineControl.scala:72:23, src/main/scala/chisel3/util/Mux.scala:141:16]
  assign io_stallWB = stall[0];	// @[<stdin>:1640:10, CRRV/src/core/pipeline/PipelineControl.scala:73:23, src/main/scala/chisel3/util/Mux.scala:141:16]
  assign io_flushAll = |io_exceptType;	// @[<stdin>:1640:10, CRRV/src/core/pipeline/PipelineControl.scala:50:32]
  assign io_flushIF = (|io_exceptType) | io_idFlushReq;	// @[<stdin>:1640:10, CRRV/src/core/pipeline/PipelineControl.scala:50:32, :59:27]
  assign io_flushPc =
    (|io_exceptType)
      ? (io_exceptType == 3'h2
           ? io_csrInfo_mepc
           : io_exceptType == 3'h1 ? io_csrInfo_trapEnterVec : 32'h0)
      : io_idFlushReq ? io_idFlushTarget : 32'h0;	// @[<stdin>:1640:10, CRRV/src/core/pipeline/PipelineControl.scala:14:14, :50:32, :51:44, src/main/scala/chisel3/util/Mux.scala:141:16]
endmodule

module HazardResolver(	// @[<stdin>:1674:10]
      ...
      ? (io_exeForward_en & io_regRead1_addr == io_exeForward_addr
           ...
           : io_memForward_en & io_regRead1_addr == io_memForward_addr
               ...
               : io_wbForward_en & io_regRead1_addr == io_wbForward_addr
                   ? io_wbForward_data
                   : io_regFile1_data)
      : 32'h0;	// @[<stdin>:1674:10, CRRV/src/core/pipeline/HazardResolver.scala:33:{18,31,40}, :34:{29,42,66}, :35:19, :36:{35,48,72}, :37:19, :38:{34,47,70}, :39:19, :41:19, :44:17]
      ...
      ? (io_exeForward_en & io_regRead2_addr == io_exeForward_addr
           ...
           : io_memForward_en & io_regRead2_addr == io_memForward_addr
               ...
               : io_wbForward_en & io_regRead2_addr == io_wbForward_addr
                   ...
                   : io_regFile2_data)
      : 32'h0;	// @[<stdin>:1674:10, CRRV/src/core/pipeline/HazardResolver.scala:33:{18,31,40}, :34:{29,42,66}, :35:19, :36:{35,48,72}, :37:19, :38:{34,47,70}, :39:19, :41:19, :44:17]
  assign io_csrRead_data = io_regCsr_data;	// @[<stdin>:1674:10]
  assign io_regFile1_en = io_regRead1_en;	// @[<stdin>:1674:10]
  assign io_regFile1_addr = io_regRead1_addr;	// @[<stdin>:1674:10]
  assign io_regFile2_en = io_regRead2_en;	// @[<stdin>:1674:10]
  assign io_regFile2_addr = io_regRead2_addr;	// @[<stdin>:1674:10]
  assign io_regCsr_addr = io_csrRead_addr;	// @[<stdin>:1674:10]
  assign io_loadHazardFlag =
    ...
    & (io_exeForward_load & io_regRead2_addr == io_exeForward_addr | io_memForward_load
       & io_regRead2_addr == io_memForward_addr);	// @[<stdin>:1674:10, CRRV/src/core/pipeline/HazardResolver.scala:52:{38,51}, :53:{38,51}, :54:{13,25}, :78:36]
  assign io_csrHazardFlag =
    ...
    & ((|io_memCsrStall_op) & io_memCsrStall_op != 3'h1
       ...
       & io_wbCsrStall_op != 3'h1 & io_csrRead_addr == io_wbCsrStall_addr);	// @[<stdin>:1674:10, CRRV/src/core/pipeline/HazardResolver.scala:58:{26,49}, :59:36, :60:{25,35}, :61:17, :62:34, :63:{24,34}, :64:17, :65:{12,23}]
endmodule

module CsrFile(	// @[<stdin>:1757:10]
  input         clock,	// @[<stdin>:1758:11]
                reset,	// @[<stdin>:1759:11]
  ...
  always @(posedge clock) begin	// @[<stdin>:1758:11]
    if (reset) begin	// @[<stdin>:1758:11]
  ...
  assign io_read_data = readData;	// @[<stdin>:1757:10, CRRV/src/core/regfile/CsrFile.scala:26:47]
  assign io_csrInfo_mepc = mepc;	// @[<stdin>:1757:10, CRRV/src/core/regfile/CsrFile.scala:21:26]
  assign io_csrInfo_trapEnterVec = mtvec;	// @[<stdin>:1757:10, CRRV/src/core/regfile/CsrFile.scala:20:26]
endmodule

module RegFile(	// @[<stdin>:1825:10]
  ...
  regfile_combMem regfile_ext (	// @[CRRV/src/core/regfile/RegFile.scala:15:20]
    ...
    .R0_en   (1'h1),	// @[<stdin>:1825:10]
    .R0_clk  (clock),
    .R1_addr (io_read2_addr),
    .R1_en   (1'h1),	// @[<stdin>:1825:10]
    .R1_clk  (clock),
  ...
  assign io_read1_data = (|io_read1_addr) & io_read1_en ? _regfile_ext_R0_data : 32'h0;	// @[<stdin>:1825:10, CRRV/src/core/regfile/RegFile.scala:15:20, :17:{23,38,46}, :18:23]
  assign io_read2_data = (|io_read2_addr) & io_read2_en ? _regfile_ext_R1_data : 32'h0;	// @[<stdin>:1825:10, CRRV/src/core/regfile/RegFile.scala:15:20, :18:{23,38,46}]
endmodule

module Core(	// @[<stdin>:1848:10]
  input         clock,	// @[<stdin>:1849:11]
                reset,	// @[<stdin>:1850:11]
  ...
  wire [31:0] _mem2wb_io_next_ID_nextpc;	// @[CRRV/src/core/Core.scala:24:30]
  ...
  wire [31:0] _memoryStage_io_mem2wb_ID_nextpc;	// @[CRRV/src/core/Core.scala:23:30]
  ...
  wire [31:0] _exe2mem_io_next_ID_nextpc;	// @[CRRV/src/core/Core.scala:22:30]
  ...
  wire [31:0] _executeStage_io_exe2mem_ID_nextpc;	// @[CRRV/src/core/Core.scala:21:30]
  ...
  wire [31:0] _id2exe_io_next_ID_nextpc;	// @[CRRV/src/core/Core.scala:20:30]
  ...
  wire [31:0] _decodeStage_io_id2exe_ID_nextpc;	// @[CRRV/src/core/Core.scala:19:30]
  ...
  PipelineStage_1 id2exe (	// @[CRRV/src/core/Core.scala:20:30]
    ...
    .io_prev_ID_nextpc       (_decodeStage_io_id2exe_ID_nextpc),	// @[CRRV/src/core/Core.scala:19:30]
  ...
  ExecuteStage executeStage (	// @[CRRV/src/core/Core.scala:21:30]
    ...
    .io_id2exe_ID_nextpc        (_id2exe_io_next_ID_nextpc),	// @[CRRV/src/core/Core.scala:20:30]
  ...
  PipelineStage_2 exe2mem (	// @[CRRV/src/core/Core.scala:22:30]
    ...
    .io_prev_ID_nextpc       (_executeStage_io_exe2mem_ID_nextpc),	// @[CRRV/src/core/Core.scala:21:30]
  ...
  MemoryStage memoryStage (	// @[CRRV/src/core/Core.scala:23:30]
    ...
    .io_exe2mem_ID_nextpc       (_exe2mem_io_next_ID_nextpc),	// @[CRRV/src/core/Core.scala:22:30]
  ...
  PipelineStage_3 mem2wb (	// @[CRRV/src/core/Core.scala:24:30]
    ...
    .io_prev_ID_nextpc       (_memoryStage_io_mem2wb_ID_nextpc),	// @[CRRV/src/core/Core.scala:23:30]
  ...
  WriteBackStage writeBackStage (	// @[CRRV/src/core/Core.scala:25:30]
    ...
    .io_mem2wb_ID_nextpc       (_mem2wb_io_next_ID_nextpc),	// @[CRRV/src/core/Core.scala:24:30]
...
module SimpleXbar(	// @[<stdin>:2033:10]
  ...
  SimpleMux2 mux2 (	// @[CRRV/src/bus/SimpleXbar.scala:16:23]
    .clock                    (clock),
    .io_sel2                  (io_simpleIn_out_bits_addr[31:16] == 16'h200),	// @[CRRV/src/bus/SimpleXbar.scala:15:{42,51}]
...
module Simple2AXI4(	// @[<stdin>:2086:10]
  ...
  reg  [2:0]  casez_tmp;	// @[CRRV/src/bus/Simple2AXI4.scala:27:17, :29:63]
  reg  [14:0] casez_tmp_0;	// @[CRRV/src/bus/Simple2AXI4.scala:70:39]
  ...
  wire        _GEN = io_simple_out_valid & io_simple_out_bits_writeEn;	// @[CRRV/src/bus/Simple2AXI4.scala:29:32]
  wire        _GEN_0 =
    io_simple_out_valid & ~io_simple_out_bits_writeEn & addr != io_simple_out_bits_addr;	// @[CRRV/src/bus/Simple2AXI4.scala:25:18, :32:{41,69,77}]
  wire        _GEN_1 = io_axi_r_valid & io_axi_r_bits_last;	// @[CRRV/src/bus/Simple2AXI4.scala:43:27]
  always_comb begin	// @[CRRV/src/bus/Simple2AXI4.scala:22:30, :27:17, :29:63, :38:29, :43:50, :49:48, :56:28, :61:13]
    casez (state)	// @[CRRV/src/bus/Simple2AXI4.scala:22:30, :27:17, :29:63, :38:29, :43:50, :49:48, :56:28, :61:13]
      3'b000:
        casez_tmp = _GEN ? 3'h3 : _GEN_0 ? 3'h1 : state;	// @[CRRV/src/bus/Simple2AXI4.scala:22:30, :27:17, :29:{32,63}, :30:15, :32:{69,106}, :33:15, :38:29, :43:50, :49:48, :56:28, :61:13]
      3'b001:
        casez_tmp = io_axi_ar_ready ? 3'h2 : state;	// @[CRRV/src/bus/Simple2AXI4.scala:22:30, :27:17, :29:63, :38:29, :39:15, :43:50, :49:48, :56:28, :61:13]
      3'b010:
        casez_tmp = _GEN_1 ? 3'h5 : state;	// @[CRRV/src/bus/Simple2AXI4.scala:22:30, :27:17, :29:63, :38:29, :43:{27,50}, :45:15, :49:48, :56:28, :61:13]
      3'b011:
        casez_tmp =
          io_axi_aw_ready & ~io_axi_w_ready
            ? 3'h4
            : io_axi_aw_ready & io_axi_w_ready ? 3'h5 : state;	// @[CRRV/src/bus/Simple2AXI4.scala:22:30, :27:17, :29:63, :38:29, :43:50, :45:15, :49:{28,31,48}, :50:15, :51:{34,53}, :52:15, :56:28, :61:13]
      3'b100:
        casez_tmp = io_axi_w_ready ? 3'h5 : state;	// @[CRRV/src/bus/Simple2AXI4.scala:22:30, :27:17, :29:63, :38:29, :43:50, :45:15, :49:48, :56:28, :57:15, :61:13]
      3'b101:
        casez_tmp = 3'h0;	// @[CRRV/src/bus/Simple2AXI4.scala:22:30, :27:17, :29:63, :38:29, :43:50, :49:48, :56:28, :61:13]
      3'b110:
        casez_tmp = state;	// @[CRRV/src/bus/Simple2AXI4.scala:22:30, :27:17, :29:63, :38:29, :43:50, :49:48, :56:28, :61:13]
      default:
        casez_tmp = state;	// @[CRRV/src/bus/Simple2AXI4.scala:22:30, :27:17, :29:63, :38:29, :43:50, :49:48, :56:28, :61:13]
    endcase	// @[CRRV/src/bus/Simple2AXI4.scala:22:30, :27:17, :29:63, :38:29, :43:50, :49:48, :56:28, :61:13]
  end // always_comb
  wire [14:0] _GEN_2 = {12'h0, addr[2:0]};	// @[CRRV/src/bus/Simple2AXI4.scala:25:18, :72:{30,37}]
  always_comb begin	// @[CRRV/src/bus/Simple2AXI4.scala:70:39]
    casez (io_simple_out_bits_size)	// @[CRRV/src/bus/Simple2AXI4.scala:70:39]
      2'b00:
        casez_tmp_0 = 15'h1 << _GEN_2;	// @[CRRV/src/bus/Simple2AXI4.scala:70:39, :72:30]
      2'b01:
        casez_tmp_0 = 15'h3 << _GEN_2;	// @[CRRV/src/bus/Simple2AXI4.scala:70:39, :72:30, :73:30]
      2'b10:
        casez_tmp_0 = 15'hF << _GEN_2;	// @[CRRV/src/bus/Simple2AXI4.scala:70:39, :72:30, :74:30]
      default:
        casez_tmp_0 = 15'h0;	// @[CRRV/src/bus/Simple2AXI4.scala:70:39]
    endcase	// @[CRRV/src/bus/Simple2AXI4.scala:70:39]
  end // always_comb
  wire [2:0]  _GEN_3 = {1'h0, io_simple_out_bits_size};	// @[CRRV/src/bus/Simple2AXI4.scala:70:39, :81:23]
  wire        _io_axi_w_bits_last_T = state == 3'h3;	// @[CRRV/src/bus/Simple2AXI4.scala:22:30, :30:15, :83:32]
  wire        _io_axi_w_bits_last_T_1 = state == 3'h4;	// @[CRRV/src/bus/Simple2AXI4.scala:22:30, :50:15, :86:52]
  wire        _GEN_4 = state == 3'h0;	// @[CRRV/src/bus/Simple2AXI4.scala:22:30, :27:17]
  always @(posedge clock) begin	// @[<stdin>:2087:11]
    if (reset)	// @[<stdin>:2087:11]
      state <= 3'h0;	// @[CRRV/src/bus/Simple2AXI4.scala:22:30]
    else	// @[<stdin>:2087:11]
      state <= casez_tmp;	// @[CRRV/src/bus/Simple2AXI4.scala:22:30, :27:17, :29:63]
    if (_GEN_4 | state == 3'h1 | ~(state == 3'h2 & _GEN_1)) begin	// @[CRRV/src/bus/Simple2AXI4.scala:22:30, :24:18, :27:17, :33:15, :39:15, :43:{27,50}, :44:15]
    end
    else	// @[CRRV/src/bus/Simple2AXI4.scala:24:18, :27:17]
      rdata <= io_axi_r_bits_data;	// @[CRRV/src/bus/Simple2AXI4.scala:24:18]
    if (_GEN_4 & (_GEN | _GEN_0))	// @[CRRV/src/bus/Simple2AXI4.scala:25:18, :27:17, :29:{32,63}, :31:15, :32:{69,106}, :34:15]
      addr <= io_simple_out_bits_addr;	// @[CRRV/src/bus/Simple2AXI4.scala:25:18]
  end // always @(posedge)
  assign io_simple_out_ready = state == 3'h5 & addr == io_simple_out_bits_addr;	// @[<stdin>:2086:10, CRRV/src/bus/Simple2AXI4.scala:22:30, :25:18, :45:15, :65:{33,43,52}]
  assign io_simple_in_rdata = addr[2] ? rdata[63:32] : rdata[31:0];	// @[<stdin>:2086:10, CRRV/src/bus/Simple2AXI4.scala:24:18, :25:18, :66:{29,34,44,59}]
  assign io_axi_ar_valid = state == 3'h1;	// @[<stdin>:2086:10, CRRV/src/bus/Simple2AXI4.scala:22:30, :33:15, :79:32]
  assign io_axi_ar_bits_addr = addr;	// @[<stdin>:2086:10, CRRV/src/bus/Simple2AXI4.scala:25:18]
  assign io_axi_ar_bits_size = _GEN_3;	// @[<stdin>:2086:10, CRRV/src/bus/Simple2AXI4.scala:81:23]
  assign io_axi_aw_valid = _io_axi_w_bits_last_T;	// @[<stdin>:2086:10, CRRV/src/bus/Simple2AXI4.scala:83:32]
  assign io_axi_aw_bits_addr = addr;	// @[<stdin>:2086:10, CRRV/src/bus/Simple2AXI4.scala:25:18]
  assign io_axi_aw_bits_size = _GEN_3;	// @[<stdin>:2086:10, CRRV/src/bus/Simple2AXI4.scala:81:23]
  assign io_axi_w_valid = _io_axi_w_bits_last_T | _io_axi_w_bits_last_T_1;	// @[<stdin>:2086:10, CRRV/src/bus/Simple2AXI4.scala:83:32, :86:{43,52}]
  assign io_axi_w_bits_data = {2{io_simple_out_bits_wdata}};	// @[<stdin>:2086:10, CRRV/src/bus/Simple2AXI4.scala:68:21]
  assign io_axi_w_bits_strb = casez_tmp_0[7:0];	// @[<stdin>:2086:10, CRRV/src/bus/Simple2AXI4.scala:70:39, :89:23]
  assign io_axi_w_bits_last = _io_axi_w_bits_last_T | _io_axi_w_bits_last_T_1;	// @[<stdin>:2086:10, CRRV/src/bus/Simple2AXI4.scala:83:32, :86:52, :88:43]
endmodule

// external module Debug

module CRRVTop(	// @[<stdin>:2216:10]
  ...
  wire        _core_io_debug_deviceAccess;	// @[CRRV/src/CRRVTop.scala:13:26]
  wire [31:0] _core_io_debug_deviceAddr;	// @[CRRV/src/CRRVTop.scala:13:26]
  ...
  Debug debug (	// @[CRRV/src/CRRVTop.scala:18:26]
    ...
    .debug_deviceAccess (_core_io_debug_deviceAccess),	// @[CRRV/src/CRRVTop.scala:13:26]
    .debug_deviceAddr   (_core_io_debug_deviceAddr),	// @[CRRV/src/CRRVTop.scala:13:26]
  ...
  assign io_master_awid = 4'h0;	// @[<stdin>:2216:10, CRRV/src/CRRVTop.scala:17:26]
  assign io_master_awlen = 8'h0;	// @[<stdin>:2216:10, CRRV/src/CRRVTop.scala:17:26]
  assign io_master_awburst = 2'h0;	// @[<stdin>:2216:10, CRRV/src/CRRVTop.scala:17:26]
  assign io_master_bready = 1'h1;	// @[<stdin>:2216:10, CRRV/src/CRRVTop.scala:13:26, :14:26, :15:26, :16:26, :17:26]
  assign io_master_arid = 4'h0;	// @[<stdin>:2216:10, CRRV/src/CRRVTop.scala:17:26]
  assign io_master_arlen = 8'h0;	// @[<stdin>:2216:10, CRRV/src/CRRVTop.scala:17:26]
  assign io_master_arburst = 2'h0;	// @[<stdin>:2216:10, CRRV/src/CRRVTop.scala:17:26]
  assign io_master_rready = 1'h1;	// @[<stdin>:2216:10, CRRV/src/CRRVTop.scala:13:26, :14:26, :15:26, :16:26, :17:26]
  assign io_slave_awready = 1'h0;	// @[<stdin>:2216:10, CRRV/src/CRRVTop.scala:13:26, :14:26]
  assign io_slave_wready = 1'h0;	// @[<stdin>:2216:10, CRRV/src/CRRVTop.scala:13:26, :14:26]
  assign io_slave_bvalid = 1'h0;	// @[<stdin>:2216:10, CRRV/src/CRRVTop.scala:13:26, :14:26]
  assign io_slave_bresp = 2'h0;	// @[<stdin>:2216:10, CRRV/src/CRRVTop.scala:17:26]
  assign io_slave_bid = 4'h0;	// @[<stdin>:2216:10, CRRV/src/CRRVTop.scala:17:26]
  assign io_slave_arready = 1'h0;	// @[<stdin>:2216:10, CRRV/src/CRRVTop.scala:13:26, :14:26]
  assign io_slave_rvalid = 1'h0;	// @[<stdin>:2216:10, CRRV/src/CRRVTop.scala:13:26, :14:26]
  assign io_slave_rresp = 2'h0;	// @[<stdin>:2216:10, CRRV/src/CRRVTop.scala:17:26]
  assign io_slave_rdata = 64'h0;	// @[<stdin>:2216:10, CRRV/src/CRRVTop.scala:75:20]
  assign io_slave_rlast = 1'h0;	// @[<stdin>:2216:10, CRRV/src/CRRVTop.scala:13:26, :14:26]
  assign io_slave_rid = 4'h0;	// @[<stdin>:2216:10, CRRV/src/CRRVTop.scala:17:26]
endmodule
