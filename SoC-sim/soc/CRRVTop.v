...
module CsrFile(	// @[<stdin>:1753:10]
  ...
  assign io_read_data = readData;	// @[<stdin>:1753:10, CRRV/src/core/regfile/CsrFile.scala:26:47]
  assign io_csrInfo_mepc = mepc;	// @[<stdin>:1753:10, CRRV/src/core/regfile/CsrFile.scala:21:26]
  assign io_csrInfo_trapEnterVec = mtvec;	// @[<stdin>:1753:10, CRRV/src/core/regfile/CsrFile.scala:20:26]
endmodule

module RegFile(	// @[<stdin>:1821:10]
  ...
  regfile_combMem regfile_ext (	// @[CRRV/src/core/regfile/RegFile.scala:15:20]
    ...
    .R0_en   (1'h1),	// @[<stdin>:1821:10]
    .R0_clk  (clock),
    .R1_addr (io_read2_addr),
    .R1_en   (1'h1),	// @[<stdin>:1821:10]
    .R1_clk  (clock),
  ...
  assign io_read1_data = (|io_read1_addr) & io_read1_en ? _regfile_ext_R0_data : 32'h0;	// @[<stdin>:1821:10, CRRV/src/core/regfile/RegFile.scala:15:20, :17:{23,38,46}, :18:23]
  assign io_read2_data = (|io_read2_addr) & io_read2_en ? _regfile_ext_R1_data : 32'h0;	// @[<stdin>:1821:10, CRRV/src/core/regfile/RegFile.scala:15:20, :18:{23,38,46}]
endmodule

module Core(	// @[<stdin>:1844:10]
  input         clock,	// @[<stdin>:1845:11]
                reset,	// @[<stdin>:1846:11]
...
module SimpleArbiter(	// @[<stdin>:1950:10]
  input         clock,	// @[<stdin>:1951:11]
                reset,	// @[<stdin>:1952:11]
  ...
  always @(posedge clock) begin	// @[<stdin>:1951:11]
    if (reset)	// @[<stdin>:1951:11]
      state <= 3'h0;	// @[CRRV/src/bus/SimpleArbiter.scala:21:46]
    else	// @[<stdin>:1951:11]
      state <= casez_tmp;	// @[CRRV/src/bus/SimpleArbiter.scala:21:46, :23:17, :25:37]
  end // always @(posedge)
  assign io_simpleInst_out_ready = _io_simpleInst_out_ready_output;	// @[<stdin>:1950:10, CRRV/src/bus/SimpleArbiter.scala:49:38]
  assign io_simpleInst_in_rdata = io_simpleOut_in_rdata;	// @[<stdin>:1950:10]
  assign io_simpleData_out_ready = _io_simpleData_out_ready_output;	// @[<stdin>:1950:10, CRRV/src/bus/SimpleArbiter.scala:52:38]
  assign io_simpleData_in_rdata = io_simpleOut_in_rdata;	// @[<stdin>:1950:10]
  assign io_simpleOut_out_valid = _io_simpleOut_out_valid_T | _io_simpleOut_out_valid_T_1;	// @[<stdin>:1950:10, CRRV/src/bus/SimpleArbiter.scala:46:24, :47:24, :55:52]
  assign io_simpleOut_out_bits_addr =
    selData ? io_simpleData_out_bits_addr : io_simpleInst_out_bits_addr;	// @[<stdin>:1950:10, CRRV/src/bus/SimpleArbiter.scala:47:35, :57:39]
  assign io_simpleOut_out_bits_writeEn = selData & io_simpleData_out_bits_writeEn;	// @[<stdin>:1950:10, CRRV/src/bus/SimpleArbiter.scala:47:35, :58:39]
  assign io_simpleOut_out_bits_size = selData ? io_simpleData_out_bits_size : 2'h2;	// @[<stdin>:1950:10, CRRV/src/bus/SimpleArbiter.scala:13:14, :47:35, :56:39]
  assign io_simpleOut_out_bits_wdata = selData ? io_simpleData_out_bits_wdata : 32'h0;	// @[<stdin>:1950:10, CRRV/src/bus/SimpleArbiter.scala:13:14, :47:35, :59:39]
endmodule

module SimpleMux2(	// @[<stdin>:2009:10]
  input         clock,	// @[<stdin>:2010:11]
  ...
  always @(posedge clock)	// @[<stdin>:2010:11]
    readSel <= io_sel2;	// @[CRRV/src/bus/SimpleUtils.scala:16:24]
  assign io_in_out_ready = io_sel2 | io_out1_out_ready;	// @[<stdin>:2009:10, CRRV/src/bus/SimpleUtils.scala:20:25]
  assign io_in_in_rdata = readSel ? io_out2_in_rdata : io_out1_in_rdata;	// @[<stdin>:2009:10, CRRV/src/bus/SimpleUtils.scala:16:24, :18:24]
  assign io_out1_out_valid = io_in_out_valid & ~io_sel2;	// @[<stdin>:2009:10, CRRV/src/bus/SimpleUtils.scala:22:{40,43}]
  assign io_out1_out_bits_addr = io_in_out_bits_addr;	// @[<stdin>:2009:10]
  assign io_out1_out_bits_writeEn = io_in_out_bits_writeEn;	// @[<stdin>:2009:10]
  assign io_out1_out_bits_size = io_in_out_bits_size;	// @[<stdin>:2009:10]
  assign io_out1_out_bits_wdata = io_in_out_bits_wdata;	// @[<stdin>:2009:10]
  assign io_out2_out_bits_addr = io_in_out_bits_addr;	// @[<stdin>:2009:10]
endmodule

module SimpleXbar(	// @[<stdin>:2029:10]
  input         clock,	// @[<stdin>:2030:11]
...
module CLINT(	// @[<stdin>:2050:10]
  ...
  always @(posedge clock) begin	// @[<stdin>:2051:11]
    if (reset) begin	// @[<stdin>:2051:11]
  ...
  assign io_in_rdata = outputData;	// @[<stdin>:2050:10, CRRV/src/bus/CLINT.scala:24:27]
endmodule

module Simple2AXI4(	// @[<stdin>:2082:10]
  input         clock,	// @[<stdin>:2083:11]
                reset,	// @[<stdin>:2084:11]
  ...
  always @(posedge clock) begin	// @[<stdin>:2083:11]
    if (reset)	// @[<stdin>:2083:11]
  ...
  assign io_simple_out_ready = state == 3'h5 & addr == io_simple_out_bits_addr;	// @[<stdin>:2082:10, CRRV/src/bus/Simple2AXI4.scala:22:30, :25:18, :42:15, :62:{33,43,52}]
  assign io_simple_in_rdata = addr[2] ? rdata[63:32] : rdata[31:0];	// @[<stdin>:2082:10, CRRV/src/bus/Simple2AXI4.scala:24:18, :25:18, :63:{29,34,44,59}]
  assign io_axi_ar_valid = state == 3'h1;	// @[<stdin>:2082:10, CRRV/src/bus/Simple2AXI4.scala:22:30, :30:21, :76:33]
  assign io_axi_ar_bits_addr = addr;	// @[<stdin>:2082:10, CRRV/src/bus/Simple2AXI4.scala:25:18]
  assign io_axi_ar_bits_size = _GEN_1;	// @[<stdin>:2082:10, CRRV/src/bus/Simple2AXI4.scala:78:24]
  assign io_axi_aw_valid = _io_axi_w_bits_last_T;	// @[<stdin>:2082:10, CRRV/src/bus/Simple2AXI4.scala:80:33]
  assign io_axi_aw_bits_addr = addr;	// @[<stdin>:2082:10, CRRV/src/bus/Simple2AXI4.scala:25:18]
  assign io_axi_aw_bits_size = _GEN_1;	// @[<stdin>:2082:10, CRRV/src/bus/Simple2AXI4.scala:78:24]
  assign io_axi_w_valid = _io_axi_w_bits_last_T | _io_axi_w_bits_last_T_1;	// @[<stdin>:2082:10, CRRV/src/bus/Simple2AXI4.scala:80:33, :83:{44,53}]
  assign io_axi_w_bits_data = {2{io_simple_out_bits_wdata}};	// @[<stdin>:2082:10, CRRV/src/bus/Simple2AXI4.scala:65:21]
  assign io_axi_w_bits_strb = casez_tmp_0[7:0];	// @[<stdin>:2082:10, CRRV/src/bus/Simple2AXI4.scala:67:39, :86:24]
  assign io_axi_w_bits_last = _io_axi_w_bits_last_T | _io_axi_w_bits_last_T_1;	// @[<stdin>:2082:10, CRRV/src/bus/Simple2AXI4.scala:80:33, :83:53, :85:44]
endmodule

// external module Debug

module CRRVTop(	// @[<stdin>:2204:10]
  input         clock,	// @[<stdin>:2205:11]
                reset,	// @[<stdin>:2206:11]
  ...
  assign io_master_awid = 4'h0;	// @[<stdin>:2204:10, CRRV/src/CRRVTop.scala:17:26]
  assign io_master_awlen = 8'h0;	// @[<stdin>:2204:10, CRRV/src/CRRVTop.scala:17:26]
  assign io_master_awburst = 2'h0;	// @[<stdin>:2204:10, CRRV/src/CRRVTop.scala:17:26]
  assign io_master_bready = 1'h1;	// @[<stdin>:2204:10, CRRV/src/CRRVTop.scala:13:26, :14:26, :15:26, :16:26, :17:26]
  assign io_master_arid = 4'h0;	// @[<stdin>:2204:10, CRRV/src/CRRVTop.scala:17:26]
  assign io_master_arlen = 8'h0;	// @[<stdin>:2204:10, CRRV/src/CRRVTop.scala:17:26]
  assign io_master_arburst = 2'h0;	// @[<stdin>:2204:10, CRRV/src/CRRVTop.scala:17:26]
  assign io_master_rready = 1'h1;	// @[<stdin>:2204:10, CRRV/src/CRRVTop.scala:13:26, :14:26, :15:26, :16:26, :17:26]
  assign io_slave_awready = 1'h0;	// @[<stdin>:2204:10, CRRV/src/CRRVTop.scala:13:26, :14:26]
  assign io_slave_wready = 1'h0;	// @[<stdin>:2204:10, CRRV/src/CRRVTop.scala:13:26, :14:26]
  assign io_slave_bvalid = 1'h0;	// @[<stdin>:2204:10, CRRV/src/CRRVTop.scala:13:26, :14:26]
  assign io_slave_bresp = 2'h0;	// @[<stdin>:2204:10, CRRV/src/CRRVTop.scala:17:26]
  assign io_slave_bid = 4'h0;	// @[<stdin>:2204:10, CRRV/src/CRRVTop.scala:17:26]
  assign io_slave_arready = 1'h0;	// @[<stdin>:2204:10, CRRV/src/CRRVTop.scala:13:26, :14:26]
  assign io_slave_rvalid = 1'h0;	// @[<stdin>:2204:10, CRRV/src/CRRVTop.scala:13:26, :14:26]
  assign io_slave_rresp = 2'h0;	// @[<stdin>:2204:10, CRRV/src/CRRVTop.scala:17:26]
  assign io_slave_rdata = 64'h0;	// @[<stdin>:2204:10, CRRV/src/CRRVTop.scala:75:20]
  assign io_slave_rlast = 1'h0;	// @[<stdin>:2204:10, CRRV/src/CRRVTop.scala:13:26, :14:26]
  assign io_slave_rid = 4'h0;	// @[<stdin>:2204:10, CRRV/src/CRRVTop.scala:17:26]
endmodule
