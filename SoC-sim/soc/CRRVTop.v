...
module ExecuteStage(	// @[<stdin>:1252:10]
  ...
  assign io_exe2mem_ID_nextpc = io_id2exe_ID_nextpc;	// @[<stdin>:1252:10]
...
module PipelineStage_2(	// @[<stdin>:1324:10]
  ...
  assign io_next_ID_nextpc = pipelineReg_ID_nextpc;	// @[<stdin>:1324:10, CRRV/src/core/pipeline/PipelineStage.scala:23:28]
...
module MemoryStage(	// @[<stdin>:1380:10]
  ...
  assign io_mem2wb_ID_nextpc = io_exe2mem_ID_nextpc;	// @[<stdin>:1380:10]
...
module PipelineStage_3(	// @[<stdin>:1526:10]
  ...
  assign io_next_ID_nextpc = pipelineReg_ID_nextpc;	// @[<stdin>:1526:10, CRRV/src/core/pipeline/PipelineStage.scala:23:28]
...
module WriteBackStage(	// @[<stdin>:1584:10]
  ...
  assign io_debug_deviceAccess = |io_mem2wb_ID_lsuOp;	// @[<stdin>:1584:10, CRRV/src/core/pipeline/WriteBackStage.scala:37:33]
  assign io_debug_deviceAddr = io_mem2wb_EXE_exeResult;	// @[<stdin>:1584:10]
  assign io_debug_pc = io_mem2wb_ID_nextpc;	// @[<stdin>:1584:10]
...
module PipelineControl(	// @[<stdin>:1639:10]
  ...
  assign io_stallIF = stall[4];	// @[<stdin>:1639:10, CRRV/src/core/pipeline/PipelineControl.scala:69:23, src/main/scala/chisel3/util/Mux.scala:141:16]
  assign io_stallID = stall[3];	// @[<stdin>:1639:10, CRRV/src/core/pipeline/PipelineControl.scala:70:23, src/main/scala/chisel3/util/Mux.scala:141:16]
  assign io_stallEXE = stall[2];	// @[<stdin>:1639:10, CRRV/src/core/pipeline/PipelineControl.scala:71:23, src/main/scala/chisel3/util/Mux.scala:141:16]
  assign io_stallMEM = stall[1];	// @[<stdin>:1639:10, CRRV/src/core/pipeline/PipelineControl.scala:72:23, src/main/scala/chisel3/util/Mux.scala:141:16]
  assign io_stallWB = stall[0];	// @[<stdin>:1639:10, CRRV/src/core/pipeline/PipelineControl.scala:73:23, src/main/scala/chisel3/util/Mux.scala:141:16]
  assign io_flushAll = |io_exceptType;	// @[<stdin>:1639:10, CRRV/src/core/pipeline/PipelineControl.scala:50:32]
  assign io_flushIF = (|io_exceptType) | io_idFlushReq;	// @[<stdin>:1639:10, CRRV/src/core/pipeline/PipelineControl.scala:50:32, :59:27]
  assign io_flushPc =
    (|io_exceptType)
      ? (io_exceptType == 3'h2
           ? io_csrInfo_mepc
           : io_exceptType == 3'h1 ? io_csrInfo_trapEnterVec : 32'h0)
      : io_idFlushReq ? io_idFlushTarget : 32'h0;	// @[<stdin>:1639:10, CRRV/src/core/pipeline/PipelineControl.scala:14:14, :50:32, :51:44, src/main/scala/chisel3/util/Mux.scala:141:16]
endmodule

module HazardResolver(	// @[<stdin>:1673:10]
      ...
      ? (io_exeForward_en & io_regRead1_addr == io_exeForward_addr
           ...
           : io_memForward_en & io_regRead1_addr == io_memForward_addr
               ...
               : io_wbForward_en & io_regRead1_addr == io_wbForward_addr
                   ? io_wbForward_data
                   : io_regFile1_data)
      : 32'h0;	// @[<stdin>:1673:10, CRRV/src/core/pipeline/HazardResolver.scala:33:{18,31,40}, :34:{29,42,66}, :35:19, :36:{35,48,72}, :37:19, :38:{34,47,70}, :39:19, :41:19, :44:17]
      ...
      ? (io_exeForward_en & io_regRead2_addr == io_exeForward_addr
           ...
           : io_memForward_en & io_regRead2_addr == io_memForward_addr
               ...
               : io_wbForward_en & io_regRead2_addr == io_wbForward_addr
                   ...
                   : io_regFile2_data)
      : 32'h0;	// @[<stdin>:1673:10, CRRV/src/core/pipeline/HazardResolver.scala:33:{18,31,40}, :34:{29,42,66}, :35:19, :36:{35,48,72}, :37:19, :38:{34,47,70}, :39:19, :41:19, :44:17]
  assign io_csrRead_data = io_regCsr_data;	// @[<stdin>:1673:10]
  assign io_regFile1_en = io_regRead1_en;	// @[<stdin>:1673:10]
  assign io_regFile1_addr = io_regRead1_addr;	// @[<stdin>:1673:10]
  assign io_regFile2_en = io_regRead2_en;	// @[<stdin>:1673:10]
  assign io_regFile2_addr = io_regRead2_addr;	// @[<stdin>:1673:10]
  assign io_regCsr_addr = io_csrRead_addr;	// @[<stdin>:1673:10]
  assign io_loadHazardFlag =
    ...
    & (io_exeForward_load & io_regRead2_addr == io_exeForward_addr | io_memForward_load
       & io_regRead2_addr == io_memForward_addr);	// @[<stdin>:1673:10, CRRV/src/core/pipeline/HazardResolver.scala:52:{38,51}, :53:{38,51}, :54:{13,25}, :78:36]
  assign io_csrHazardFlag =
    ...
    & ((|io_memCsrStall_op) & io_memCsrStall_op != 3'h1
       ...
       & io_wbCsrStall_op != 3'h1 & io_csrRead_addr == io_wbCsrStall_addr);	// @[<stdin>:1673:10, CRRV/src/core/pipeline/HazardResolver.scala:58:{26,49}, :59:36, :60:{25,35}, :61:17, :62:34, :63:{24,34}, :64:17, :65:{12,23}]
endmodule

module CsrFile(	// @[<stdin>:1756:10]
  input         clock,	// @[<stdin>:1757:11]
                reset,	// @[<stdin>:1758:11]
  ...
  always @(posedge clock) begin	// @[<stdin>:1757:11]
    if (reset) begin	// @[<stdin>:1757:11]
  ...
  assign io_read_data = readData;	// @[<stdin>:1756:10, CRRV/src/core/regfile/CsrFile.scala:26:47]
  assign io_csrInfo_mepc = mepc;	// @[<stdin>:1756:10, CRRV/src/core/regfile/CsrFile.scala:21:26]
  assign io_csrInfo_trapEnterVec = mtvec;	// @[<stdin>:1756:10, CRRV/src/core/regfile/CsrFile.scala:20:26]
endmodule
...
module SimpleArbiter(	// @[<stdin>:1953:10]
  input         clock,	// @[<stdin>:1954:11]
                reset,	// @[<stdin>:1955:11]
  ...
  always @(posedge clock) begin	// @[<stdin>:1954:11]
    if (reset)	// @[<stdin>:1954:11]
      state <= 3'h0;	// @[CRRV/src/bus/SimpleArbiter.scala:21:46]
    else	// @[<stdin>:1954:11]
      state <= casez_tmp;	// @[CRRV/src/bus/SimpleArbiter.scala:21:46, :23:17, :25:37]
  end // always @(posedge)
  assign io_simpleInst_out_ready = _io_simpleInst_out_ready_output;	// @[<stdin>:1953:10, CRRV/src/bus/SimpleArbiter.scala:49:38]
  assign io_simpleInst_in_rdata = io_simpleOut_in_rdata;	// @[<stdin>:1953:10]
  assign io_simpleData_out_ready = _io_simpleData_out_ready_output;	// @[<stdin>:1953:10, CRRV/src/bus/SimpleArbiter.scala:52:38]
  assign io_simpleData_in_rdata = io_simpleOut_in_rdata;	// @[<stdin>:1953:10]
  assign io_simpleOut_out_valid = _io_simpleOut_out_valid_T | _io_simpleOut_out_valid_T_1;	// @[<stdin>:1953:10, CRRV/src/bus/SimpleArbiter.scala:46:24, :47:24, :55:52]
  assign io_simpleOut_out_bits_addr =
    selData ? io_simpleData_out_bits_addr : io_simpleInst_out_bits_addr;	// @[<stdin>:1953:10, CRRV/src/bus/SimpleArbiter.scala:47:35, :57:39]
  assign io_simpleOut_out_bits_writeEn = selData & io_simpleData_out_bits_writeEn;	// @[<stdin>:1953:10, CRRV/src/bus/SimpleArbiter.scala:47:35, :58:39]
  assign io_simpleOut_out_bits_size = selData ? io_simpleData_out_bits_size : 2'h2;	// @[<stdin>:1953:10, CRRV/src/bus/SimpleArbiter.scala:13:14, :47:35, :56:39]
  assign io_simpleOut_out_bits_wdata = selData ? io_simpleData_out_bits_wdata : 32'h0;	// @[<stdin>:1953:10, CRRV/src/bus/SimpleArbiter.scala:13:14, :47:35, :59:39]
endmodule

module SimpleMux2(	// @[<stdin>:2012:10]
  input         clock,	// @[<stdin>:2013:11]
  ...
  always @(posedge clock)	// @[<stdin>:2013:11]
    readSel <= io_sel2;	// @[CRRV/src/bus/SimpleUtils.scala:16:24]
  assign io_in_out_ready = io_sel2 | io_out1_out_ready;	// @[<stdin>:2012:10, CRRV/src/bus/SimpleUtils.scala:20:25]
  assign io_in_in_rdata = readSel ? io_out2_in_rdata : io_out1_in_rdata;	// @[<stdin>:2012:10, CRRV/src/bus/SimpleUtils.scala:16:24, :18:24]
  assign io_out1_out_valid = io_in_out_valid & ~io_sel2;	// @[<stdin>:2012:10, CRRV/src/bus/SimpleUtils.scala:22:{40,43}]
  assign io_out1_out_bits_addr = io_in_out_bits_addr;	// @[<stdin>:2012:10]
  assign io_out1_out_bits_writeEn = io_in_out_bits_writeEn;	// @[<stdin>:2012:10]
  assign io_out1_out_bits_size = io_in_out_bits_size;	// @[<stdin>:2012:10]
  assign io_out1_out_bits_wdata = io_in_out_bits_wdata;	// @[<stdin>:2012:10]
  assign io_out2_out_bits_addr = io_in_out_bits_addr;	// @[<stdin>:2012:10]
endmodule

module SimpleXbar(	// @[<stdin>:2032:10]
  input         clock,	// @[<stdin>:2033:11]
...
module CLINT(	// @[<stdin>:2053:10]
  ...
  always @(posedge clock) begin	// @[<stdin>:2054:11]
    if (reset) begin	// @[<stdin>:2054:11]
  ...
  assign io_in_rdata = outputData;	// @[<stdin>:2053:10, CRRV/src/bus/CLINT.scala:24:27]
endmodule

module Simple2AXI4(	// @[<stdin>:2085:10]
  input         clock,	// @[<stdin>:2086:11]
                reset,	// @[<stdin>:2087:11]
  ...
  always @(posedge clock) begin	// @[<stdin>:2086:11]
    if (reset)	// @[<stdin>:2086:11]
  ...
  assign io_simple_out_ready = state == 3'h5 & addr == io_simple_out_bits_addr;	// @[<stdin>:2085:10, CRRV/src/bus/Simple2AXI4.scala:22:30, :25:18, :42:15, :62:{33,43,52}]
  assign io_simple_in_rdata = addr[2] ? rdata[63:32] : rdata[31:0];	// @[<stdin>:2085:10, CRRV/src/bus/Simple2AXI4.scala:24:18, :25:18, :63:{29,34,44,59}]
  assign io_axi_ar_valid = state == 3'h1;	// @[<stdin>:2085:10, CRRV/src/bus/Simple2AXI4.scala:22:30, :30:21, :76:33]
  assign io_axi_ar_bits_addr = addr;	// @[<stdin>:2085:10, CRRV/src/bus/Simple2AXI4.scala:25:18]
  assign io_axi_ar_bits_size = _GEN_1;	// @[<stdin>:2085:10, CRRV/src/bus/Simple2AXI4.scala:78:24]
  assign io_axi_aw_valid = _io_axi_w_bits_last_T;	// @[<stdin>:2085:10, CRRV/src/bus/Simple2AXI4.scala:80:33]
  assign io_axi_aw_bits_addr = addr;	// @[<stdin>:2085:10, CRRV/src/bus/Simple2AXI4.scala:25:18]
  assign io_axi_aw_bits_size = _GEN_1;	// @[<stdin>:2085:10, CRRV/src/bus/Simple2AXI4.scala:78:24]
  assign io_axi_w_valid = _io_axi_w_bits_last_T | _io_axi_w_bits_last_T_1;	// @[<stdin>:2085:10, CRRV/src/bus/Simple2AXI4.scala:80:33, :83:{44,53}]
  assign io_axi_w_bits_data = {2{io_simple_out_bits_wdata}};	// @[<stdin>:2085:10, CRRV/src/bus/Simple2AXI4.scala:65:21]
  assign io_axi_w_bits_strb = casez_tmp_0[7:0];	// @[<stdin>:2085:10, CRRV/src/bus/Simple2AXI4.scala:67:39, :86:24]
  assign io_axi_w_bits_last = _io_axi_w_bits_last_T | _io_axi_w_bits_last_T_1;	// @[<stdin>:2085:10, CRRV/src/bus/Simple2AXI4.scala:80:33, :83:53, :85:44]
endmodule

// external module Debug

module CRRVTop(	// @[<stdin>:2207:10]
  input         clock,	// @[<stdin>:2208:11]
                reset,	// @[<stdin>:2209:11]
  ...
  assign io_master_awid = 4'h0;	// @[<stdin>:2207:10, CRRV/src/CRRVTop.scala:17:26]
  assign io_master_awlen = 8'h0;	// @[<stdin>:2207:10, CRRV/src/CRRVTop.scala:17:26]
  assign io_master_awburst = 2'h0;	// @[<stdin>:2207:10, CRRV/src/CRRVTop.scala:17:26]
  assign io_master_bready = 1'h1;	// @[<stdin>:2207:10, CRRV/src/CRRVTop.scala:13:26, :14:26, :15:26, :16:26, :17:26]
  assign io_master_arid = 4'h0;	// @[<stdin>:2207:10, CRRV/src/CRRVTop.scala:17:26]
  assign io_master_arlen = 8'h0;	// @[<stdin>:2207:10, CRRV/src/CRRVTop.scala:17:26]
  assign io_master_arburst = 2'h0;	// @[<stdin>:2207:10, CRRV/src/CRRVTop.scala:17:26]
  assign io_master_rready = 1'h1;	// @[<stdin>:2207:10, CRRV/src/CRRVTop.scala:13:26, :14:26, :15:26, :16:26, :17:26]
  assign io_slave_awready = 1'h0;	// @[<stdin>:2207:10, CRRV/src/CRRVTop.scala:13:26, :14:26]
  assign io_slave_wready = 1'h0;	// @[<stdin>:2207:10, CRRV/src/CRRVTop.scala:13:26, :14:26]
  assign io_slave_bvalid = 1'h0;	// @[<stdin>:2207:10, CRRV/src/CRRVTop.scala:13:26, :14:26]
  assign io_slave_bresp = 2'h0;	// @[<stdin>:2207:10, CRRV/src/CRRVTop.scala:17:26]
  assign io_slave_bid = 4'h0;	// @[<stdin>:2207:10, CRRV/src/CRRVTop.scala:17:26]
  assign io_slave_arready = 1'h0;	// @[<stdin>:2207:10, CRRV/src/CRRVTop.scala:13:26, :14:26]
  assign io_slave_rvalid = 1'h0;	// @[<stdin>:2207:10, CRRV/src/CRRVTop.scala:13:26, :14:26]
  assign io_slave_rresp = 2'h0;	// @[<stdin>:2207:10, CRRV/src/CRRVTop.scala:17:26]
  assign io_slave_rdata = 64'h0;	// @[<stdin>:2207:10, CRRV/src/CRRVTop.scala:75:20]
  assign io_slave_rlast = 1'h0;	// @[<stdin>:2207:10, CRRV/src/CRRVTop.scala:13:26, :14:26]
  assign io_slave_rid = 4'h0;	// @[<stdin>:2207:10, CRRV/src/CRRVTop.scala:17:26]
endmodule
