...
module DecodeStage(	// @[<stdin>:49:10]
  ...
  wire [31:0] _flushPC_T_1 = io_if2id_IF_pc + 32'h4;	// @[CRRV/src/core/pipeline/DecodeStage.scala:49:57, :78:62]
  wire [31:0] flushPC =
    casez_tmp
      ? (_branchTarget_T
           ? (regEn1
      ...
      : _flushPC_T_1;	// @[CRRV/src/core/pipeline/DecodeStage.scala:23:27, :40:{22,32,41,55}, :42:{32,46,56}, :62:51, :73:39, :74:{25,51,65}, :75:25, :76:39, :77:25, :78:{25,62}, src/main/scala/chisel3/util/Lookup.scala:34:39, src/main/scala/chisel3/util/Mux.scala:141:16]
  ...
  assign io_control_flushIF = ~io_control_stall & flushPC != _flushPC_T_1;	// @[<stdin>:49:10, CRRV/src/core/pipeline/DecodeStage.scala:78:{25,62}, :79:30, :90:{25,43}]
  assign io_control_flushPc = flushPC;	// @[<stdin>:49:10, CRRV/src/core/pipeline/DecodeStage.scala:78:25]
...
module PipelineStage_1(	// @[<stdin>:931:10]
  ...
  assign io_next_IF_instValid = pipelineReg_IF_instValid;	// @[<stdin>:931:10, CRRV/src/core/pipeline/PipelineStage.scala:23:28]
  assign io_next_IF_pc = pipelineReg_IF_pc;	// @[<stdin>:931:10, CRRV/src/core/pipeline/PipelineStage.scala:23:28]
  assign io_next_ID_inst = pipelineReg_ID_inst;	// @[<stdin>:931:10, CRRV/src/core/pipeline/PipelineStage.scala:23:28]
  assign io_next_ID_aluOp = pipelineReg_ID_aluOp;	// @[<stdin>:931:10, CRRV/src/core/pipeline/PipelineStage.scala:23:28]
  assign io_next_ID_mduOp = pipelineReg_ID_mduOp;	// @[<stdin>:931:10, CRRV/src/core/pipeline/PipelineStage.scala:23:28]
  assign io_next_ID_src1 = pipelineReg_ID_src1;	// @[<stdin>:931:10, CRRV/src/core/pipeline/PipelineStage.scala:23:28]
  assign io_next_ID_src2 = pipelineReg_ID_src2;	// @[<stdin>:931:10, CRRV/src/core/pipeline/PipelineStage.scala:23:28]
  assign io_next_ID_lsuOp = pipelineReg_ID_lsuOp;	// @[<stdin>:931:10, CRRV/src/core/pipeline/PipelineStage.scala:23:28]
  assign io_next_ID_lsuData = pipelineReg_ID_lsuData;	// @[<stdin>:931:10, CRRV/src/core/pipeline/PipelineStage.scala:23:28]
  assign io_next_ID_regWen = pipelineReg_ID_regWen;	// @[<stdin>:931:10, CRRV/src/core/pipeline/PipelineStage.scala:23:28]
  assign io_next_ID_regWaddr = pipelineReg_ID_regWaddr;	// @[<stdin>:931:10, CRRV/src/core/pipeline/PipelineStage.scala:23:28]
  assign io_next_ID_csrOp = pipelineReg_ID_csrOp;	// @[<stdin>:931:10, CRRV/src/core/pipeline/PipelineStage.scala:23:28]
  assign io_next_ID_csrAddr = pipelineReg_ID_csrAddr;	// @[<stdin>:931:10, CRRV/src/core/pipeline/PipelineStage.scala:23:28]
  assign io_next_ID_csrWriteData = pipelineReg_ID_csrWriteData;	// @[<stdin>:931:10, CRRV/src/core/pipeline/PipelineStage.scala:23:28]
  assign io_next_ID_exceptType = pipelineReg_ID_exceptType;	// @[<stdin>:931:10, CRRV/src/core/pipeline/PipelineStage.scala:23:28]
endmodule

module Multiplier(	// @[<stdin>:983:10]
  input         clock,	// @[<stdin>:984:11]
                reset,	// @[<stdin>:985:11]
  ...
  always @(posedge clock) begin	// @[<stdin>:984:11]
  ...
  assign io_valid = io_en & ~io_flush & state == 2'h2;	// @[<stdin>:983:10, CRRV/src/core/muldiv/Multiplier.scala:34:51, :48:60, :75:{25,35,44}]
  assign io_result = mulResutl;	// @[<stdin>:983:10, CRRV/src/core/muldiv/Multiplier.scala:31:47]
endmodule

module Divider(	// @[<stdin>:1074:10]
  input         clock,	// @[<stdin>:1075:11]
                reset,	// @[<stdin>:1076:11]
  ...
  always @(posedge clock) begin	// @[<stdin>:1075:11]
  ...
  assign io_valid = io_en & ~io_flush & state == 2'h2;	// @[<stdin>:1074:10, CRRV/src/core/muldiv/Divider.scala:38:51, :57:15, :67:{28,38,47}]
  assign io_divresult = opr1Neg ^ opr2Neg ? 32'h0 - quotient : quotient;	// @[<stdin>:1074:10, CRRV/src/core/muldiv/Divider.scala:26:30, :27:30, :28:30, :30:35, :35:47, :43:24, :68:{22,37}]
  assign io_remresult = opr1Neg ? 32'h0 - dividend[63:32] : dividend[63:32];	// @[<stdin>:1074:10, CRRV/src/core/muldiv/Divider.scala:26:30, :30:35, :33:47, :43:24, :65:27, :69:{22,37}]
endmodule

module MDU(	// @[<stdin>:1158:10]
  input         clock,	// @[<stdin>:1159:11]
                reset,	// @[<stdin>:1160:11]
  ...
  assign io_valid = mulEnable ? _multiplier_io_valid : ~divEnable | _divider_io_valid;	// @[<stdin>:1158:10, CRRV/src/core/muldiv/MDU.scala:31:26, :41:23, src/main/scala/chisel3/util/Lookup.scala:34:39, src/main/scala/chisel3/util/Mux.scala:141:16]
  assign io_result =
    mulEnable
      ? (~_GEN & (_GEN_7 | _GEN_2)
      ...
      : divEnable
          ...
          : 32'h0;	// @[<stdin>:1158:10, CRRV/src/core/muldiv/MDU.scala:31:26, :39:{8,36,90}, :41:23, :47:22, src/main/scala/chisel3/util/Lookup.scala:31:38, :34:39, src/main/scala/chisel3/util/Mux.scala:141:16]
endmodule

module ExecuteStage(	// @[<stdin>:1256:10]
  input         clock,	// @[<stdin>:1257:11]
                reset,	// @[<stdin>:1258:11]
  ...
  assign io_control_stallReq = ~_mdu_io_valid;	// @[<stdin>:1256:10, CRRV/src/core/pipeline/ExecuteStage.scala:44:19, :64:26]
  assign io_exe2mem_IF_instValid = io_id2exe_IF_instValid;	// @[<stdin>:1256:10]
  assign io_exe2mem_IF_pc = io_id2exe_IF_pc;	// @[<stdin>:1256:10]
  assign io_exe2mem_ID_inst = io_id2exe_ID_inst;	// @[<stdin>:1256:10]
  assign io_exe2mem_ID_lsuOp = io_id2exe_ID_lsuOp;	// @[<stdin>:1256:10]
  assign io_exe2mem_ID_lsuData = io_id2exe_ID_lsuData;	// @[<stdin>:1256:10]
  assign io_exe2mem_ID_regWen = io_id2exe_ID_regWen;	// @[<stdin>:1256:10]
  assign io_exe2mem_ID_regWaddr = io_id2exe_ID_regWaddr;	// @[<stdin>:1256:10]
  assign io_exe2mem_ID_csrOp = io_id2exe_ID_csrOp;	// @[<stdin>:1256:10]
  assign io_exe2mem_ID_csrAddr = io_id2exe_ID_csrAddr;	// @[<stdin>:1256:10]
  assign io_exe2mem_ID_csrWriteData = io_id2exe_ID_csrWriteData;	// @[<stdin>:1256:10]
  assign io_exe2mem_ID_exceptType = io_id2exe_ID_exceptType;	// @[<stdin>:1256:10]
  assign io_exe2mem_EXE_load = load;	// @[<stdin>:1256:10, CRRV/src/core/pipeline/ExecuteStage.scala:61:39]
  assign io_exe2mem_EXE_exeResult = _GEN_0;	// @[<stdin>:1256:10, src/main/scala/chisel3/util/Mux.scala:141:16]
  assign io_csrRead_op = io_id2exe_ID_csrOp;	// @[<stdin>:1256:10]
  assign io_csrRead_addr = io_id2exe_ID_csrAddr;	// @[<stdin>:1256:10]
  assign io_regForward_en = io_id2exe_ID_regWen;	// @[<stdin>:1256:10]
  assign io_regForward_addr = io_id2exe_ID_regWaddr;	// @[<stdin>:1256:10]
  assign io_regForward_data = _GEN_0;	// @[<stdin>:1256:10, src/main/scala/chisel3/util/Mux.scala:141:16]
  assign io_regForward_load = load;	// @[<stdin>:1256:10, CRRV/src/core/pipeline/ExecuteStage.scala:61:39]
endmodule

module PipelineStage_2(	// @[<stdin>:1328:10]
  ...
  assign io_next_IF_instValid = pipelineReg_IF_instValid;	// @[<stdin>:1328:10, CRRV/src/core/pipeline/PipelineStage.scala:23:28]
  assign io_next_IF_pc = pipelineReg_IF_pc;	// @[<stdin>:1328:10, CRRV/src/core/pipeline/PipelineStage.scala:23:28]
  assign io_next_ID_inst = pipelineReg_ID_inst;	// @[<stdin>:1328:10, CRRV/src/core/pipeline/PipelineStage.scala:23:28]
  assign io_next_ID_lsuOp = pipelineReg_ID_lsuOp;	// @[<stdin>:1328:10, CRRV/src/core/pipeline/PipelineStage.scala:23:28]
  assign io_next_ID_lsuData = pipelineReg_ID_lsuData;	// @[<stdin>:1328:10, CRRV/src/core/pipeline/PipelineStage.scala:23:28]
  assign io_next_ID_regWen = pipelineReg_ID_regWen;	// @[<stdin>:1328:10, CRRV/src/core/pipeline/PipelineStage.scala:23:28]
  assign io_next_ID_regWaddr = pipelineReg_ID_regWaddr;	// @[<stdin>:1328:10, CRRV/src/core/pipeline/PipelineStage.scala:23:28]
  assign io_next_ID_csrOp = pipelineReg_ID_csrOp;	// @[<stdin>:1328:10, CRRV/src/core/pipeline/PipelineStage.scala:23:28]
  assign io_next_ID_csrAddr = pipelineReg_ID_csrAddr;	// @[<stdin>:1328:10, CRRV/src/core/pipeline/PipelineStage.scala:23:28]
  assign io_next_ID_csrWriteData = pipelineReg_ID_csrWriteData;	// @[<stdin>:1328:10, CRRV/src/core/pipeline/PipelineStage.scala:23:28]
  assign io_next_ID_exceptType = pipelineReg_ID_exceptType;	// @[<stdin>:1328:10, CRRV/src/core/pipeline/PipelineStage.scala:23:28]
  assign io_next_EXE_load = pipelineReg_EXE_load;	// @[<stdin>:1328:10, CRRV/src/core/pipeline/PipelineStage.scala:23:28]
  assign io_next_EXE_exeResult = pipelineReg_EXE_exeResult;	// @[<stdin>:1328:10, CRRV/src/core/pipeline/PipelineStage.scala:23:28]
endmodule

module MemoryStage(	// @[<stdin>:1384:10]
  ...
  assign io_control_stallReq = ~io_dataRam_ready & en;	// @[<stdin>:1384:10, CRRV/src/core/pipeline/MemoryStage.scala:41:{19,38}, src/main/scala/chisel3/util/Lookup.scala:34:39]
  assign io_mem2wb_IF_instValid = io_exe2mem_IF_instValid;	// @[<stdin>:1384:10]
  assign io_mem2wb_IF_pc = io_exe2mem_IF_pc;	// @[<stdin>:1384:10]
  assign io_mem2wb_ID_inst = io_exe2mem_ID_inst;	// @[<stdin>:1384:10]
  assign io_mem2wb_ID_lsuOp = io_exe2mem_ID_lsuOp;	// @[<stdin>:1384:10]
  assign io_mem2wb_ID_regWen = io_exe2mem_ID_regWen;	// @[<stdin>:1384:10]
  assign io_mem2wb_ID_regWaddr = io_exe2mem_ID_regWaddr;	// @[<stdin>:1384:10]
  assign io_mem2wb_ID_csrOp = io_exe2mem_ID_csrOp;	// @[<stdin>:1384:10]
  assign io_mem2wb_ID_csrAddr = io_exe2mem_ID_csrAddr;	// @[<stdin>:1384:10]
  assign io_mem2wb_ID_csrWriteData = io_exe2mem_ID_csrWriteData;	// @[<stdin>:1384:10]
  assign io_mem2wb_ID_exceptType = io_exe2mem_ID_exceptType;	// @[<stdin>:1384:10]
  assign io_mem2wb_EXE_exeResult = io_exe2mem_EXE_exeResult;	// @[<stdin>:1384:10]
  assign io_mem2wb_MEM_memAddr = io_exe2mem_EXE_exeResult;	// @[<stdin>:1384:10]
  assign io_dataRam_valid = en;	// @[<stdin>:1384:10, src/main/scala/chisel3/util/Lookup.scala:34:39]
  assign io_dataRam_bits_addr = io_exe2mem_EXE_exeResult;	// @[<stdin>:1384:10]
  assign io_dataRam_bits_writeEn =
    ~(_GEN | _GEN_0 | _GEN_1 | _GEN_2 | _GEN_3) & (_GEN_7 | _GEN_6);	// @[<stdin>:1384:10, src/main/scala/chisel3/util/Lookup.scala:31:38, :34:39]
  assign io_dataRam_bits_size = width;	// @[<stdin>:1384:10, src/main/scala/chisel3/util/Lookup.scala:34:39]
  assign io_dataRam_bits_wdata = casez_tmp;	// @[<stdin>:1384:10, CRRV/src/core/pipeline/MemoryStage.scala:33:41]
  assign io_memCsrStall_op = io_exe2mem_ID_csrOp;	// @[<stdin>:1384:10]
  assign io_memCsrStall_addr = io_exe2mem_ID_csrAddr;	// @[<stdin>:1384:10]
  assign io_regForward_en = io_exe2mem_ID_regWen;	// @[<stdin>:1384:10]
  assign io_regForward_addr = io_exe2mem_ID_regWaddr;	// @[<stdin>:1384:10]
  assign io_regForward_data = io_exe2mem_EXE_exeResult;	// @[<stdin>:1384:10]
  assign io_regForward_load = io_exe2mem_EXE_load;	// @[<stdin>:1384:10]
endmodule

module PipelineStage_3(	// @[<stdin>:1530:10]
  ...
  wire        _GEN = io_flush | io_stallPrev & ~io_stallNext;	// @[CRRV/src/core/pipeline/PipelineStage.scala:24:{17,34,37}]
  always @(posedge clock) begin	// @[<stdin>:1531:11]
    if (reset) begin	// @[<stdin>:1531:11]
      pipelineReg_IF_instValid <= 1'h0;	// @[CRRV/src/core/pipeline/PipelineStage.scala:23:28, CRRV/src/io/PipelineStageIO.scala:11:31]
      pipelineReg_IF_pc <= 32'h0;	// @[CRRV/src/core/pipeline/PipelineStage.scala:23:28, CRRV/src/io/PipelineStageIO.scala:11:31]
      pipelineReg_ID_inst <= 32'h0;	// @[CRRV/src/core/pipeline/PipelineStage.scala:23:28, CRRV/src/io/PipelineStageIO.scala:11:31]
      pipelineReg_ID_lsuOp <= 4'h0;	// @[CRRV/src/core/pipeline/PipelineStage.scala:23:28, CRRV/src/io/PipelineStageIO.scala:11:31]
  ...
  assign io_next_IF_instValid = pipelineReg_IF_instValid;	// @[<stdin>:1530:10, CRRV/src/core/pipeline/PipelineStage.scala:23:28]
  assign io_next_IF_pc = pipelineReg_IF_pc;	// @[<stdin>:1530:10, CRRV/src/core/pipeline/PipelineStage.scala:23:28]
  assign io_next_ID_inst = pipelineReg_ID_inst;	// @[<stdin>:1530:10, CRRV/src/core/pipeline/PipelineStage.scala:23:28]
  assign io_next_ID_lsuOp = pipelineReg_ID_lsuOp;	// @[<stdin>:1530:10, CRRV/src/core/pipeline/PipelineStage.scala:23:28]
  assign io_next_ID_regWen = pipelineReg_ID_regWen;	// @[<stdin>:1530:10, CRRV/src/core/pipeline/PipelineStage.scala:23:28]
  assign io_next_ID_regWaddr = pipelineReg_ID_regWaddr;	// @[<stdin>:1530:10, CRRV/src/core/pipeline/PipelineStage.scala:23:28]
  assign io_next_ID_csrOp = pipelineReg_ID_csrOp;	// @[<stdin>:1530:10, CRRV/src/core/pipeline/PipelineStage.scala:23:28]
  assign io_next_ID_csrAddr = pipelineReg_ID_csrAddr;	// @[<stdin>:1530:10, CRRV/src/core/pipeline/PipelineStage.scala:23:28]
  assign io_next_ID_csrWriteData = pipelineReg_ID_csrWriteData;	// @[<stdin>:1530:10, CRRV/src/core/pipeline/PipelineStage.scala:23:28]
  assign io_next_ID_exceptType = pipelineReg_ID_exceptType;	// @[<stdin>:1530:10, CRRV/src/core/pipeline/PipelineStage.scala:23:28]
  assign io_next_EXE_exeResult = pipelineReg_EXE_exeResult;	// @[<stdin>:1530:10, CRRV/src/core/pipeline/PipelineStage.scala:23:28]
  assign io_next_MEM_memAddr = pipelineReg_MEM_memAddr;	// @[<stdin>:1530:10, CRRV/src/core/pipeline/PipelineStage.scala:23:28]
endmodule

module WriteBackStage(	// @[<stdin>:1588:10]
  ...
  assign io_wb2csr_op = io_mem2wb_ID_csrOp;	// @[<stdin>:1588:10]
  assign io_wb2csr_addr = io_mem2wb_ID_csrAddr;	// @[<stdin>:1588:10]
  assign io_wb2csr_data = io_mem2wb_ID_csrWriteData;	// @[<stdin>:1588:10]
  assign io_wb2csr_exceptType = io_mem2wb_ID_exceptType;	// @[<stdin>:1588:10]
  assign io_wb2csr_exceptPc = io_mem2wb_IF_pc;	// @[<stdin>:1588:10]
  assign io_regForward_en = io_mem2wb_ID_regWen;	// @[<stdin>:1588:10]
  assign io_regForward_addr = io_mem2wb_ID_regWaddr;	// @[<stdin>:1588:10]
  assign io_regForward_data = regData;	// @[<stdin>:1588:10, CRRV/src/core/pipeline/WriteBackStage.scala:37:20]
  assign io_debug_valid = io_mem2wb_IF_instValid;	// @[<stdin>:1588:10]
  assign io_debug_halt = io_mem2wb_ID_inst == 32'h100073;	// @[<stdin>:1588:10, CRRV/src/core/pipeline/WriteBackStage.scala:52:32]
  assign io_debug_deviceAccess = |io_mem2wb_ID_lsuOp;	// @[<stdin>:1588:10, CRRV/src/core/pipeline/WriteBackStage.scala:37:33]
  assign io_debug_deviceAddr = io_mem2wb_EXE_exeResult;	// @[<stdin>:1588:10]
  assign io_debug_pc = io_mem2wb_IF_pc;	// @[<stdin>:1588:10]
  assign io_debug_regWen = io_mem2wb_ID_regWen;	// @[<stdin>:1588:10]
  assign io_debug_regWaddr = io_mem2wb_ID_regWaddr;	// @[<stdin>:1588:10]
  assign io_debug_regWdata = regData;	// @[<stdin>:1588:10, CRRV/src/core/pipeline/WriteBackStage.scala:37:20]
endmodule

module PipelineControl(	// @[<stdin>:1643:10]
  ...
  assign io_stallIF = stall[4];	// @[<stdin>:1643:10, CRRV/src/core/pipeline/PipelineControl.scala:69:23, src/main/scala/chisel3/util/Mux.scala:141:16]
  assign io_stallID = stall[3];	// @[<stdin>:1643:10, CRRV/src/core/pipeline/PipelineControl.scala:70:23, src/main/scala/chisel3/util/Mux.scala:141:16]
  assign io_stallEXE = stall[2];	// @[<stdin>:1643:10, CRRV/src/core/pipeline/PipelineControl.scala:71:23, src/main/scala/chisel3/util/Mux.scala:141:16]
  assign io_stallMEM = stall[1];	// @[<stdin>:1643:10, CRRV/src/core/pipeline/PipelineControl.scala:72:23, src/main/scala/chisel3/util/Mux.scala:141:16]
  assign io_stallWB = stall[0];	// @[<stdin>:1643:10, CRRV/src/core/pipeline/PipelineControl.scala:73:23, src/main/scala/chisel3/util/Mux.scala:141:16]
  assign io_flushAll = |io_exceptType;	// @[<stdin>:1643:10, CRRV/src/core/pipeline/PipelineControl.scala:50:32]
  assign io_flushIF = (|io_exceptType) | io_idFlushReq;	// @[<stdin>:1643:10, CRRV/src/core/pipeline/PipelineControl.scala:50:32, :59:27]
  assign io_flushPc =
    (|io_exceptType)
      ? (io_exceptType == 3'h2
           ? io_csrInfo_mepc
           : io_exceptType == 3'h1 ? io_csrInfo_trapEnterVec : 32'h0)
      : io_idFlushReq ? io_idFlushTarget : 32'h0;	// @[<stdin>:1643:10, CRRV/src/core/pipeline/PipelineControl.scala:14:14, :50:32, :51:44, src/main/scala/chisel3/util/Mux.scala:141:16]
endmodule

module HazardResolver(	// @[<stdin>:1677:10]
      ...
      ? (io_exeForward_en & io_regRead1_addr == io_exeForward_addr
           ...
           : io_memForward_en & io_regRead1_addr == io_memForward_addr
               ...
               : io_wbForward_en & io_regRead1_addr == io_wbForward_addr
                   ? io_wbForward_data
                   : io_regFile1_data)
      : 32'h0;	// @[<stdin>:1677:10, CRRV/src/core/pipeline/HazardResolver.scala:33:{18,31,40}, :34:{29,42,66}, :35:19, :36:{35,48,72}, :37:19, :38:{34,47,70}, :39:19, :41:19, :44:17]
      ...
      ? (io_exeForward_en & io_regRead2_addr == io_exeForward_addr
           ...
           : io_memForward_en & io_regRead2_addr == io_memForward_addr
               ...
               : io_wbForward_en & io_regRead2_addr == io_wbForward_addr
                   ...
                   : io_regFile2_data)
      : 32'h0;	// @[<stdin>:1677:10, CRRV/src/core/pipeline/HazardResolver.scala:33:{18,31,40}, :34:{29,42,66}, :35:19, :36:{35,48,72}, :37:19, :38:{34,47,70}, :39:19, :41:19, :44:17]
  assign io_csrRead_data = io_regCsr_data;	// @[<stdin>:1677:10]
  assign io_regFile1_en = io_regRead1_en;	// @[<stdin>:1677:10]
  assign io_regFile1_addr = io_regRead1_addr;	// @[<stdin>:1677:10]
  assign io_regFile2_en = io_regRead2_en;	// @[<stdin>:1677:10]
  assign io_regFile2_addr = io_regRead2_addr;	// @[<stdin>:1677:10]
  assign io_regCsr_addr = io_csrRead_addr;	// @[<stdin>:1677:10]
  assign io_loadHazardFlag =
    ...
    & (io_exeForward_load & io_regRead2_addr == io_exeForward_addr | io_memForward_load
       & io_regRead2_addr == io_memForward_addr);	// @[<stdin>:1677:10, CRRV/src/core/pipeline/HazardResolver.scala:52:{38,51}, :53:{38,51}, :54:{13,25}, :78:36]
  assign io_csrHazardFlag =
    ...
    & ((|io_memCsrStall_op) & io_memCsrStall_op != 3'h1
       ...
       & io_wbCsrStall_op != 3'h1 & io_csrRead_addr == io_wbCsrStall_addr);	// @[<stdin>:1677:10, CRRV/src/core/pipeline/HazardResolver.scala:58:{26,49}, :59:36, :60:{25,35}, :61:17, :62:34, :63:{24,34}, :64:17, :65:{12,23}]
endmodule

module CsrFile(	// @[<stdin>:1760:10]
  ...
  assign io_read_data = readData;	// @[<stdin>:1760:10, CRRV/src/core/regfile/CsrFile.scala:26:47]
  assign io_csrInfo_mepc = mepc;	// @[<stdin>:1760:10, CRRV/src/core/regfile/CsrFile.scala:21:26]
  assign io_csrInfo_trapEnterVec = mtvec;	// @[<stdin>:1760:10, CRRV/src/core/regfile/CsrFile.scala:20:26]
endmodule

module RegFile(	// @[<stdin>:1828:10]
  input         clock,	// @[<stdin>:1829:11]
  ...
  regfile_combMem regfile_ext (	// @[CRRV/src/core/regfile/RegFile.scala:15:20]
    ...
    .R0_en   (1'h1),	// @[<stdin>:1828:10]
    .R0_clk  (clock),
    .R1_addr (io_read2_addr),
    .R1_en   (1'h1),	// @[<stdin>:1828:10]
    .R1_clk  (clock),
  ...
  assign io_read1_data = (|io_read1_addr) & io_read1_en ? _regfile_ext_R0_data : 32'h0;	// @[<stdin>:1828:10, CRRV/src/core/regfile/RegFile.scala:15:20, :17:{23,38,46}, :18:23]
  assign io_read2_data = (|io_read2_addr) & io_read2_en ? _regfile_ext_R1_data : 32'h0;	// @[<stdin>:1828:10, CRRV/src/core/regfile/RegFile.scala:15:20, :18:{23,38,46}]
endmodule

module Core(	// @[<stdin>:1851:10]
  input         clock,	// @[<stdin>:1852:11]
                reset,	// @[<stdin>:1853:11]
...
module AXI4Arbiter(	// @[<stdin>:1957:10]
  input         clock,	// @[<stdin>:1958:11]
                reset,	// @[<stdin>:1959:11]
  ...
  always @(posedge clock) begin	// @[<stdin>:1958:11]
    if (reset)	// @[<stdin>:1958:11]
      state <= 3'h0;	// @[CRRV/src/bus/AXI4Arbiter.scala:30:46]
    else	// @[<stdin>:1958:11]
      state <= casez_tmp;	// @[CRRV/src/bus/AXI4Arbiter.scala:30:46, :31:17, :33:39]
  end // always @(posedge)
  assign io_axiInst_ar_ready = selInst & io_axiOut_ar_ready;	// @[<stdin>:1957:10, CRRV/src/bus/AXI4Arbiter.scala:57:40, :60:28]
  assign io_axiInst_r_valid = _io_axiInst_r_valid_output;	// @[<stdin>:1957:10, CRRV/src/bus/AXI4Arbiter.scala:61:28]
  assign io_axiInst_r_bits_data = io_axiOut_r_bits_data;	// @[<stdin>:1957:10]
  assign io_axiInst_r_bits_last = io_axiOut_r_bits_last;	// @[<stdin>:1957:10]
  assign io_axiData_ar_ready = selData & io_axiOut_ar_ready;	// @[<stdin>:1957:10, CRRV/src/bus/AXI4Arbiter.scala:54:59, :68:28]
  assign io_axiData_r_valid = _io_axiData_r_valid_output;	// @[<stdin>:1957:10, CRRV/src/bus/AXI4Arbiter.scala:69:28]
  assign io_axiData_r_bits_data = io_axiOut_r_bits_data;	// @[<stdin>:1957:10]
  assign io_axiData_r_bits_last = io_axiOut_r_bits_last;	// @[<stdin>:1957:10]
  assign io_axiData_aw_ready = selData & io_axiOut_aw_ready;	// @[<stdin>:1957:10, CRRV/src/bus/AXI4Arbiter.scala:54:59, :70:28]
  assign io_axiData_w_ready = selData & io_axiOut_w_ready;	// @[<stdin>:1957:10, CRRV/src/bus/AXI4Arbiter.scala:54:59, :71:28]
  assign io_axiOut_ar_valid = selData ? io_axiData_ar_valid : io_axiInst_ar_valid;	// @[<stdin>:1957:10, CRRV/src/bus/AXI4Arbiter.scala:54:59, :76:22]
  assign io_axiOut_ar_bits_addr =
    selData ? io_axiData_ar_bits_addr : io_axiInst_ar_bits_addr;	// @[<stdin>:1957:10, CRRV/src/bus/AXI4Arbiter.scala:54:59, :82:21]
  assign io_axiOut_ar_bits_size =
    selData ? io_axiData_ar_bits_size : io_axiInst_ar_bits_size;	// @[<stdin>:1957:10, CRRV/src/bus/AXI4Arbiter.scala:54:59, :82:21]
  assign io_axiOut_aw_valid = selData ? io_axiData_aw_valid : io_axiInst_aw_valid;	// @[<stdin>:1957:10, CRRV/src/bus/AXI4Arbiter.scala:54:59, :78:22]
  assign io_axiOut_aw_bits_addr =
    selData ? io_axiData_aw_bits_addr : io_axiInst_aw_bits_addr;	// @[<stdin>:1957:10, CRRV/src/bus/AXI4Arbiter.scala:54:59, :83:21]
  assign io_axiOut_aw_bits_size =
    selData ? io_axiData_aw_bits_size : io_axiInst_aw_bits_size;	// @[<stdin>:1957:10, CRRV/src/bus/AXI4Arbiter.scala:54:59, :83:21]
  assign io_axiOut_w_valid = selData ? io_axiData_w_valid : io_axiInst_w_valid;	// @[<stdin>:1957:10, CRRV/src/bus/AXI4Arbiter.scala:54:59, :79:22]
  assign io_axiOut_w_bits_data =
    selData ? io_axiData_w_bits_data : io_axiInst_w_bits_data;	// @[<stdin>:1957:10, CRRV/src/bus/AXI4Arbiter.scala:54:59, :84:21]
  assign io_axiOut_w_bits_strb =
    selData ? io_axiData_w_bits_strb : io_axiInst_w_bits_strb;	// @[<stdin>:1957:10, CRRV/src/bus/AXI4Arbiter.scala:54:59, :84:21]
  assign io_axiOut_w_bits_last =
    selData ? io_axiData_w_bits_last : io_axiInst_w_bits_last;	// @[<stdin>:1957:10, CRRV/src/bus/AXI4Arbiter.scala:54:59, :84:21]
endmodule

module SimpleMux2(	// @[<stdin>:2053:10]
  input         clock,	// @[<stdin>:2054:11]
  ...
  always @(posedge clock)	// @[<stdin>:2054:11]
    readSel <= io_sel2;	// @[CRRV/src/bus/SimpleUtils.scala:16:24]
  assign io_in_out_ready = io_sel2 | io_out1_out_ready;	// @[<stdin>:2053:10, CRRV/src/bus/SimpleUtils.scala:20:25]
  assign io_in_in_rdata = readSel ? io_out2_in_rdata : io_out1_in_rdata;	// @[<stdin>:2053:10, CRRV/src/bus/SimpleUtils.scala:16:24, :18:24]
  assign io_out1_out_valid = io_in_out_valid & ~io_sel2;	// @[<stdin>:2053:10, CRRV/src/bus/SimpleUtils.scala:22:{40,43}]
  assign io_out1_out_bits_addr = io_in_out_bits_addr;	// @[<stdin>:2053:10]
  assign io_out1_out_bits_writeEn = io_in_out_bits_writeEn;	// @[<stdin>:2053:10]
  assign io_out1_out_bits_size = io_in_out_bits_size;	// @[<stdin>:2053:10]
  assign io_out1_out_bits_wdata = io_in_out_bits_wdata;	// @[<stdin>:2053:10]
  assign io_out2_out_bits_addr = io_in_out_bits_addr;	// @[<stdin>:2053:10]
endmodule

module SimpleXbar(	// @[<stdin>:2073:10]
...
module CLINT(	// @[<stdin>:2094:10]
  input         clock,	// @[<stdin>:2095:11]
                reset,	// @[<stdin>:2096:11]
  ...
  always @(posedge clock) begin	// @[<stdin>:2095:11]
    if (reset) begin	// @[<stdin>:2095:11]
  ...
  assign io_in_rdata = outputData;	// @[<stdin>:2094:10, CRRV/src/bus/CLINT.scala:24:27]
endmodule

module Simple2AXI4(	// @[<stdin>:2126:10, :2242:10]
  input         clock,	// @[<stdin>:2127:11, :2243:11]
                reset,	// @[<stdin>:2128:11, :2244:11]
  ...
  always @(posedge clock) begin	// @[<stdin>:2127:11, :2243:11]
    if (reset)	// @[<stdin>:2127:11, :2243:11]
      state <= 3'h0;	// @[CRRV/src/bus/Simple2AXI4.scala:22:30]
    else	// @[<stdin>:2127:11, :2243:11]
  ...
  assign io_simple_out_ready = state == 3'h5 & addr == io_simple_out_bits_addr;	// @[<stdin>:2126:10, :2242:10, CRRV/src/bus/Simple2AXI4.scala:22:30, :25:18, :42:15, :62:{33,43,52}]
  assign io_simple_in_rdata = addr[2] ? rdata[63:32] : rdata[31:0];	// @[<stdin>:2126:10, :2242:10, CRRV/src/bus/Simple2AXI4.scala:24:18, :25:18, :63:{29,34,44,59}]
  assign io_axi_ar_valid = state == 3'h1;	// @[<stdin>:2126:10, :2242:10, CRRV/src/bus/Simple2AXI4.scala:22:30, :30:21, :76:33]
  assign io_axi_ar_bits_addr = addr;	// @[<stdin>:2126:10, :2242:10, CRRV/src/bus/Simple2AXI4.scala:25:18]
  assign io_axi_ar_bits_size = _GEN_1;	// @[<stdin>:2126:10, :2242:10, CRRV/src/bus/Simple2AXI4.scala:78:24]
  assign io_axi_aw_valid = _io_axi_w_bits_last_T;	// @[<stdin>:2126:10, :2242:10, CRRV/src/bus/Simple2AXI4.scala:80:33]
  assign io_axi_aw_bits_addr = addr;	// @[<stdin>:2126:10, :2242:10, CRRV/src/bus/Simple2AXI4.scala:25:18]
  assign io_axi_aw_bits_size = _GEN_1;	// @[<stdin>:2126:10, :2242:10, CRRV/src/bus/Simple2AXI4.scala:78:24]
  assign io_axi_w_valid = _io_axi_w_bits_last_T | _io_axi_w_bits_last_T_1;	// @[<stdin>:2126:10, :2242:10, CRRV/src/bus/Simple2AXI4.scala:80:33, :83:{44,53}]
  assign io_axi_w_bits_data = {2{io_simple_out_bits_wdata}};	// @[<stdin>:2126:10, :2242:10, CRRV/src/bus/Simple2AXI4.scala:65:21]
  assign io_axi_w_bits_strb = casez_tmp_0[7:0];	// @[<stdin>:2126:10, :2242:10, CRRV/src/bus/Simple2AXI4.scala:67:39, :86:24]
  assign io_axi_w_bits_last = _io_axi_w_bits_last_T | _io_axi_w_bits_last_T_1;	// @[<stdin>:2126:10, :2242:10, CRRV/src/bus/Simple2AXI4.scala:80:33, :83:53, :85:44]
endmodule

// external module Debug

module CRRVTop(	// @[<stdin>:2364:10]
  input         clock,	// @[<stdin>:2365:11]
                reset,	// @[<stdin>:2366:11]
  ...
  assign io_master_awid = 4'h0;	// @[<stdin>:2364:10, CRRV/src/CRRVTop.scala:15:30, :18:30, :19:30]
  assign io_master_awlen = 8'h0;	// @[<stdin>:2364:10, CRRV/src/CRRVTop.scala:15:30, :18:30, :19:30]
  assign io_master_awburst = 2'h0;	// @[<stdin>:2364:10, CRRV/src/CRRVTop.scala:15:30, :18:30, :19:30]
  assign io_master_bready = 1'h1;	// @[<stdin>:2364:10, CRRV/src/CRRVTop.scala:13:20, :15:30, :16:30, :17:30, :18:30, :19:30]
  assign io_master_arid = 4'h0;	// @[<stdin>:2364:10, CRRV/src/CRRVTop.scala:15:30, :18:30, :19:30]
  assign io_master_arlen = 8'h0;	// @[<stdin>:2364:10, CRRV/src/CRRVTop.scala:15:30, :18:30, :19:30]
  assign io_master_arburst = 2'h0;	// @[<stdin>:2364:10, CRRV/src/CRRVTop.scala:15:30, :18:30, :19:30]
  assign io_master_rready = 1'h1;	// @[<stdin>:2364:10, CRRV/src/CRRVTop.scala:13:20, :15:30, :16:30, :17:30, :18:30, :19:30]
  assign io_slave_awready = 1'h0;	// @[<stdin>:2364:10, CRRV/src/CRRVTop.scala:13:20, :15:30, :18:30]
  assign io_slave_wready = 1'h0;	// @[<stdin>:2364:10, CRRV/src/CRRVTop.scala:13:20, :15:30, :18:30]
  assign io_slave_bvalid = 1'h0;	// @[<stdin>:2364:10, CRRV/src/CRRVTop.scala:13:20, :15:30, :18:30]
  assign io_slave_bresp = 2'h0;	// @[<stdin>:2364:10, CRRV/src/CRRVTop.scala:15:30, :18:30, :19:30]
  assign io_slave_bid = 4'h0;	// @[<stdin>:2364:10, CRRV/src/CRRVTop.scala:15:30, :18:30, :19:30]
  assign io_slave_arready = 1'h0;	// @[<stdin>:2364:10, CRRV/src/CRRVTop.scala:13:20, :15:30, :18:30]
  assign io_slave_rvalid = 1'h0;	// @[<stdin>:2364:10, CRRV/src/CRRVTop.scala:13:20, :15:30, :18:30]
  assign io_slave_rresp = 2'h0;	// @[<stdin>:2364:10, CRRV/src/CRRVTop.scala:15:30, :18:30, :19:30]
  assign io_slave_rdata = 64'h0;	// @[<stdin>:2364:10, CRRV/src/CRRVTop.scala:80:20]
  assign io_slave_rlast = 1'h0;	// @[<stdin>:2364:10, CRRV/src/CRRVTop.scala:13:20, :15:30, :18:30]
  assign io_slave_rid = 4'h0;	// @[<stdin>:2364:10, CRRV/src/CRRVTop.scala:15:30, :18:30, :19:30]
endmodule
