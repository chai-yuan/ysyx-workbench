...
module SimpleMux2(	// @[<stdin>:2001:10]
  ...
  always @(posedge clock)	// @[<stdin>:2002:11]
    readSel <= io_sel2;	// @[CRRV/src/bus/SimpleUtils.scala:16:24]
  assign io_in_out_ready = io_sel2 | io_out1_out_ready;	// @[<stdin>:2001:10, CRRV/src/bus/SimpleUtils.scala:20:25]
  assign io_in_in_rdata = readSel ? io_out2_in_rdata : io_out1_in_rdata;	// @[<stdin>:2001:10, CRRV/src/bus/SimpleUtils.scala:16:24, :18:24]
  assign io_out1_out_valid = io_in_out_valid & ~io_sel2;	// @[<stdin>:2001:10, CRRV/src/bus/SimpleUtils.scala:22:{40,43}]
  assign io_out1_out_bits_addr = io_in_out_bits_addr;	// @[<stdin>:2001:10]
  assign io_out1_out_bits_writeEn = io_in_out_bits_writeEn;	// @[<stdin>:2001:10]
  assign io_out1_out_bits_size = io_in_out_bits_size;	// @[<stdin>:2001:10]
  assign io_out1_out_bits_wdata = io_in_out_bits_wdata;	// @[<stdin>:2001:10]
  assign io_out2_out_bits_addr = io_in_out_bits_addr;	// @[<stdin>:2001:10]
endmodule

module SimpleXbar(	// @[<stdin>:2021:10]
  input         clock,	// @[<stdin>:2022:11]
...
module CLINT(	// @[<stdin>:2042:10]
  input         clock,	// @[<stdin>:2043:11]
                reset,	// @[<stdin>:2044:11]
  ...
  always @(posedge clock) begin	// @[<stdin>:2043:11]
    if (reset) begin	// @[<stdin>:2043:11]
  ...
  assign io_in_rdata = outputData;	// @[<stdin>:2042:10, CRRV/src/bus/CLINT.scala:24:27]
endmodule

module Simple2AXI4(	// @[<stdin>:2074:10]
  input         clock,	// @[<stdin>:2075:11]
                reset,	// @[<stdin>:2076:11]
  ...
  always @(posedge clock) begin	// @[<stdin>:2075:11]
    if (reset)	// @[<stdin>:2075:11]
  ...
  assign io_simple_out_ready = state == 3'h5 & addr == io_simple_out_bits_addr;	// @[<stdin>:2074:10, CRRV/src/bus/Simple2AXI4.scala:22:30, :25:18, :42:15, :62:{33,43,52}]
  assign io_simple_in_rdata = addr[2] ? rdata[63:32] : rdata[31:0];	// @[<stdin>:2074:10, CRRV/src/bus/Simple2AXI4.scala:24:18, :25:18, :63:{29,34,44,59}]
  assign io_axi_ar_valid = state == 3'h1;	// @[<stdin>:2074:10, CRRV/src/bus/Simple2AXI4.scala:22:30, :30:21, :76:33]
  assign io_axi_ar_bits_addr = addr;	// @[<stdin>:2074:10, CRRV/src/bus/Simple2AXI4.scala:25:18]
  assign io_axi_ar_bits_size = _GEN_1;	// @[<stdin>:2074:10, CRRV/src/bus/Simple2AXI4.scala:78:24]
  assign io_axi_aw_valid = _io_axi_w_bits_last_T;	// @[<stdin>:2074:10, CRRV/src/bus/Simple2AXI4.scala:80:33]
  assign io_axi_aw_bits_addr = addr;	// @[<stdin>:2074:10, CRRV/src/bus/Simple2AXI4.scala:25:18]
  assign io_axi_aw_bits_size = _GEN_1;	// @[<stdin>:2074:10, CRRV/src/bus/Simple2AXI4.scala:78:24]
  assign io_axi_w_valid = _io_axi_w_bits_last_T | _io_axi_w_bits_last_T_1;	// @[<stdin>:2074:10, CRRV/src/bus/Simple2AXI4.scala:80:33, :83:{44,53}]
  assign io_axi_w_bits_data = {2{io_simple_out_bits_wdata}};	// @[<stdin>:2074:10, CRRV/src/bus/Simple2AXI4.scala:65:21]
  assign io_axi_w_bits_strb = casez_tmp_0[7:0];	// @[<stdin>:2074:10, CRRV/src/bus/Simple2AXI4.scala:67:39, :86:24]
  assign io_axi_w_bits_last = _io_axi_w_bits_last_T | _io_axi_w_bits_last_T_1;	// @[<stdin>:2074:10, CRRV/src/bus/Simple2AXI4.scala:80:33, :83:53, :85:44]
endmodule

// external module Debug

module CRRVTop(	// @[<stdin>:2196:10]
  ...
  assign io_master_awid = 4'h0;	// @[<stdin>:2196:10, CRRV/src/CRRVTop.scala:17:26]
  assign io_master_awlen = 8'h0;	// @[<stdin>:2196:10, CRRV/src/CRRVTop.scala:17:26]
  assign io_master_awburst = 2'h0;	// @[<stdin>:2196:10, CRRV/src/CRRVTop.scala:17:26]
  assign io_master_bready = 1'h1;	// @[<stdin>:2196:10, CRRV/src/CRRVTop.scala:13:26, :14:26, :15:26, :16:26, :17:26]
  assign io_master_arid = 4'h0;	// @[<stdin>:2196:10, CRRV/src/CRRVTop.scala:17:26]
  assign io_master_arlen = 8'h0;	// @[<stdin>:2196:10, CRRV/src/CRRVTop.scala:17:26]
  assign io_master_arburst = 2'h0;	// @[<stdin>:2196:10, CRRV/src/CRRVTop.scala:17:26]
  assign io_master_rready = 1'h1;	// @[<stdin>:2196:10, CRRV/src/CRRVTop.scala:13:26, :14:26, :15:26, :16:26, :17:26]
  assign io_slave_awready = 1'h0;	// @[<stdin>:2196:10, CRRV/src/CRRVTop.scala:13:26, :14:26]
  assign io_slave_wready = 1'h0;	// @[<stdin>:2196:10, CRRV/src/CRRVTop.scala:13:26, :14:26]
  assign io_slave_bvalid = 1'h0;	// @[<stdin>:2196:10, CRRV/src/CRRVTop.scala:13:26, :14:26]
  assign io_slave_bresp = 2'h0;	// @[<stdin>:2196:10, CRRV/src/CRRVTop.scala:17:26]
  assign io_slave_bid = 4'h0;	// @[<stdin>:2196:10, CRRV/src/CRRVTop.scala:17:26]
  assign io_slave_arready = 1'h0;	// @[<stdin>:2196:10, CRRV/src/CRRVTop.scala:13:26, :14:26]
  assign io_slave_rvalid = 1'h0;	// @[<stdin>:2196:10, CRRV/src/CRRVTop.scala:13:26, :14:26]
  assign io_slave_rresp = 2'h0;	// @[<stdin>:2196:10, CRRV/src/CRRVTop.scala:17:26]
  assign io_slave_rdata = 64'h0;	// @[<stdin>:2196:10, CRRV/src/CRRVTop.scala:75:20]
  assign io_slave_rlast = 1'h0;	// @[<stdin>:2196:10, CRRV/src/CRRVTop.scala:13:26, :14:26]
  assign io_slave_rid = 4'h0;	// @[<stdin>:2196:10, CRRV/src/CRRVTop.scala:17:26]
endmodule
