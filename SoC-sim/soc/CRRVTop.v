...
module WriteBackStage(	// @[<stdin>:2246:10]
  ...
  assign io_debug_halt = io_mem2wb_ID_inst == 32'h100073;	// @[<stdin>:2246:10, CRRV/src/core/pipeline/WriteBackStage.scala:62:39]
...
module PipelineControl(	// @[<stdin>:2299:10]
  ...
  wire       _excFlush_T_1 = (|io_exceptType) | io_csrInfo_intr;	// @[CRRV/src/core/pipeline/PipelineControl.scala:50:{32,45}]
  assign io_stallIF = stall[4];	// @[<stdin>:2299:10, CRRV/src/core/pipeline/PipelineControl.scala:70:23, src/main/scala/chisel3/util/Mux.scala:141:16]
  assign io_stallID = stall[3];	// @[<stdin>:2299:10, CRRV/src/core/pipeline/PipelineControl.scala:71:23, src/main/scala/chisel3/util/Mux.scala:141:16]
  assign io_stallEXE = stall[2];	// @[<stdin>:2299:10, CRRV/src/core/pipeline/PipelineControl.scala:72:23, src/main/scala/chisel3/util/Mux.scala:141:16]
  assign io_stallMEM = stall[1];	// @[<stdin>:2299:10, CRRV/src/core/pipeline/PipelineControl.scala:73:23, src/main/scala/chisel3/util/Mux.scala:141:16]
  assign io_stallWB = stall[0];	// @[<stdin>:2299:10, CRRV/src/core/pipeline/PipelineControl.scala:74:23, src/main/scala/chisel3/util/Mux.scala:141:16]
  assign io_flushAll = _excFlush_T_1;	// @[<stdin>:2299:10, CRRV/src/core/pipeline/PipelineControl.scala:50:45]
  assign io_flushIF = _excFlush_T_1 | io_idFlushReq;	// @[<stdin>:2299:10, CRRV/src/core/pipeline/PipelineControl.scala:50:45, :60:27]
  assign io_flushPc =
    _excFlush_T_1
      ? (io_exceptType == 3'h2
           ? io_csrInfo_mepc
           : io_exceptType == 3'h1 | {2'h0, io_csrInfo_intr} == io_exceptType
               ? io_csrInfo_trapEnterVec
               : 32'h0)
      : io_idFlushReq ? io_idFlushTarget : 32'h0;	// @[<stdin>:2299:10, CRRV/src/core/pipeline/PipelineControl.scala:14:14, :50:45, :51:44, src/main/scala/chisel3/util/Mux.scala:141:16]
endmodule

module HazardResolver(	// @[<stdin>:2337:10]
      ...
      ? (io_exeForward_en & io_regRead1_addr == io_exeForward_addr
           ...
           : io_memForward_en & io_regRead1_addr == io_memForward_addr
               ...
               : io_wbForward_en & io_regRead1_addr == io_wbForward_addr
                   ? io_wbForward_data
                   : io_regFile1_data)
      : 32'h0;	// @[<stdin>:2337:10, CRRV/src/core/pipeline/HazardResolver.scala:38:{18,31,40}, :39:{29,42,66}, :40:19, :41:{35,48,72}, :42:19, :43:{34,47,70}, :44:19, :46:19, :49:17]
      ...
      ? (io_exeForward_en & io_regRead2_addr == io_exeForward_addr
           ...
           : io_memForward_en & io_regRead2_addr == io_memForward_addr
               ...
               : io_wbForward_en & io_regRead2_addr == io_wbForward_addr
                   ...
                   : io_regFile2_data)
      : 32'h0;	// @[<stdin>:2337:10, CRRV/src/core/pipeline/HazardResolver.scala:38:{18,31,40}, :39:{29,42,66}, :40:19, :41:{35,48,72}, :42:19, :43:{34,47,70}, :44:19, :46:19, :49:17]
  assign io_csrRead_data = io_regCsr_data;	// @[<stdin>:2337:10]
  assign io_regFile1_en = io_regRead1_en;	// @[<stdin>:2337:10]
  assign io_regFile1_addr = io_regRead1_addr;	// @[<stdin>:2337:10]
  assign io_regFile2_en = io_regRead2_en;	// @[<stdin>:2337:10]
  assign io_regFile2_addr = io_regRead2_addr;	// @[<stdin>:2337:10]
  assign io_regCsr_addr = io_csrRead_addr;	// @[<stdin>:2337:10]
  assign io_memExcMonCheck_valid =
    io_wbExcMon_clear | io_wbExcMon_set
      ? io_memExcMonCheck_addr == io_wbExcMon_addr & ~io_wbExcMon_clear
      : io_excMonCheck_valid;	// @[<stdin>:2337:10, CRRV/src/core/pipeline/HazardResolver.scala:38:31, :61:{28,48}, :62:{23,45}, :63:33, :64:23, :66:23, :69:21, :72:19]
  assign io_excMonCheck_addr = io_memExcMonCheck_addr;	// @[<stdin>:2337:10]
  assign io_loadHazardFlag =
    ...
    & (io_exeForward_load & io_regRead2_addr == io_exeForward_addr | io_memForward_load
       & io_regRead2_addr == io_memForward_addr);	// @[<stdin>:2337:10, CRRV/src/core/pipeline/HazardResolver.scala:79:{38,51}, :80:{38,51}, :81:{13,25}, :99:36]
  assign io_csrHazardFlag =
    ...
    & ((|io_memCsrStall_op) & io_memCsrStall_op != 3'h1
       ...
       & io_wbCsrStall_op != 3'h1 & io_csrRead_addr == io_wbCsrStall_addr);	// @[<stdin>:2337:10, CRRV/src/core/pipeline/HazardResolver.scala:85:{26,49}, :86:36, :87:{25,35}, :88:17, :89:34, :90:{24,34}, :91:17, :92:{12,23}]
endmodule

module CsrFile(	// @[<stdin>:2433:10]
  input         clock,	// @[<stdin>:2434:11]
                reset,	// @[<stdin>:2435:11]
  ...
  input         io_intr_timer,	// @[CRRV/src/core/regfile/CsrFile.scala:12:14]
  ...
  wire        intr = mip[7] & mie[7] & mstatus[3];	// @[CRRV/src/core/regfile/CsrFile.scala:22:26, :29:26, :30:26, :82:{17,27,31,41}]
  ...
  wire [31:0] _GEN_0 = {24'h18, mstatus[3], 7'h0};	// @[CRRV/src/core/regfile/CsrFile.scala:22:26, :67:46, :88:{15,28,39}]
  wire        _GEN_1 = intr | (|io_write_exceptType);	// @[CRRV/src/core/regfile/CsrFile.scala:24:26, :82:31, :84:14, :91:{35,49}, :100:24]
  always @(posedge clock) begin	// @[<stdin>:2434:11]
    if (reset) begin	// @[<stdin>:2434:11]
    ...
    else begin	// @[<stdin>:2434:11]
      if (intr) begin	// @[CRRV/src/core/regfile/CsrFile.scala:82:31]
        mstatus <= _GEN_0;	// @[CRRV/src/core/regfile/CsrFile.scala:22:26, :88:15]
        mcause <= 32'h80000007;	// @[CRRV/src/core/regfile/CsrFile.scala:23:26, :86:15]
        mepc <= io_write_exceptPc;	// @[CRRV/src/core/regfile/CsrFile.scala:25:26]
        mtval <= 32'h0;	// @[CRRV/src/core/regfile/CsrFile.scala:22:26, :31:26]
      end
      else if (|io_write_exceptType) begin	// @[CRRV/src/core/regfile/CsrFile.scala:91:35]
        if (io_write_exceptType == 3'h1) begin	// @[CRRV/src/core/regfile/CsrFile.scala:52:66, :92:32]
          mstatus <= _GEN_0;	// @[CRRV/src/core/regfile/CsrFile.scala:22:26, :88:15]
          mcause <= 32'hB;	// @[CRRV/src/core/regfile/CsrFile.scala:23:26, :94:19]
          mepc <= io_write_exceptPc;	// @[CRRV/src/core/regfile/CsrFile.scala:25:26]
          mtval <= io_write_exceptPc;	// @[CRRV/src/core/regfile/CsrFile.scala:31:26]
        end
      end
      else begin	// @[CRRV/src/core/regfile/CsrFile.scala:91:35]
        if (writeEn & _writeOldData_T) begin	// @[CRRV/src/core/regfile/CsrFile.scala:22:26, :52:51, :53:52, :100:24, :101:{43,53}]
        ...
        if (writeEn & _writeOldData_T_2) begin	// @[CRRV/src/core/regfile/CsrFile.scala:23:26, :52:51, :53:52, :100:24, :104:{42,51}]
          if (_writeData_T_9)	// @[CRRV/src/core/regfile/CsrFile.scala:67:46]
        ...
        if (writeEn & _writeOldData_T_6) begin	// @[CRRV/src/core/regfile/CsrFile.scala:25:26, :52:51, :53:52, :100:24, :103:{40,47}]
          if (_writeData_T_9)	// @[CRRV/src/core/regfile/CsrFile.scala:67:46]
        ...
        if (writeEn & _writeOldData_T_18) begin	// @[CRRV/src/core/regfile/CsrFile.scala:31:26, :52:51, :53:52, :100:24, :107:{41,49}]
          if (_writeData_T_9)	// @[CRRV/src/core/regfile/CsrFile.scala:67:46]
      ...
      if (_GEN_1 | ~(writeEn & _writeOldData_T_4)) begin	// @[CRRV/src/core/regfile/CsrFile.scala:24:26, :52:51, :53:52, :84:14, :91:49, :100:24, :102:{41,49}]
      end
        ...
        mtvec <= 32'h0;	// @[CRRV/src/core/regfile/CsrFile.scala:22:26, :24:26]
      if (_GEN_1 | ~(writeEn & _writeOldData_T_12)) begin	// @[CRRV/src/core/regfile/CsrFile.scala:24:26, :28:26, :52:51, :53:52, :84:14, :91:49, :100:24, :105:{44,55}]
      end
      else if (_writeData_T_9)	// @[CRRV/src/core/regfile/CsrFile.scala:67:46]
        ...
        mscratch <= 32'h0;	// @[CRRV/src/core/regfile/CsrFile.scala:22:26, :28:26]
      if (_GEN_1 | ~(writeEn & _writeOldData_T_14)) begin	// @[CRRV/src/core/regfile/CsrFile.scala:24:26, :29:26, :52:51, :53:52, :84:14, :91:49, :100:24, :106:{39,45}]
      end
      else if (_writeData_T_9)	// @[CRRV/src/core/regfile/CsrFile.scala:67:46]
        ...
        mie <= 32'h0;	// @[CRRV/src/core/regfile/CsrFile.scala:22:26, :29:26]
      if (io_intr_timer)	// @[CRRV/src/core/regfile/CsrFile.scala:12:14]
        mip <= {mip[31:8], mip[7:0] | 8'h80};	// @[CRRV/src/core/regfile/CsrFile.scala:30:26, :77:18]
      else	// @[CRRV/src/core/regfile/CsrFile.scala:12:14]
        mip <= {25'h0, mip[6:0]};	// @[CRRV/src/core/regfile/CsrFile.scala:30:26, :77:18, :80:16]
    end
  end // always @(posedge)
  assign io_read_data =
                      ...
                      : io_read_addr == 12'h341
                          ...
                          : io_read_addr == 12'h305
                              ...
                              : io_read_addr == 12'h342
                                  ? mcause
                                  : io_read_addr == 12'h300 ? mstatus : 32'h0;	// @[<stdin>:2433:10, CRRV/src/core/regfile/CsrFile.scala:22:26, :23:26, :24:26, :25:26, :28:26, :29:26, :30:26, :31:26, :36:47]
  assign io_csrInfo_mepc = mepc;	// @[<stdin>:2433:10, CRRV/src/core/regfile/CsrFile.scala:25:26]
  assign io_csrInfo_trapEnterVec = mtvec;	// @[<stdin>:2433:10, CRRV/src/core/regfile/CsrFile.scala:24:26]
  assign io_csrInfo_intr = intr;	// @[<stdin>:2433:10, CRRV/src/core/regfile/CsrFile.scala:82:31]
  assign io_debug_mstatus = mstatus;	// @[<stdin>:2433:10, CRRV/src/core/regfile/CsrFile.scala:22:26]
  assign io_debug_mcause = mcause;	// @[<stdin>:2433:10, CRRV/src/core/regfile/CsrFile.scala:23:26]
  assign io_debug_mtvec = mtvec;	// @[<stdin>:2433:10, CRRV/src/core/regfile/CsrFile.scala:24:26]
  assign io_debug_mepc = mepc;	// @[<stdin>:2433:10, CRRV/src/core/regfile/CsrFile.scala:25:26]
  assign io_debug_mscratch = mscratch;	// @[<stdin>:2433:10, CRRV/src/core/regfile/CsrFile.scala:28:26]
  assign io_debug_mie = mie;	// @[<stdin>:2433:10, CRRV/src/core/regfile/CsrFile.scala:29:26]
  assign io_debug_mip = mip;	// @[<stdin>:2433:10, CRRV/src/core/regfile/CsrFile.scala:30:26]
  assign io_debug_mtval = mtval;	// @[<stdin>:2433:10, CRRV/src/core/regfile/CsrFile.scala:31:26]
endmodule

module RegFile(	// @[<stdin>:2593:10]
  input         clock,	// @[<stdin>:2594:11]
  ...
  assign io_read1_data = (|io_read1_addr) & io_read1_en ? _regfile_ext_R32_data : 32'h0;	// @[<stdin>:2593:10, CRRV/src/core/regfile/RegFile.scala:18:20, :20:{23,38,46}, :21:23]
  assign io_read2_data = (|io_read2_addr) & io_read2_en ? _regfile_ext_R33_data : 32'h0;	// @[<stdin>:2593:10, CRRV/src/core/regfile/RegFile.scala:18:20, :21:{23,38,46}]
endmodule

module ExclusiveMonitor(	// @[<stdin>:2679:10]
  input         clock,	// @[<stdin>:2680:11]
                reset,	// @[<stdin>:2681:11]
  ...
  assign io_check_valid = flag & addr == io_check_addr;	// @[<stdin>:2679:10, CRRV/src/core/atom/ExclusiveMonitor.scala:16:21, :17:21, :27:{26,34}]
endmodule

module Core(	// @[<stdin>:2702:10]
  input         clock,	// @[<stdin>:2703:11]
                reset,	// @[<stdin>:2704:11]
  ...
  input         io_intr_timer,	// @[CRRV/src/core/Core.scala:12:14]
  ...
  output        io_debug_debugInfo_valid,	// @[CRRV/src/core/Core.scala:12:14]
                io_debug_debugInfo_halt,	// @[CRRV/src/core/Core.scala:12:14]
                io_debug_debugInfo_deviceAccess,	// @[CRRV/src/core/Core.scala:12:14]
  output [31:0] io_debug_debugInfo_deviceAddr,	// @[CRRV/src/core/Core.scala:12:14]
                io_debug_debugInfo_pc,	// @[CRRV/src/core/Core.scala:12:14]
                io_debug_regs_regs_0,	// @[CRRV/src/core/Core.scala:12:14]
                io_debug_regs_regs_1,	// @[CRRV/src/core/Core.scala:12:14]
                io_debug_regs_regs_2,	// @[CRRV/src/core/Core.scala:12:14]
                io_debug_regs_regs_3,	// @[CRRV/src/core/Core.scala:12:14]
                io_debug_regs_regs_4,	// @[CRRV/src/core/Core.scala:12:14]
                io_debug_regs_regs_5,	// @[CRRV/src/core/Core.scala:12:14]
                io_debug_regs_regs_6,	// @[CRRV/src/core/Core.scala:12:14]
                io_debug_regs_regs_7,	// @[CRRV/src/core/Core.scala:12:14]
                io_debug_regs_regs_8,	// @[CRRV/src/core/Core.scala:12:14]
                io_debug_regs_regs_9,	// @[CRRV/src/core/Core.scala:12:14]
                io_debug_regs_regs_10,	// @[CRRV/src/core/Core.scala:12:14]
                io_debug_regs_regs_11,	// @[CRRV/src/core/Core.scala:12:14]
                io_debug_regs_regs_12,	// @[CRRV/src/core/Core.scala:12:14]
                io_debug_regs_regs_13,	// @[CRRV/src/core/Core.scala:12:14]
                io_debug_regs_regs_14,	// @[CRRV/src/core/Core.scala:12:14]
                io_debug_regs_regs_15,	// @[CRRV/src/core/Core.scala:12:14]
                io_debug_regs_regs_16,	// @[CRRV/src/core/Core.scala:12:14]
                io_debug_regs_regs_17,	// @[CRRV/src/core/Core.scala:12:14]
                io_debug_regs_regs_18,	// @[CRRV/src/core/Core.scala:12:14]
                io_debug_regs_regs_19,	// @[CRRV/src/core/Core.scala:12:14]
                io_debug_regs_regs_20,	// @[CRRV/src/core/Core.scala:12:14]
                io_debug_regs_regs_21,	// @[CRRV/src/core/Core.scala:12:14]
                io_debug_regs_regs_22,	// @[CRRV/src/core/Core.scala:12:14]
                io_debug_regs_regs_23,	// @[CRRV/src/core/Core.scala:12:14]
                io_debug_regs_regs_24,	// @[CRRV/src/core/Core.scala:12:14]
                io_debug_regs_regs_25,	// @[CRRV/src/core/Core.scala:12:14]
                io_debug_regs_regs_26,	// @[CRRV/src/core/Core.scala:12:14]
                io_debug_regs_regs_27,	// @[CRRV/src/core/Core.scala:12:14]
                io_debug_regs_regs_28,	// @[CRRV/src/core/Core.scala:12:14]
                io_debug_regs_regs_29,	// @[CRRV/src/core/Core.scala:12:14]
                io_debug_regs_regs_30,	// @[CRRV/src/core/Core.scala:12:14]
                io_debug_regs_regs_31,	// @[CRRV/src/core/Core.scala:12:14]
                io_debug_csr_mstatus,	// @[CRRV/src/core/Core.scala:12:14]
                io_debug_csr_mcause,	// @[CRRV/src/core/Core.scala:12:14]
                io_debug_csr_mtvec,	// @[CRRV/src/core/Core.scala:12:14]
                io_debug_csr_mepc,	// @[CRRV/src/core/Core.scala:12:14]
                io_debug_csr_mscratch,	// @[CRRV/src/core/Core.scala:12:14]
                io_debug_csr_mie,	// @[CRRV/src/core/Core.scala:12:14]
                io_debug_csr_mip,	// @[CRRV/src/core/Core.scala:12:14]
                io_debug_csr_mtval,	// @[CRRV/src/core/Core.scala:12:14]
  output        io_debug_intr	// @[CRRV/src/core/Core.scala:12:14]
);

  wire        _excMon_io_check_valid;	// @[CRRV/src/core/Core.scala:33:31]
  wire [31:0] _regFile_io_read1_data;	// @[CRRV/src/core/Core.scala:32:31]
  wire [31:0] _regFile_io_read2_data;	// @[CRRV/src/core/Core.scala:32:31]
  wire [31:0] _csrFile_io_read_data;	// @[CRRV/src/core/Core.scala:31:31]
  wire [31:0] _csrFile_io_csrInfo_mepc;	// @[CRRV/src/core/Core.scala:31:31]
  wire [31:0] _csrFile_io_csrInfo_trapEnterVec;	// @[CRRV/src/core/Core.scala:31:31]
  wire        _csrFile_io_csrInfo_intr;	// @[CRRV/src/core/Core.scala:31:31]
  wire [31:0] _hazardResolver_io_regRead1_data;	// @[CRRV/src/core/Core.scala:30:31]
  wire [31:0] _hazardResolver_io_regRead2_data;	// @[CRRV/src/core/Core.scala:30:31]
  wire [31:0] _hazardResolver_io_csrRead_data;	// @[CRRV/src/core/Core.scala:30:31]
  wire        _hazardResolver_io_regFile1_en;	// @[CRRV/src/core/Core.scala:30:31]
  wire [4:0]  _hazardResolver_io_regFile1_addr;	// @[CRRV/src/core/Core.scala:30:31]
  wire        _hazardResolver_io_regFile2_en;	// @[CRRV/src/core/Core.scala:30:31]
  wire [4:0]  _hazardResolver_io_regFile2_addr;	// @[CRRV/src/core/Core.scala:30:31]
  wire [11:0] _hazardResolver_io_regCsr_addr;	// @[CRRV/src/core/Core.scala:30:31]
  wire        _hazardResolver_io_memExcMonCheck_valid;	// @[CRRV/src/core/Core.scala:30:31]
  wire [31:0] _hazardResolver_io_excMonCheck_addr;	// @[CRRV/src/core/Core.scala:30:31]
  wire        _hazardResolver_io_loadHazardFlag;	// @[CRRV/src/core/Core.scala:30:31]
  wire        _hazardResolver_io_csrHazardFlag;	// @[CRRV/src/core/Core.scala:30:31]
  wire        _pipelineControl_io_stallIF;	// @[CRRV/src/core/Core.scala:29:31]
  wire        _pipelineControl_io_stallID;	// @[CRRV/src/core/Core.scala:29:31]
  wire        _pipelineControl_io_stallEXE;	// @[CRRV/src/core/Core.scala:29:31]
  wire        _pipelineControl_io_stallMEM;	// @[CRRV/src/core/Core.scala:29:31]
  wire        _pipelineControl_io_stallWB;	// @[CRRV/src/core/Core.scala:29:31]
  wire        _pipelineControl_io_flushAll;	// @[CRRV/src/core/Core.scala:29:31]
  wire        _pipelineControl_io_flushIF;	// @[CRRV/src/core/Core.scala:29:31]
  wire [31:0] _pipelineControl_io_flushPc;	// @[CRRV/src/core/Core.scala:29:31]
  wire [2:0]  _writeBackStage_io_wb2csr_op;	// @[CRRV/src/core/Core.scala:27:30]
  wire [11:0] _writeBackStage_io_wb2csr_addr;	// @[CRRV/src/core/Core.scala:27:30]
  wire [31:0] _writeBackStage_io_wb2csr_data;	// @[CRRV/src/core/Core.scala:27:30]
  wire [2:0]  _writeBackStage_io_wb2csr_exceptType;	// @[CRRV/src/core/Core.scala:27:30]
  wire [31:0] _writeBackStage_io_wb2csr_exceptPc;	// @[CRRV/src/core/Core.scala:27:30]
  wire [31:0] _writeBackStage_io_excMonCommit_addr;	// @[CRRV/src/core/Core.scala:27:30]
  wire        _writeBackStage_io_excMonCommit_set;	// @[CRRV/src/core/Core.scala:27:30]
  wire        _writeBackStage_io_excMonCommit_clear;	// @[CRRV/src/core/Core.scala:27:30]
  wire        _writeBackStage_io_regForward_en;	// @[CRRV/src/core/Core.scala:27:30]
  wire [4:0]  _writeBackStage_io_regForward_addr;	// @[CRRV/src/core/Core.scala:27:30]
  wire [31:0] _writeBackStage_io_regForward_data;	// @[CRRV/src/core/Core.scala:27:30]
  wire        _mem2wb_io_next_IF_instValid;	// @[CRRV/src/core/Core.scala:26:30]
  wire [31:0] _mem2wb_io_next_IF_pc;	// @[CRRV/src/core/Core.scala:26:30]
  wire [31:0] _mem2wb_io_next_ID_inst;	// @[CRRV/src/core/Core.scala:26:30]
  wire [4:0]  _mem2wb_io_next_ID_lsuOp;	// @[CRRV/src/core/Core.scala:26:30]
  wire        _mem2wb_io_next_ID_regWen;	// @[CRRV/src/core/Core.scala:26:30]
  wire [4:0]  _mem2wb_io_next_ID_regWaddr;	// @[CRRV/src/core/Core.scala:26:30]
  wire [2:0]  _mem2wb_io_next_ID_csrOp;	// @[CRRV/src/core/Core.scala:26:30]
  wire [11:0] _mem2wb_io_next_ID_csrAddr;	// @[CRRV/src/core/Core.scala:26:30]
  wire [31:0] _mem2wb_io_next_ID_csrWriteData;	// @[CRRV/src/core/Core.scala:26:30]
  wire [2:0]  _mem2wb_io_next_ID_exceptType;	// @[CRRV/src/core/Core.scala:26:30]
  wire [31:0] _mem2wb_io_next_EXE_exeResult;	// @[CRRV/src/core/Core.scala:26:30]
  wire [31:0] _mem2wb_io_next_MEM_excMonCommit_addr;	// @[CRRV/src/core/Core.scala:26:30]
  wire        _mem2wb_io_next_MEM_excMonCommit_set;	// @[CRRV/src/core/Core.scala:26:30]
  wire        _mem2wb_io_next_MEM_excMonCommit_clear;	// @[CRRV/src/core/Core.scala:26:30]
  wire        _mem2wb_io_next_MEM_amoValid;	// @[CRRV/src/core/Core.scala:26:30]
  wire [31:0] _mem2wb_io_next_MEM_amoResult;	// @[CRRV/src/core/Core.scala:26:30]
  wire        _memoryStage_io_control_stallReq;	// @[CRRV/src/core/Core.scala:25:30]
  wire        _memoryStage_io_mem2wb_IF_instValid;	// @[CRRV/src/core/Core.scala:25:30]
  wire [31:0] _memoryStage_io_mem2wb_IF_pc;	// @[CRRV/src/core/Core.scala:25:30]
  wire [31:0] _memoryStage_io_mem2wb_ID_inst;	// @[CRRV/src/core/Core.scala:25:30]
  wire [4:0]  _memoryStage_io_mem2wb_ID_lsuOp;	// @[CRRV/src/core/Core.scala:25:30]
  wire        _memoryStage_io_mem2wb_ID_regWen;	// @[CRRV/src/core/Core.scala:25:30]
  wire [4:0]  _memoryStage_io_mem2wb_ID_regWaddr;	// @[CRRV/src/core/Core.scala:25:30]
  wire [2:0]  _memoryStage_io_mem2wb_ID_csrOp;	// @[CRRV/src/core/Core.scala:25:30]
  wire [11:0] _memoryStage_io_mem2wb_ID_csrAddr;	// @[CRRV/src/core/Core.scala:25:30]
  wire [31:0] _memoryStage_io_mem2wb_ID_csrWriteData;	// @[CRRV/src/core/Core.scala:25:30]
  wire [2:0]  _memoryStage_io_mem2wb_ID_exceptType;	// @[CRRV/src/core/Core.scala:25:30]
  wire [31:0] _memoryStage_io_mem2wb_EXE_exeResult;	// @[CRRV/src/core/Core.scala:25:30]
  wire [31:0] _memoryStage_io_mem2wb_MEM_excMonCommit_addr;	// @[CRRV/src/core/Core.scala:25:30]
  wire        _memoryStage_io_mem2wb_MEM_excMonCommit_set;	// @[CRRV/src/core/Core.scala:25:30]
  wire        _memoryStage_io_mem2wb_MEM_excMonCommit_clear;	// @[CRRV/src/core/Core.scala:25:30]
  wire        _memoryStage_io_mem2wb_MEM_amoValid;	// @[CRRV/src/core/Core.scala:25:30]
  wire [31:0] _memoryStage_io_mem2wb_MEM_amoResult;	// @[CRRV/src/core/Core.scala:25:30]
  wire [31:0] _memoryStage_io_excMon_addr;	// @[CRRV/src/core/Core.scala:25:30]
  wire [2:0]  _memoryStage_io_memCsrStall_op;	// @[CRRV/src/core/Core.scala:25:30]
  wire [11:0] _memoryStage_io_memCsrStall_addr;	// @[CRRV/src/core/Core.scala:25:30]
  wire        _memoryStage_io_regForward_en;	// @[CRRV/src/core/Core.scala:25:30]
  wire [4:0]  _memoryStage_io_regForward_addr;	// @[CRRV/src/core/Core.scala:25:30]
  wire [31:0] _memoryStage_io_regForward_data;	// @[CRRV/src/core/Core.scala:25:30]
  wire        _memoryStage_io_regForward_load;	// @[CRRV/src/core/Core.scala:25:30]
  wire        _exe2mem_io_next_IF_instValid;	// @[CRRV/src/core/Core.scala:24:30]
  wire [31:0] _exe2mem_io_next_IF_pc;	// @[CRRV/src/core/Core.scala:24:30]
  wire [31:0] _exe2mem_io_next_ID_inst;	// @[CRRV/src/core/Core.scala:24:30]
  wire [4:0]  _exe2mem_io_next_ID_lsuOp;	// @[CRRV/src/core/Core.scala:24:30]
  wire [31:0] _exe2mem_io_next_ID_lsuData;	// @[CRRV/src/core/Core.scala:24:30]
  wire        _exe2mem_io_next_ID_regWen;	// @[CRRV/src/core/Core.scala:24:30]
  wire [4:0]  _exe2mem_io_next_ID_regWaddr;	// @[CRRV/src/core/Core.scala:24:30]
  wire [2:0]  _exe2mem_io_next_ID_csrOp;	// @[CRRV/src/core/Core.scala:24:30]
  wire [11:0] _exe2mem_io_next_ID_csrAddr;	// @[CRRV/src/core/Core.scala:24:30]
  wire [31:0] _exe2mem_io_next_ID_csrWriteData;	// @[CRRV/src/core/Core.scala:24:30]
  wire [2:0]  _exe2mem_io_next_ID_exceptType;	// @[CRRV/src/core/Core.scala:24:30]
  wire        _exe2mem_io_next_EXE_load;	// @[CRRV/src/core/Core.scala:24:30]
  wire [31:0] _exe2mem_io_next_EXE_exeResult;	// @[CRRV/src/core/Core.scala:24:30]
  wire        _executeStage_io_control_stallReq;	// @[CRRV/src/core/Core.scala:23:30]
  wire        _executeStage_io_exe2mem_IF_instValid;	// @[CRRV/src/core/Core.scala:23:30]
  wire [31:0] _executeStage_io_exe2mem_IF_pc;	// @[CRRV/src/core/Core.scala:23:30]
  wire [31:0] _executeStage_io_exe2mem_ID_inst;	// @[CRRV/src/core/Core.scala:23:30]
  wire [4:0]  _executeStage_io_exe2mem_ID_lsuOp;	// @[CRRV/src/core/Core.scala:23:30]
  wire [31:0] _executeStage_io_exe2mem_ID_lsuData;	// @[CRRV/src/core/Core.scala:23:30]
  wire        _executeStage_io_exe2mem_ID_regWen;	// @[CRRV/src/core/Core.scala:23:30]
  wire [4:0]  _executeStage_io_exe2mem_ID_regWaddr;	// @[CRRV/src/core/Core.scala:23:30]
  wire [2:0]  _executeStage_io_exe2mem_ID_csrOp;	// @[CRRV/src/core/Core.scala:23:30]
  wire [11:0] _executeStage_io_exe2mem_ID_csrAddr;	// @[CRRV/src/core/Core.scala:23:30]
  wire [31:0] _executeStage_io_exe2mem_ID_csrWriteData;	// @[CRRV/src/core/Core.scala:23:30]
  wire [2:0]  _executeStage_io_exe2mem_ID_exceptType;	// @[CRRV/src/core/Core.scala:23:30]
  wire        _executeStage_io_exe2mem_EXE_load;	// @[CRRV/src/core/Core.scala:23:30]
  wire [31:0] _executeStage_io_exe2mem_EXE_exeResult;	// @[CRRV/src/core/Core.scala:23:30]
  wire [2:0]  _executeStage_io_csrRead_op;	// @[CRRV/src/core/Core.scala:23:30]
  wire [11:0] _executeStage_io_csrRead_addr;	// @[CRRV/src/core/Core.scala:23:30]
  wire        _executeStage_io_regForward_en;	// @[CRRV/src/core/Core.scala:23:30]
  wire [4:0]  _executeStage_io_regForward_addr;	// @[CRRV/src/core/Core.scala:23:30]
  wire [31:0] _executeStage_io_regForward_data;	// @[CRRV/src/core/Core.scala:23:30]
  wire        _executeStage_io_regForward_load;	// @[CRRV/src/core/Core.scala:23:30]
  wire        _id2exe_io_next_IF_instValid;	// @[CRRV/src/core/Core.scala:22:30]
  wire [31:0] _id2exe_io_next_IF_pc;	// @[CRRV/src/core/Core.scala:22:30]
  wire [31:0] _id2exe_io_next_ID_inst;	// @[CRRV/src/core/Core.scala:22:30]
  wire [3:0]  _id2exe_io_next_ID_aluOp;	// @[CRRV/src/core/Core.scala:22:30]
  wire [3:0]  _id2exe_io_next_ID_mduOp;	// @[CRRV/src/core/Core.scala:22:30]
  wire [31:0] _id2exe_io_next_ID_src1;	// @[CRRV/src/core/Core.scala:22:30]
  wire [31:0] _id2exe_io_next_ID_src2;	// @[CRRV/src/core/Core.scala:22:30]
  wire [4:0]  _id2exe_io_next_ID_lsuOp;	// @[CRRV/src/core/Core.scala:22:30]
  wire [31:0] _id2exe_io_next_ID_lsuData;	// @[CRRV/src/core/Core.scala:22:30]
  wire        _id2exe_io_next_ID_regWen;	// @[CRRV/src/core/Core.scala:22:30]
  wire [4:0]  _id2exe_io_next_ID_regWaddr;	// @[CRRV/src/core/Core.scala:22:30]
  wire [2:0]  _id2exe_io_next_ID_csrOp;	// @[CRRV/src/core/Core.scala:22:30]
  wire [11:0] _id2exe_io_next_ID_csrAddr;	// @[CRRV/src/core/Core.scala:22:30]
  wire [31:0] _id2exe_io_next_ID_csrWriteData;	// @[CRRV/src/core/Core.scala:22:30]
  wire [2:0]  _id2exe_io_next_ID_exceptType;	// @[CRRV/src/core/Core.scala:22:30]
  wire        _decodeStage_io_control_flushIF;	// @[CRRV/src/core/Core.scala:21:30]
  wire [31:0] _decodeStage_io_control_flushPc;	// @[CRRV/src/core/Core.scala:21:30]
  wire        _decodeStage_io_id2exe_IF_instValid;	// @[CRRV/src/core/Core.scala:21:30]
  wire [31:0] _decodeStage_io_id2exe_IF_pc;	// @[CRRV/src/core/Core.scala:21:30]
  wire [31:0] _decodeStage_io_id2exe_ID_inst;	// @[CRRV/src/core/Core.scala:21:30]
  wire [3:0]  _decodeStage_io_id2exe_ID_aluOp;	// @[CRRV/src/core/Core.scala:21:30]
  wire [3:0]  _decodeStage_io_id2exe_ID_mduOp;	// @[CRRV/src/core/Core.scala:21:30]
  wire [31:0] _decodeStage_io_id2exe_ID_src1;	// @[CRRV/src/core/Core.scala:21:30]
  wire [31:0] _decodeStage_io_id2exe_ID_src2;	// @[CRRV/src/core/Core.scala:21:30]
  wire [4:0]  _decodeStage_io_id2exe_ID_lsuOp;	// @[CRRV/src/core/Core.scala:21:30]
  wire [31:0] _decodeStage_io_id2exe_ID_lsuData;	// @[CRRV/src/core/Core.scala:21:30]
  wire        _decodeStage_io_id2exe_ID_regWen;	// @[CRRV/src/core/Core.scala:21:30]
  wire [4:0]  _decodeStage_io_id2exe_ID_regWaddr;	// @[CRRV/src/core/Core.scala:21:30]
  wire [2:0]  _decodeStage_io_id2exe_ID_csrOp;	// @[CRRV/src/core/Core.scala:21:30]
  wire [11:0] _decodeStage_io_id2exe_ID_csrAddr;	// @[CRRV/src/core/Core.scala:21:30]
  wire [31:0] _decodeStage_io_id2exe_ID_csrWriteData;	// @[CRRV/src/core/Core.scala:21:30]
  wire [2:0]  _decodeStage_io_id2exe_ID_exceptType;	// @[CRRV/src/core/Core.scala:21:30]
  wire        _decodeStage_io_branchInfo_branch;	// @[CRRV/src/core/Core.scala:21:30]
  wire        _decodeStage_io_branchInfo_jump;	// @[CRRV/src/core/Core.scala:21:30]
  wire        _decodeStage_io_branchInfo_taken;	// @[CRRV/src/core/Core.scala:21:30]
  wire [4:0]  _decodeStage_io_branchInfo_index;	// @[CRRV/src/core/Core.scala:21:30]
  wire [31:0] _decodeStage_io_branchInfo_pc;	// @[CRRV/src/core/Core.scala:21:30]
  wire [31:0] _decodeStage_io_branchInfo_target;	// @[CRRV/src/core/Core.scala:21:30]
  wire        _decodeStage_io_regRead1_en;	// @[CRRV/src/core/Core.scala:21:30]
  wire [4:0]  _decodeStage_io_regRead1_addr;	// @[CRRV/src/core/Core.scala:21:30]
  wire        _decodeStage_io_regRead2_en;	// @[CRRV/src/core/Core.scala:21:30]
  wire [4:0]  _decodeStage_io_regRead2_addr;	// @[CRRV/src/core/Core.scala:21:30]
  wire        _if2id_io_next_IF_instValid;	// @[CRRV/src/core/Core.scala:20:30]
  wire [31:0] _if2id_io_next_IF_pc;	// @[CRRV/src/core/Core.scala:20:30]
  wire        _if2id_io_next_IF_predTaken;	// @[CRRV/src/core/Core.scala:20:30]
  wire [31:0] _if2id_io_next_IF_predTarget;	// @[CRRV/src/core/Core.scala:20:30]
  wire [4:0]  _if2id_io_next_IF_predIndex;	// @[CRRV/src/core/Core.scala:20:30]
  wire        _fetchStage_io_control_stallReq;	// @[CRRV/src/core/Core.scala:19:30]
  wire        _fetchStage_io_if2id_IF_instValid;	// @[CRRV/src/core/Core.scala:19:30]
  wire [31:0] _fetchStage_io_if2id_IF_pc;	// @[CRRV/src/core/Core.scala:19:30]
  wire        _fetchStage_io_if2id_IF_predTaken;	// @[CRRV/src/core/Core.scala:19:30]
  wire [31:0] _fetchStage_io_if2id_IF_predTarget;	// @[CRRV/src/core/Core.scala:19:30]
  wire [4:0]  _fetchStage_io_if2id_IF_predIndex;	// @[CRRV/src/core/Core.scala:19:30]
  FetchStage fetchStage (	// @[CRRV/src/core/Core.scala:19:30]
    .clock                  (clock),
    .reset                  (reset),
    .io_control_flush       (_pipelineControl_io_flushIF),	// @[CRRV/src/core/Core.scala:29:31]
    .io_control_flushPC     (_pipelineControl_io_flushPc),	// @[CRRV/src/core/Core.scala:29:31]
    .io_control_stall       (_pipelineControl_io_stallIF),	// @[CRRV/src/core/Core.scala:29:31]
    .io_instRom_ready       (io_inst_out_ready),
    .io_branchInfo_branch   (_decodeStage_io_branchInfo_branch),	// @[CRRV/src/core/Core.scala:21:30]
    .io_branchInfo_jump     (_decodeStage_io_branchInfo_jump),	// @[CRRV/src/core/Core.scala:21:30]
    .io_branchInfo_taken    (_decodeStage_io_branchInfo_taken),	// @[CRRV/src/core/Core.scala:21:30]
    .io_branchInfo_index    (_decodeStage_io_branchInfo_index),	// @[CRRV/src/core/Core.scala:21:30]
    .io_branchInfo_pc       (_decodeStage_io_branchInfo_pc),	// @[CRRV/src/core/Core.scala:21:30]
    .io_branchInfo_target   (_decodeStage_io_branchInfo_target),	// @[CRRV/src/core/Core.scala:21:30]
  ...
  PipelineStage if2id (	// @[CRRV/src/core/Core.scala:20:30]
    .clock                 (clock),
    .reset                 (reset),
    .io_flush              (_pipelineControl_io_flushIF),	// @[CRRV/src/core/Core.scala:29:31]
    .io_stallPrev          (_pipelineControl_io_stallIF),	// @[CRRV/src/core/Core.scala:29:31]
    .io_stallNext          (_pipelineControl_io_stallID),	// @[CRRV/src/core/Core.scala:29:31]
    .io_prev_IF_instValid  (_fetchStage_io_if2id_IF_instValid),	// @[CRRV/src/core/Core.scala:19:30]
    .io_prev_IF_pc         (_fetchStage_io_if2id_IF_pc),	// @[CRRV/src/core/Core.scala:19:30]
    .io_prev_IF_predTaken  (_fetchStage_io_if2id_IF_predTaken),	// @[CRRV/src/core/Core.scala:19:30]
    .io_prev_IF_predTarget (_fetchStage_io_if2id_IF_predTarget),	// @[CRRV/src/core/Core.scala:19:30]
    .io_prev_IF_predIndex  (_fetchStage_io_if2id_IF_predIndex),	// @[CRRV/src/core/Core.scala:19:30]
  ...
  DecodeStage decodeStage (	// @[CRRV/src/core/Core.scala:21:30]
    .clock                     (clock),
    .io_if2id_IF_instValid     (_if2id_io_next_IF_instValid),	// @[CRRV/src/core/Core.scala:20:30]
    .io_if2id_IF_pc            (_if2id_io_next_IF_pc),	// @[CRRV/src/core/Core.scala:20:30]
    .io_if2id_IF_predTaken     (_if2id_io_next_IF_predTaken),	// @[CRRV/src/core/Core.scala:20:30]
    .io_if2id_IF_predTarget    (_if2id_io_next_IF_predTarget),	// @[CRRV/src/core/Core.scala:20:30]
    .io_if2id_IF_predIndex     (_if2id_io_next_IF_predIndex),	// @[CRRV/src/core/Core.scala:20:30]
    .io_control_stall          (_pipelineControl_io_stallID),	// @[CRRV/src/core/Core.scala:29:31]
    .io_read_rdata             (io_inst_in_rdata),
    .io_regRead1_data          (_hazardResolver_io_regRead1_data),	// @[CRRV/src/core/Core.scala:30:31]
    .io_regRead2_data          (_hazardResolver_io_regRead2_data),	// @[CRRV/src/core/Core.scala:30:31]
  ...
  PipelineStage_1 id2exe (	// @[CRRV/src/core/Core.scala:22:30]
    .clock                   (clock),
    .reset                   (reset),
    .io_flush                (_pipelineControl_io_flushAll),	// @[CRRV/src/core/Core.scala:29:31]
    .io_stallPrev            (_pipelineControl_io_stallID),	// @[CRRV/src/core/Core.scala:29:31]
    .io_stallNext            (_pipelineControl_io_stallEXE),	// @[CRRV/src/core/Core.scala:29:31]
    .io_prev_IF_instValid    (_decodeStage_io_id2exe_IF_instValid),	// @[CRRV/src/core/Core.scala:21:30]
    .io_prev_IF_pc           (_decodeStage_io_id2exe_IF_pc),	// @[CRRV/src/core/Core.scala:21:30]
    .io_prev_ID_inst         (_decodeStage_io_id2exe_ID_inst),	// @[CRRV/src/core/Core.scala:21:30]
    .io_prev_ID_aluOp        (_decodeStage_io_id2exe_ID_aluOp),	// @[CRRV/src/core/Core.scala:21:30]
    .io_prev_ID_mduOp        (_decodeStage_io_id2exe_ID_mduOp),	// @[CRRV/src/core/Core.scala:21:30]
    .io_prev_ID_src1         (_decodeStage_io_id2exe_ID_src1),	// @[CRRV/src/core/Core.scala:21:30]
    .io_prev_ID_src2         (_decodeStage_io_id2exe_ID_src2),	// @[CRRV/src/core/Core.scala:21:30]
    .io_prev_ID_lsuOp        (_decodeStage_io_id2exe_ID_lsuOp),	// @[CRRV/src/core/Core.scala:21:30]
    .io_prev_ID_lsuData      (_decodeStage_io_id2exe_ID_lsuData),	// @[CRRV/src/core/Core.scala:21:30]
    .io_prev_ID_regWen       (_decodeStage_io_id2exe_ID_regWen),	// @[CRRV/src/core/Core.scala:21:30]
    .io_prev_ID_regWaddr     (_decodeStage_io_id2exe_ID_regWaddr),	// @[CRRV/src/core/Core.scala:21:30]
    .io_prev_ID_csrOp        (_decodeStage_io_id2exe_ID_csrOp),	// @[CRRV/src/core/Core.scala:21:30]
    .io_prev_ID_csrAddr      (_decodeStage_io_id2exe_ID_csrAddr),	// @[CRRV/src/core/Core.scala:21:30]
    .io_prev_ID_csrWriteData (_decodeStage_io_id2exe_ID_csrWriteData),	// @[CRRV/src/core/Core.scala:21:30]
    .io_prev_ID_exceptType   (_decodeStage_io_id2exe_ID_exceptType),	// @[CRRV/src/core/Core.scala:21:30]
  ...
  ExecuteStage executeStage (	// @[CRRV/src/core/Core.scala:23:30]
    .clock                      (clock),
    .reset                      (reset),
    .io_id2exe_IF_instValid     (_id2exe_io_next_IF_instValid),	// @[CRRV/src/core/Core.scala:22:30]
    .io_id2exe_IF_pc            (_id2exe_io_next_IF_pc),	// @[CRRV/src/core/Core.scala:22:30]
    .io_id2exe_ID_inst          (_id2exe_io_next_ID_inst),	// @[CRRV/src/core/Core.scala:22:30]
    .io_id2exe_ID_aluOp         (_id2exe_io_next_ID_aluOp),	// @[CRRV/src/core/Core.scala:22:30]
    .io_id2exe_ID_mduOp         (_id2exe_io_next_ID_mduOp),	// @[CRRV/src/core/Core.scala:22:30]
    .io_id2exe_ID_src1          (_id2exe_io_next_ID_src1),	// @[CRRV/src/core/Core.scala:22:30]
    .io_id2exe_ID_src2          (_id2exe_io_next_ID_src2),	// @[CRRV/src/core/Core.scala:22:30]
    .io_id2exe_ID_lsuOp         (_id2exe_io_next_ID_lsuOp),	// @[CRRV/src/core/Core.scala:22:30]
    .io_id2exe_ID_lsuData       (_id2exe_io_next_ID_lsuData),	// @[CRRV/src/core/Core.scala:22:30]
    .io_id2exe_ID_regWen        (_id2exe_io_next_ID_regWen),	// @[CRRV/src/core/Core.scala:22:30]
    .io_id2exe_ID_regWaddr      (_id2exe_io_next_ID_regWaddr),	// @[CRRV/src/core/Core.scala:22:30]
    .io_id2exe_ID_csrOp         (_id2exe_io_next_ID_csrOp),	// @[CRRV/src/core/Core.scala:22:30]
    .io_id2exe_ID_csrAddr       (_id2exe_io_next_ID_csrAddr),	// @[CRRV/src/core/Core.scala:22:30]
    .io_id2exe_ID_csrWriteData  (_id2exe_io_next_ID_csrWriteData),	// @[CRRV/src/core/Core.scala:22:30]
    .io_id2exe_ID_exceptType    (_id2exe_io_next_ID_exceptType),	// @[CRRV/src/core/Core.scala:22:30]
    .io_control_flush           (_pipelineControl_io_flushAll),	// @[CRRV/src/core/Core.scala:29:31]
    .io_csrRead_data            (_hazardResolver_io_csrRead_data),	// @[CRRV/src/core/Core.scala:30:31]
  ...
  PipelineStage_2 exe2mem (	// @[CRRV/src/core/Core.scala:24:30]
    .clock                   (clock),
    .reset                   (reset),
    .io_flush                (_pipelineControl_io_flushAll),	// @[CRRV/src/core/Core.scala:29:31]
    .io_stallPrev            (_pipelineControl_io_stallEXE),	// @[CRRV/src/core/Core.scala:29:31]
    .io_stallNext            (_pipelineControl_io_stallMEM),	// @[CRRV/src/core/Core.scala:29:31]
    .io_prev_IF_instValid    (_executeStage_io_exe2mem_IF_instValid),	// @[CRRV/src/core/Core.scala:23:30]
    .io_prev_IF_pc           (_executeStage_io_exe2mem_IF_pc),	// @[CRRV/src/core/Core.scala:23:30]
    .io_prev_ID_inst         (_executeStage_io_exe2mem_ID_inst),	// @[CRRV/src/core/Core.scala:23:30]
    .io_prev_ID_lsuOp        (_executeStage_io_exe2mem_ID_lsuOp),	// @[CRRV/src/core/Core.scala:23:30]
    .io_prev_ID_lsuData      (_executeStage_io_exe2mem_ID_lsuData),	// @[CRRV/src/core/Core.scala:23:30]
    .io_prev_ID_regWen       (_executeStage_io_exe2mem_ID_regWen),	// @[CRRV/src/core/Core.scala:23:30]
    .io_prev_ID_regWaddr     (_executeStage_io_exe2mem_ID_regWaddr),	// @[CRRV/src/core/Core.scala:23:30]
    .io_prev_ID_csrOp        (_executeStage_io_exe2mem_ID_csrOp),	// @[CRRV/src/core/Core.scala:23:30]
    .io_prev_ID_csrAddr      (_executeStage_io_exe2mem_ID_csrAddr),	// @[CRRV/src/core/Core.scala:23:30]
    .io_prev_ID_csrWriteData (_executeStage_io_exe2mem_ID_csrWriteData),	// @[CRRV/src/core/Core.scala:23:30]
    .io_prev_ID_exceptType   (_executeStage_io_exe2mem_ID_exceptType),	// @[CRRV/src/core/Core.scala:23:30]
    .io_prev_EXE_load        (_executeStage_io_exe2mem_EXE_load),	// @[CRRV/src/core/Core.scala:23:30]
    .io_prev_EXE_exeResult   (_executeStage_io_exe2mem_EXE_exeResult),	// @[CRRV/src/core/Core.scala:23:30]
  ...
  MemoryStage memoryStage (	// @[CRRV/src/core/Core.scala:25:30]
    .clock                            (clock),
    .reset                            (reset),
    .io_exe2mem_IF_instValid          (_exe2mem_io_next_IF_instValid),	// @[CRRV/src/core/Core.scala:24:30]
    .io_exe2mem_IF_pc                 (_exe2mem_io_next_IF_pc),	// @[CRRV/src/core/Core.scala:24:30]
    .io_exe2mem_ID_inst               (_exe2mem_io_next_ID_inst),	// @[CRRV/src/core/Core.scala:24:30]
    .io_exe2mem_ID_lsuOp              (_exe2mem_io_next_ID_lsuOp),	// @[CRRV/src/core/Core.scala:24:30]
    .io_exe2mem_ID_lsuData            (_exe2mem_io_next_ID_lsuData),	// @[CRRV/src/core/Core.scala:24:30]
    .io_exe2mem_ID_regWen             (_exe2mem_io_next_ID_regWen),	// @[CRRV/src/core/Core.scala:24:30]
    .io_exe2mem_ID_regWaddr           (_exe2mem_io_next_ID_regWaddr),	// @[CRRV/src/core/Core.scala:24:30]
    .io_exe2mem_ID_csrOp              (_exe2mem_io_next_ID_csrOp),	// @[CRRV/src/core/Core.scala:24:30]
    .io_exe2mem_ID_csrAddr            (_exe2mem_io_next_ID_csrAddr),	// @[CRRV/src/core/Core.scala:24:30]
    .io_exe2mem_ID_csrWriteData       (_exe2mem_io_next_ID_csrWriteData),	// @[CRRV/src/core/Core.scala:24:30]
    .io_exe2mem_ID_exceptType         (_exe2mem_io_next_ID_exceptType),	// @[CRRV/src/core/Core.scala:24:30]
    .io_exe2mem_EXE_load              (_exe2mem_io_next_EXE_load),	// @[CRRV/src/core/Core.scala:24:30]
    .io_exe2mem_EXE_exeResult         (_exe2mem_io_next_EXE_exeResult),	// @[CRRV/src/core/Core.scala:24:30]
    .io_control_flush                 (_pipelineControl_io_flushAll),	// @[CRRV/src/core/Core.scala:29:31]
    .io_dataRam_out_ready             (io_data_out_ready),
    .io_dataRam_in_rdata              (io_data_in_rdata),
    .io_excMon_valid                  (_hazardResolver_io_memExcMonCheck_valid),	// @[CRRV/src/core/Core.scala:30:31]
  ...
  PipelineStage_3 mem2wb (	// @[CRRV/src/core/Core.scala:26:30]
    .clock                          (clock),
    .reset                          (reset),
    .io_flush                       (_pipelineControl_io_flushAll),	// @[CRRV/src/core/Core.scala:29:31]
    .io_stallPrev                   (_pipelineControl_io_stallMEM),	// @[CRRV/src/core/Core.scala:29:31]
    .io_stallNext                   (_pipelineControl_io_stallWB),	// @[CRRV/src/core/Core.scala:29:31]
    .io_prev_IF_instValid           (_memoryStage_io_mem2wb_IF_instValid),	// @[CRRV/src/core/Core.scala:25:30]
    .io_prev_IF_pc                  (_memoryStage_io_mem2wb_IF_pc),	// @[CRRV/src/core/Core.scala:25:30]
    .io_prev_ID_inst                (_memoryStage_io_mem2wb_ID_inst),	// @[CRRV/src/core/Core.scala:25:30]
    .io_prev_ID_lsuOp               (_memoryStage_io_mem2wb_ID_lsuOp),	// @[CRRV/src/core/Core.scala:25:30]
    .io_prev_ID_regWen              (_memoryStage_io_mem2wb_ID_regWen),	// @[CRRV/src/core/Core.scala:25:30]
    .io_prev_ID_regWaddr            (_memoryStage_io_mem2wb_ID_regWaddr),	// @[CRRV/src/core/Core.scala:25:30]
    .io_prev_ID_csrOp               (_memoryStage_io_mem2wb_ID_csrOp),	// @[CRRV/src/core/Core.scala:25:30]
    .io_prev_ID_csrAddr             (_memoryStage_io_mem2wb_ID_csrAddr),	// @[CRRV/src/core/Core.scala:25:30]
    .io_prev_ID_csrWriteData        (_memoryStage_io_mem2wb_ID_csrWriteData),	// @[CRRV/src/core/Core.scala:25:30]
    .io_prev_ID_exceptType          (_memoryStage_io_mem2wb_ID_exceptType),	// @[CRRV/src/core/Core.scala:25:30]
    .io_prev_EXE_exeResult          (_memoryStage_io_mem2wb_EXE_exeResult),	// @[CRRV/src/core/Core.scala:25:30]
    .io_prev_MEM_excMonCommit_addr  (_memoryStage_io_mem2wb_MEM_excMonCommit_addr),	// @[CRRV/src/core/Core.scala:25:30]
    .io_prev_MEM_excMonCommit_set   (_memoryStage_io_mem2wb_MEM_excMonCommit_set),	// @[CRRV/src/core/Core.scala:25:30]
    .io_prev_MEM_excMonCommit_clear (_memoryStage_io_mem2wb_MEM_excMonCommit_clear),	// @[CRRV/src/core/Core.scala:25:30]
    .io_prev_MEM_amoValid           (_memoryStage_io_mem2wb_MEM_amoValid),	// @[CRRV/src/core/Core.scala:25:30]
    .io_prev_MEM_amoResult          (_memoryStage_io_mem2wb_MEM_amoResult),	// @[CRRV/src/core/Core.scala:25:30]
  ...
  WriteBackStage writeBackStage (	// @[CRRV/src/core/Core.scala:27:30]
    .io_mem2wb_IF_instValid           (_mem2wb_io_next_IF_instValid),	// @[CRRV/src/core/Core.scala:26:30]
    .io_mem2wb_IF_pc                  (_mem2wb_io_next_IF_pc),	// @[CRRV/src/core/Core.scala:26:30]
    .io_mem2wb_ID_inst                (_mem2wb_io_next_ID_inst),	// @[CRRV/src/core/Core.scala:26:30]
    .io_mem2wb_ID_lsuOp               (_mem2wb_io_next_ID_lsuOp),	// @[CRRV/src/core/Core.scala:26:30]
    .io_mem2wb_ID_regWen              (_mem2wb_io_next_ID_regWen),	// @[CRRV/src/core/Core.scala:26:30]
    .io_mem2wb_ID_regWaddr            (_mem2wb_io_next_ID_regWaddr),	// @[CRRV/src/core/Core.scala:26:30]
    .io_mem2wb_ID_csrOp               (_mem2wb_io_next_ID_csrOp),	// @[CRRV/src/core/Core.scala:26:30]
    .io_mem2wb_ID_csrAddr             (_mem2wb_io_next_ID_csrAddr),	// @[CRRV/src/core/Core.scala:26:30]
    .io_mem2wb_ID_csrWriteData        (_mem2wb_io_next_ID_csrWriteData),	// @[CRRV/src/core/Core.scala:26:30]
    .io_mem2wb_ID_exceptType          (_mem2wb_io_next_ID_exceptType),	// @[CRRV/src/core/Core.scala:26:30]
    .io_mem2wb_EXE_exeResult          (_mem2wb_io_next_EXE_exeResult),	// @[CRRV/src/core/Core.scala:26:30]
    .io_mem2wb_MEM_excMonCommit_addr  (_mem2wb_io_next_MEM_excMonCommit_addr),	// @[CRRV/src/core/Core.scala:26:30]
    .io_mem2wb_MEM_excMonCommit_set   (_mem2wb_io_next_MEM_excMonCommit_set),	// @[CRRV/src/core/Core.scala:26:30]
    .io_mem2wb_MEM_excMonCommit_clear (_mem2wb_io_next_MEM_excMonCommit_clear),	// @[CRRV/src/core/Core.scala:26:30]
    .io_mem2wb_MEM_amoValid           (_mem2wb_io_next_MEM_amoValid),	// @[CRRV/src/core/Core.scala:26:30]
    .io_mem2wb_MEM_amoResult          (_mem2wb_io_next_MEM_amoResult),	// @[CRRV/src/core/Core.scala:26:30]
    ...
    .io_debug_valid                   (io_debug_debugInfo_valid),
  ...
  PipelineControl pipelineControl (	// @[CRRV/src/core/Core.scala:29:31]
    .io_ifStallReq           (_fetchStage_io_control_stallReq),	// @[CRRV/src/core/Core.scala:19:30]
    .io_exeStallReq          (_executeStage_io_control_stallReq),	// @[CRRV/src/core/Core.scala:23:30]
    .io_memStallReq          (_memoryStage_io_control_stallReq),	// @[CRRV/src/core/Core.scala:25:30]
    .io_idFlushReq           (_decodeStage_io_control_flushIF),	// @[CRRV/src/core/Core.scala:21:30]
    .io_idFlushTarget        (_decodeStage_io_control_flushPc),	// @[CRRV/src/core/Core.scala:21:30]
    .io_loadHazardFlage      (_hazardResolver_io_loadHazardFlag),	// @[CRRV/src/core/Core.scala:30:31]
    .io_csrHazardFlag        (_hazardResolver_io_csrHazardFlag),	// @[CRRV/src/core/Core.scala:30:31]
    .io_exceptType           (_writeBackStage_io_wb2csr_exceptType),	// @[CRRV/src/core/Core.scala:27:30]
    .io_csrInfo_mepc         (_csrFile_io_csrInfo_mepc),	// @[CRRV/src/core/Core.scala:31:31]
    .io_csrInfo_trapEnterVec (_csrFile_io_csrInfo_trapEnterVec),	// @[CRRV/src/core/Core.scala:31:31]
    .io_csrInfo_intr         (_csrFile_io_csrInfo_intr),	// @[CRRV/src/core/Core.scala:31:31]
  ...
  HazardResolver hazardResolver (	// @[CRRV/src/core/Core.scala:30:31]
    .io_regRead1_en          (_decodeStage_io_regRead1_en),	// @[CRRV/src/core/Core.scala:21:30]
    .io_regRead1_addr        (_decodeStage_io_regRead1_addr),	// @[CRRV/src/core/Core.scala:21:30]
    .io_regRead2_en          (_decodeStage_io_regRead2_en),	// @[CRRV/src/core/Core.scala:21:30]
    .io_regRead2_addr        (_decodeStage_io_regRead2_addr),	// @[CRRV/src/core/Core.scala:21:30]
    .io_csrRead_op           (_executeStage_io_csrRead_op),	// @[CRRV/src/core/Core.scala:23:30]
    .io_csrRead_addr         (_executeStage_io_csrRead_addr),	// @[CRRV/src/core/Core.scala:23:30]
    .io_regFile1_data        (_regFile_io_read1_data),	// @[CRRV/src/core/Core.scala:32:31]
    .io_regFile2_data        (_regFile_io_read2_data),	// @[CRRV/src/core/Core.scala:32:31]
    .io_regCsr_data          (_csrFile_io_read_data),	// @[CRRV/src/core/Core.scala:31:31]
    .io_exeForward_en        (_executeStage_io_regForward_en),	// @[CRRV/src/core/Core.scala:23:30]
    .io_exeForward_addr      (_executeStage_io_regForward_addr),	// @[CRRV/src/core/Core.scala:23:30]
    .io_exeForward_data      (_executeStage_io_regForward_data),	// @[CRRV/src/core/Core.scala:23:30]
    .io_exeForward_load      (_executeStage_io_regForward_load),	// @[CRRV/src/core/Core.scala:23:30]
    .io_memForward_en        (_memoryStage_io_regForward_en),	// @[CRRV/src/core/Core.scala:25:30]
    .io_memForward_addr      (_memoryStage_io_regForward_addr),	// @[CRRV/src/core/Core.scala:25:30]
    .io_memForward_data      (_memoryStage_io_regForward_data),	// @[CRRV/src/core/Core.scala:25:30]
    .io_memForward_load      (_memoryStage_io_regForward_load),	// @[CRRV/src/core/Core.scala:25:30]
    .io_wbForward_en         (_writeBackStage_io_regForward_en),	// @[CRRV/src/core/Core.scala:27:30]
    .io_wbForward_addr       (_writeBackStage_io_regForward_addr),	// @[CRRV/src/core/Core.scala:27:30]
    .io_wbForward_data       (_writeBackStage_io_regForward_data),	// @[CRRV/src/core/Core.scala:27:30]
    .io_wbExcMon_addr        (_writeBackStage_io_excMonCommit_addr),	// @[CRRV/src/core/Core.scala:27:30]
    .io_wbExcMon_set         (_writeBackStage_io_excMonCommit_set),	// @[CRRV/src/core/Core.scala:27:30]
    .io_wbExcMon_clear       (_writeBackStage_io_excMonCommit_clear),	// @[CRRV/src/core/Core.scala:27:30]
    .io_memExcMonCheck_addr  (_memoryStage_io_excMon_addr),	// @[CRRV/src/core/Core.scala:25:30]
    .io_excMonCheck_valid    (_excMon_io_check_valid),	// @[CRRV/src/core/Core.scala:33:31]
    .io_memCsrStall_op       (_memoryStage_io_memCsrStall_op),	// @[CRRV/src/core/Core.scala:25:30]
    .io_memCsrStall_addr     (_memoryStage_io_memCsrStall_addr),	// @[CRRV/src/core/Core.scala:25:30]
    .io_wbCsrStall_op        (_writeBackStage_io_wb2csr_op),	// @[CRRV/src/core/Core.scala:27:30]
    .io_wbCsrStall_addr      (_writeBackStage_io_wb2csr_addr),	// @[CRRV/src/core/Core.scala:27:30]
  ...
  CsrFile csrFile (	// @[CRRV/src/core/Core.scala:31:31]
    .clock                   (clock),
    .reset                   (reset),
    .io_read_addr            (_hazardResolver_io_regCsr_addr),	// @[CRRV/src/core/Core.scala:30:31]
    .io_write_op             (_writeBackStage_io_wb2csr_op),	// @[CRRV/src/core/Core.scala:27:30]
    .io_write_addr           (_writeBackStage_io_wb2csr_addr),	// @[CRRV/src/core/Core.scala:27:30]
    .io_write_data           (_writeBackStage_io_wb2csr_data),	// @[CRRV/src/core/Core.scala:27:30]
    .io_write_exceptType     (_writeBackStage_io_wb2csr_exceptType),	// @[CRRV/src/core/Core.scala:27:30]
    .io_write_exceptPc       (_writeBackStage_io_wb2csr_exceptPc),	// @[CRRV/src/core/Core.scala:27:30]
    .io_intr_timer           (io_intr_timer),
  ...
  RegFile regFile (	// @[CRRV/src/core/Core.scala:32:31]
    .clock            (clock),
    .io_read1_en      (_hazardResolver_io_regFile1_en),	// @[CRRV/src/core/Core.scala:30:31]
    .io_read1_addr    (_hazardResolver_io_regFile1_addr),	// @[CRRV/src/core/Core.scala:30:31]
    .io_read2_en      (_hazardResolver_io_regFile2_en),	// @[CRRV/src/core/Core.scala:30:31]
    .io_read2_addr    (_hazardResolver_io_regFile2_addr),	// @[CRRV/src/core/Core.scala:30:31]
    .io_write_en      (_writeBackStage_io_regForward_en),	// @[CRRV/src/core/Core.scala:27:30]
    .io_write_addr    (_writeBackStage_io_regForward_addr),	// @[CRRV/src/core/Core.scala:27:30]
    .io_write_data    (_writeBackStage_io_regForward_data),	// @[CRRV/src/core/Core.scala:27:30]
  ...
  ExclusiveMonitor excMon (	// @[CRRV/src/core/Core.scala:33:31]
    .clock           (clock),
    .reset           (reset),
    .io_flush        (_pipelineControl_io_flushAll),	// @[CRRV/src/core/Core.scala:29:31]
    .io_check_addr   (_hazardResolver_io_excMonCheck_addr),	// @[CRRV/src/core/Core.scala:30:31]
    .io_update_addr  (_writeBackStage_io_excMonCommit_addr),	// @[CRRV/src/core/Core.scala:27:30]
    .io_update_set   (_writeBackStage_io_excMonCommit_set),	// @[CRRV/src/core/Core.scala:27:30]
    .io_update_clear (_writeBackStage_io_excMonCommit_clear),	// @[CRRV/src/core/Core.scala:27:30]
    .io_check_valid  (_excMon_io_check_valid)
  );
  assign io_debug_intr = io_intr_timer;	// @[<stdin>:2702:10]
endmodule

module AXI4Arbiter(	// @[<stdin>:2831:10]
  input         clock,	// @[<stdin>:2832:11]
                reset,	// @[<stdin>:2833:11]
  ...
  always @(posedge clock) begin	// @[<stdin>:2832:11]
    if (reset)	// @[<stdin>:2832:11]
      state <= 3'h0;	// @[CRRV/src/bus/AXI4Arbiter.scala:30:46]
    else	// @[<stdin>:2832:11]
      state <= casez_tmp;	// @[CRRV/src/bus/AXI4Arbiter.scala:30:46, :31:17, :33:39]
  end // always @(posedge)
  assign io_axiInst_ar_ready = selInst & io_axiOut_ar_ready;	// @[<stdin>:2831:10, CRRV/src/bus/AXI4Arbiter.scala:61:40, :64:28]
  assign io_axiInst_r_valid = _io_axiInst_r_valid_output;	// @[<stdin>:2831:10, CRRV/src/bus/AXI4Arbiter.scala:65:28]
  assign io_axiInst_r_bits_data = io_axiOut_r_bits_data;	// @[<stdin>:2831:10]
  assign io_axiInst_r_bits_last = io_axiOut_r_bits_last;	// @[<stdin>:2831:10]
  assign io_axiData_ar_ready = selData & io_axiOut_ar_ready;	// @[<stdin>:2831:10, CRRV/src/bus/AXI4Arbiter.scala:58:59, :72:28]
  assign io_axiData_r_valid = _io_axiData_r_valid_output;	// @[<stdin>:2831:10, CRRV/src/bus/AXI4Arbiter.scala:73:28]
  assign io_axiData_r_bits_data = io_axiOut_r_bits_data;	// @[<stdin>:2831:10]
  assign io_axiData_r_bits_last = io_axiOut_r_bits_last;	// @[<stdin>:2831:10]
  assign io_axiData_aw_ready = selData & io_axiOut_aw_ready;	// @[<stdin>:2831:10, CRRV/src/bus/AXI4Arbiter.scala:58:59, :74:28]
  assign io_axiData_w_ready = selData & io_axiOut_w_ready;	// @[<stdin>:2831:10, CRRV/src/bus/AXI4Arbiter.scala:58:59, :75:28]
  assign io_axiOut_ar_valid = selData ? io_axiData_ar_valid : io_axiInst_ar_valid;	// @[<stdin>:2831:10, CRRV/src/bus/AXI4Arbiter.scala:58:59, :80:22]
  assign io_axiOut_ar_bits_addr =
    selData ? io_axiData_ar_bits_addr : io_axiInst_ar_bits_addr;	// @[<stdin>:2831:10, CRRV/src/bus/AXI4Arbiter.scala:58:59, :86:21]
  assign io_axiOut_ar_bits_size =
    selData ? io_axiData_ar_bits_size : io_axiInst_ar_bits_size;	// @[<stdin>:2831:10, CRRV/src/bus/AXI4Arbiter.scala:58:59, :86:21]
  assign io_axiOut_aw_valid = selData ? io_axiData_aw_valid : io_axiInst_aw_valid;	// @[<stdin>:2831:10, CRRV/src/bus/AXI4Arbiter.scala:58:59, :82:22]
  assign io_axiOut_aw_bits_addr =
    selData ? io_axiData_aw_bits_addr : io_axiInst_aw_bits_addr;	// @[<stdin>:2831:10, CRRV/src/bus/AXI4Arbiter.scala:58:59, :87:21]
  assign io_axiOut_aw_bits_size =
    selData ? io_axiData_aw_bits_size : io_axiInst_aw_bits_size;	// @[<stdin>:2831:10, CRRV/src/bus/AXI4Arbiter.scala:58:59, :87:21]
  assign io_axiOut_w_valid = selData ? io_axiData_w_valid : io_axiInst_w_valid;	// @[<stdin>:2831:10, CRRV/src/bus/AXI4Arbiter.scala:58:59, :83:22]
  assign io_axiOut_w_bits_data =
    selData ? io_axiData_w_bits_data : io_axiInst_w_bits_data;	// @[<stdin>:2831:10, CRRV/src/bus/AXI4Arbiter.scala:58:59, :88:21]
  assign io_axiOut_w_bits_strb =
    selData ? io_axiData_w_bits_strb : io_axiInst_w_bits_strb;	// @[<stdin>:2831:10, CRRV/src/bus/AXI4Arbiter.scala:58:59, :88:21]
  assign io_axiOut_w_bits_last =
    selData ? io_axiData_w_bits_last : io_axiInst_w_bits_last;	// @[<stdin>:2831:10, CRRV/src/bus/AXI4Arbiter.scala:58:59, :88:21]
endmodule

module SimpleMux2(	// @[<stdin>:2947:10]
  input         clock,	// @[<stdin>:2948:11]
  ...
  always @(posedge clock)	// @[<stdin>:2948:11]
    readSel <= io_sel2;	// @[CRRV/src/bus/SimpleUtils.scala:16:24]
  assign io_in_out_ready = io_sel2 | io_out1_out_ready;	// @[<stdin>:2947:10, CRRV/src/bus/SimpleUtils.scala:20:25]
  assign io_in_in_rdata = readSel ? io_out2_in_rdata : io_out1_in_rdata;	// @[<stdin>:2947:10, CRRV/src/bus/SimpleUtils.scala:16:24, :18:24]
  assign io_out1_out_valid = io_in_out_valid & ~io_sel2;	// @[<stdin>:2947:10, CRRV/src/bus/SimpleUtils.scala:22:{40,43}]
  assign io_out1_out_bits_addr = io_in_out_bits_addr;	// @[<stdin>:2947:10]
  assign io_out1_out_bits_writeEn = io_in_out_bits_writeEn;	// @[<stdin>:2947:10]
  assign io_out1_out_bits_size = io_in_out_bits_size;	// @[<stdin>:2947:10]
  assign io_out1_out_bits_wdata = io_in_out_bits_wdata;	// @[<stdin>:2947:10]
  assign io_out2_out_valid = io_in_out_valid & io_sel2;	// @[<stdin>:2947:10, CRRV/src/bus/SimpleUtils.scala:25:40]
  assign io_out2_out_bits_addr = io_in_out_bits_addr;	// @[<stdin>:2947:10]
  assign io_out2_out_bits_writeEn = io_in_out_bits_writeEn;	// @[<stdin>:2947:10]
  assign io_out2_out_bits_wdata = io_in_out_bits_wdata;	// @[<stdin>:2947:10]
endmodule

module SimpleXbar(	// @[<stdin>:2967:10]
  input         clock,	// @[<stdin>:2968:11]
...
module CLINT(	// @[<stdin>:2988:10]
  input         clock,	// @[<stdin>:2989:11]
                reset,	// @[<stdin>:2990:11]
  ...
  reg  [31:0] outputData;	// @[CRRV/src/bus/CLINT.scala:36:27]
  wire        writeEn = io_core_out_valid & io_core_out_bits_writeEn;	// @[CRRV/src/bus/CLINT.scala:32:32]
  always @(posedge clock) begin	// @[<stdin>:2989:11]
    if (reset) begin	// @[<stdin>:2989:11]
      ...
      outputData <= 32'h0;	// @[CRRV/src/bus/CLINT.scala:22:28, :36:27]
    end
    else begin	// @[<stdin>:2989:11]
      if (tick == 8'h2) begin	// @[CRRV/src/bus/CLINT.scala:25:28, :27:13]
        mtime <= mtime + 64'h1;	// @[CRRV/src/bus/CLINT.scala:21:28, :29:20]
        tick <= 8'h0;	// @[CRRV/src/bus/CLINT.scala:25:28]
      end
      else	// @[CRRV/src/bus/CLINT.scala:27:13]
        tick <= tick + 8'h1;	// @[CRRV/src/bus/CLINT.scala:25:28, :26:16]
      if (io_core_out_bits_addr[15:0] == 16'h4000 & writeEn)	// @[CRRV/src/bus/CLINT.scala:32:32, :33:{26,34,48}]
        timermatchl <= io_core_out_bits_wdata;	// @[CRRV/src/bus/CLINT.scala:22:28]
      if (io_core_out_bits_addr[15:0] == 16'h4004 & writeEn)	// @[CRRV/src/bus/CLINT.scala:32:32, :33:26, :34:{34,48}]
        timermatchh <= io_core_out_bits_wdata;	// @[CRRV/src/bus/CLINT.scala:23:28]
      if (io_core_out_bits_addr[15:0] == 16'hBFF8)	// @[CRRV/src/bus/CLINT.scala:33:26, :40:20]
        outputData <= mtime[31:0];	// @[CRRV/src/bus/CLINT.scala:21:28, :36:27, :40:44]
      else if (io_core_out_bits_addr[15:0] == 16'hBFFC)	// @[CRRV/src/bus/CLINT.scala:33:26, :41:20]
        outputData <= mtime[63:32];	// @[CRRV/src/bus/CLINT.scala:21:28, :36:27, :41:44]
      else	// @[CRRV/src/bus/CLINT.scala:41:20]
        outputData <= 32'h0;	// @[CRRV/src/bus/CLINT.scala:22:28, :36:27]
    end
  end // always @(posedge)
  assign io_core_in_rdata = outputData;	// @[<stdin>:2988:10, CRRV/src/bus/CLINT.scala:36:27]
  assign io_intr = (|timermatch) & mtime >= timermatch;	// @[<stdin>:2988:10, CRRV/src/bus/CLINT.scala:21:28, :24:24, :47:{33,42,52}]
endmodule

module SimpleAlignment(	// @[<stdin>:3040:10]
  input         clock,	// @[<stdin>:3041:11]
                reset,	// @[<stdin>:3042:11]
  ...
  always @(posedge clock) begin	// @[<stdin>:3041:11]
    if (reset) begin	// @[<stdin>:3041:11]
  ...
  assign io_in_out_ready = direct ? io_out_out_ready : state == 3'h3;	// @[<stdin>:3040:10, CRRV/src/bus/SimpleAlignment.scala:24:42, :35:36, :60:15, :84:{26,59}]
  assign io_in_in_rdata =
    direct ? io_out_in_rdata >> {27'h0, lastRaddr[1:0], 3'h0} : nowRdata;	// @[<stdin>:3040:10, CRRV/src/bus/SimpleAlignment.scala:18:26, :20:{35,42,52}, :31:42, :35:36, :81:24]
  assign io_out_out_valid = direct ? io_in_out_valid : nowValid;	// @[<stdin>:3040:10, CRRV/src/bus/SimpleAlignment.scala:27:42, :35:36, :83:26]
  assign io_out_out_bits_addr = direct ? io_in_out_bits_addr : nowAddr;	// @[<stdin>:3040:10, CRRV/src/bus/SimpleAlignment.scala:28:42, :35:36, :85:26]
  assign io_out_out_bits_writeEn = direct ? io_in_out_bits_writeEn : nowWen;	// @[<stdin>:3040:10, CRRV/src/bus/SimpleAlignment.scala:29:42, :35:36, :87:26]
  assign io_out_out_bits_size = direct ? io_in_out_bits_size : 2'h0;	// @[<stdin>:3040:10, CRRV/src/bus/SimpleAlignment.scala:35:36, :86:26]
  assign io_out_out_bits_wdata = direct ? io_in_out_bits_wdata : nowWdata;	// @[<stdin>:3040:10, CRRV/src/bus/SimpleAlignment.scala:30:42, :35:36, :88:26]
endmodule

module Simple2AXI4(	// @[<stdin>:3152:10, :3273:10]
  input         clock,	// @[<stdin>:3153:11, :3274:11]
                reset,	// @[<stdin>:3154:11, :3275:11]
  ...
  always @(posedge clock) begin	// @[<stdin>:3153:11, :3274:11]
    if (reset)	// @[<stdin>:3153:11, :3274:11]
      state <= 3'h0;	// @[CRRV/src/bus/Simple2AXI4.scala:28:30]
    else	// @[<stdin>:3153:11, :3274:11]
  ...
  assign io_simple_out_ready =
    state == 3'h5
    & addr == (_simple_addr_T_1 ? io_simple_out_bits_addr : _simple_addr_T_3);	// @[<stdin>:3152:10, :3273:10, CRRV/src/bus/Simple2AXI4.scala:19:24, :20:37, :22:8, :28:30, :31:18, :48:15, :68:{33,43,52}]
  assign io_simple_in_rdata = addr[2] ? rdata[63:32] : rdata[31:0];	// @[<stdin>:3152:10, :3273:10, CRRV/src/bus/Simple2AXI4.scala:30:18, :31:18, :69:{29,34,44,59}]
  assign io_axi_ar_valid = state == 3'h1;	// @[<stdin>:3152:10, :3273:10, CRRV/src/bus/Simple2AXI4.scala:28:30, :36:21, :82:32]
  assign io_axi_ar_bits_addr = addr;	// @[<stdin>:3152:10, :3273:10, CRRV/src/bus/Simple2AXI4.scala:31:18]
  assign io_axi_ar_bits_size = _GEN_1;	// @[<stdin>:3152:10, :3273:10, CRRV/src/bus/Simple2AXI4.scala:84:23]
  assign io_axi_aw_valid = _io_axi_w_bits_last_T;	// @[<stdin>:3152:10, :3273:10, CRRV/src/bus/Simple2AXI4.scala:86:32]
  assign io_axi_aw_bits_addr = addr;	// @[<stdin>:3152:10, :3273:10, CRRV/src/bus/Simple2AXI4.scala:31:18]
  assign io_axi_aw_bits_size = _GEN_1;	// @[<stdin>:3152:10, :3273:10, CRRV/src/bus/Simple2AXI4.scala:84:23]
  assign io_axi_w_valid = _io_axi_w_bits_last_T | _io_axi_w_bits_last_T_1;	// @[<stdin>:3152:10, :3273:10, CRRV/src/bus/Simple2AXI4.scala:86:32, :89:{43,52}]
  assign io_axi_w_bits_data = {2{io_simple_out_bits_wdata}};	// @[<stdin>:3152:10, :3273:10, CRRV/src/bus/Simple2AXI4.scala:71:21]
  assign io_axi_w_bits_strb = casez_tmp_0[7:0];	// @[<stdin>:3152:10, :3273:10, CRRV/src/bus/Simple2AXI4.scala:73:39, :92:23]
  assign io_axi_w_bits_last = _io_axi_w_bits_last_T | _io_axi_w_bits_last_T_1;	// @[<stdin>:3152:10, :3273:10, CRRV/src/bus/Simple2AXI4.scala:86:32, :89:52, :91:43]
endmodule

// external module Debug

module CRRVTop(	// @[<stdin>:3400:10]
  input         clock,	// @[<stdin>:3401:11]
                reset,	// @[<stdin>:3402:11]
  ...
  assign io_master_awid = 4'h0;	// @[<stdin>:3400:10, CRRV/src/CRRVTop.scala:15:31, :19:31, :20:31]
  assign io_master_awlen = 8'h0;	// @[<stdin>:3400:10, CRRV/src/CRRVTop.scala:15:31, :19:31, :20:31]
  assign io_master_awburst = 2'h0;	// @[<stdin>:3400:10, CRRV/src/CRRVTop.scala:15:31, :19:31, :20:31]
  assign io_master_bready = 1'h1;	// @[<stdin>:3400:10, CRRV/src/CRRVTop.scala:13:20, :15:31, :16:31, :17:31, :19:31, :20:31]
  assign io_master_arid = 4'h0;	// @[<stdin>:3400:10, CRRV/src/CRRVTop.scala:15:31, :19:31, :20:31]
  assign io_master_arlen = 8'h0;	// @[<stdin>:3400:10, CRRV/src/CRRVTop.scala:15:31, :19:31, :20:31]
  assign io_master_arburst = 2'h0;	// @[<stdin>:3400:10, CRRV/src/CRRVTop.scala:15:31, :19:31, :20:31]
  assign io_master_rready = 1'h1;	// @[<stdin>:3400:10, CRRV/src/CRRVTop.scala:13:20, :15:31, :16:31, :17:31, :19:31, :20:31]
  assign io_slave_awready = 1'h0;	// @[<stdin>:3400:10, CRRV/src/CRRVTop.scala:13:20, :15:31, :19:31]
  assign io_slave_wready = 1'h0;	// @[<stdin>:3400:10, CRRV/src/CRRVTop.scala:13:20, :15:31, :19:31]
  assign io_slave_bvalid = 1'h0;	// @[<stdin>:3400:10, CRRV/src/CRRVTop.scala:13:20, :15:31, :19:31]
  assign io_slave_bresp = 2'h0;	// @[<stdin>:3400:10, CRRV/src/CRRVTop.scala:15:31, :19:31, :20:31]
  assign io_slave_bid = 4'h0;	// @[<stdin>:3400:10, CRRV/src/CRRVTop.scala:15:31, :19:31, :20:31]
  assign io_slave_arready = 1'h0;	// @[<stdin>:3400:10, CRRV/src/CRRVTop.scala:13:20, :15:31, :19:31]
  assign io_slave_rvalid = 1'h0;	// @[<stdin>:3400:10, CRRV/src/CRRVTop.scala:13:20, :15:31, :19:31]
  assign io_slave_rresp = 2'h0;	// @[<stdin>:3400:10, CRRV/src/CRRVTop.scala:15:31, :19:31, :20:31]
  assign io_slave_rdata = 64'h0;	// @[<stdin>:3400:10, CRRV/src/CRRVTop.scala:85:20]
  assign io_slave_rlast = 1'h0;	// @[<stdin>:3400:10, CRRV/src/CRRVTop.scala:13:20, :15:31, :19:31]
  assign io_slave_rid = 4'h0;	// @[<stdin>:3400:10, CRRV/src/CRRVTop.scala:15:31, :19:31, :20:31]
endmodule
