...
module FetchStage(	// @[<stdin>:3:10]
  ...
  always @(posedge clock) begin	// @[<stdin>:4:11]
    if (reset)	// @[<stdin>:4:11]
      pc <= 32'h80000000;	// @[CRRV/src/core/pipeline/FetchStage.scala:15:19]
...
module Simple2AXI4(	// @[<stdin>:2013:10]
  ...
  always_comb begin	// @[CRRV/src/bus/Simple2AXI4.scala:21:30, :26:17, :28:30, :34:29, :39:50, :45:29, :50:28, :55:13]
    casez (state)	// @[CRRV/src/bus/Simple2AXI4.scala:21:30, :26:17, :28:30, :34:29, :39:50, :45:29, :50:28, :55:13]
      3'b000:
        casez_tmp = io_simple_enable ? {1'h0, |io_simple_wen, 1'h1} : state;	// @[CRRV/src/bus/Simple2AXI4.scala:21:30, :26:17, :28:30, :29:{15,21,36}, :34:29, :39:50, :45:29, :50:28, :55:13]
      3'b001:
        casez_tmp = io_axi_ar_ready ? 3'h2 : state;	// @[CRRV/src/bus/Simple2AXI4.scala:21:30, :26:17, :28:30, :34:29, :35:15, :39:50, :45:29, :50:28, :55:13]
      3'b010:
        casez_tmp = _GEN ? 3'h5 : state;	// @[CRRV/src/bus/Simple2AXI4.scala:21:30, :26:17, :28:30, :34:29, :39:{27,50}, :41:15, :45:29, :50:28, :55:13]
      3'b011:
        casez_tmp = io_axi_aw_ready ? 3'h4 : state;	// @[CRRV/src/bus/Simple2AXI4.scala:21:30, :26:17, :28:30, :34:29, :39:50, :45:29, :46:15, :50:28, :55:13]
      3'b100:
        casez_tmp = io_axi_w_ready ? 3'h5 : state;	// @[CRRV/src/bus/Simple2AXI4.scala:21:30, :26:17, :28:30, :34:29, :39:50, :41:15, :45:29, :50:28, :51:15, :55:13]
      3'b101:
        casez_tmp = 3'h0;	// @[CRRV/src/bus/Simple2AXI4.scala:21:30, :26:17, :28:30, :34:29, :39:50, :45:29, :50:28, :55:13]
      3'b110:
        casez_tmp = state;	// @[CRRV/src/bus/Simple2AXI4.scala:21:30, :26:17, :28:30, :34:29, :39:50, :45:29, :50:28, :55:13]
      default:
        casez_tmp = state;	// @[CRRV/src/bus/Simple2AXI4.scala:21:30, :26:17, :28:30, :34:29, :39:50, :45:29, :50:28, :55:13]
    endcase	// @[CRRV/src/bus/Simple2AXI4.scala:21:30, :26:17, :28:30, :34:29, :39:50, :45:29, :50:28, :55:13]
  end // always_comb
  wire        _io_axi_w_bits_last_T = state == 3'h4;	// @[CRRV/src/bus/Simple2AXI4.scala:21:30, :46:15, :72:33]
  ...
  assign io_simple_valid = state == 3'h5 & addr == io_simple_addr;	// @[<stdin>:2013:10, CRRV/src/bus/Simple2AXI4.scala:21:30, :24:18, :41:15, :59:{29,39,48}]
  assign io_simple_rdata = rdata;	// @[<stdin>:2013:10, CRRV/src/bus/Simple2AXI4.scala:23:18]
  assign io_axi_ar_valid = state == 3'h1;	// @[<stdin>:2013:10, CRRV/src/bus/Simple2AXI4.scala:21:30, :29:21, :64:33]
  assign io_axi_ar_bits_addr = addr;	// @[<stdin>:2013:10, CRRV/src/bus/Simple2AXI4.scala:24:18]
  assign io_axi_aw_valid = state == 3'h3;	// @[<stdin>:2013:10, CRRV/src/bus/Simple2AXI4.scala:21:30, :29:21, :69:33]
  assign io_axi_aw_bits_addr = addr;	// @[<stdin>:2013:10, CRRV/src/bus/Simple2AXI4.scala:24:18]
  assign io_axi_w_valid = _io_axi_w_bits_last_T;	// @[<stdin>:2013:10, CRRV/src/bus/Simple2AXI4.scala:72:33]
  assign io_axi_w_bits_data = io_simple_wdata;	// @[<stdin>:2013:10]
  assign io_axi_w_bits_strb = io_simple_wen;	// @[<stdin>:2013:10]
  assign io_axi_w_bits_last = _io_axi_w_bits_last_T;	// @[<stdin>:2013:10, CRRV/src/bus/Simple2AXI4.scala:72:33]
endmodule

// external module Debug

module CRRVTop(	// @[<stdin>:2110:10]
  input         clock,	// @[<stdin>:2111:11]
                reset,	// @[<stdin>:2112:11]
  ...
  assign io_master_awid = 4'h0;	// @[<stdin>:2110:10, CRRV/src/CRRVTop.scala:13:26, :14:26, :15:26]
  assign io_master_awlen = 8'h0;	// @[<stdin>:2110:10, CRRV/src/CRRVTop.scala:15:26]
  assign io_master_awsize = 3'h2;	// @[<stdin>:2110:10, CRRV/src/CRRVTop.scala:15:26]
  assign io_master_awburst = 2'h0;	// @[<stdin>:2110:10, CRRV/src/CRRVTop.scala:15:26]
  assign io_master_wdata = {32'h0, _simple2axi_io_axi_w_bits_data};	// @[<stdin>:2110:10, CRRV/src/CRRVTop.scala:15:26, :39:21]
  assign io_master_wstrb = {4'h0, _simple2axi_io_axi_w_bits_strb};	// @[<stdin>:2110:10, CRRV/src/CRRVTop.scala:13:26, :14:26, :15:26, :40:21]
  assign io_master_bready = 1'h1;	// @[<stdin>:2110:10, CRRV/src/CRRVTop.scala:13:26, :14:26, :15:26]
  assign io_master_arid = 4'h0;	// @[<stdin>:2110:10, CRRV/src/CRRVTop.scala:13:26, :14:26, :15:26]
  assign io_master_arlen = 8'h0;	// @[<stdin>:2110:10, CRRV/src/CRRVTop.scala:15:26]
  assign io_master_arsize = 3'h2;	// @[<stdin>:2110:10, CRRV/src/CRRVTop.scala:15:26]
  assign io_master_arburst = 2'h1;	// @[<stdin>:2110:10, CRRV/src/CRRVTop.scala:15:26]
  assign io_master_rready = 1'h1;	// @[<stdin>:2110:10, CRRV/src/CRRVTop.scala:13:26, :14:26, :15:26]
  assign io_slave_awready = 1'h0;	// @[<stdin>:2110:10, CRRV/src/CRRVTop.scala:63:20]
  assign io_slave_wready = 1'h0;	// @[<stdin>:2110:10, CRRV/src/CRRVTop.scala:63:20]
  assign io_slave_bvalid = 1'h0;	// @[<stdin>:2110:10, CRRV/src/CRRVTop.scala:63:20]
  assign io_slave_bresp = 2'h0;	// @[<stdin>:2110:10, CRRV/src/CRRVTop.scala:15:26]
  assign io_slave_bid = 4'h0;	// @[<stdin>:2110:10, CRRV/src/CRRVTop.scala:13:26, :14:26, :15:26]
  assign io_slave_arready = 1'h0;	// @[<stdin>:2110:10, CRRV/src/CRRVTop.scala:63:20]
  assign io_slave_rvalid = 1'h0;	// @[<stdin>:2110:10, CRRV/src/CRRVTop.scala:63:20]
  assign io_slave_rresp = 2'h0;	// @[<stdin>:2110:10, CRRV/src/CRRVTop.scala:15:26]
  assign io_slave_rdata = 64'h0;	// @[<stdin>:2110:10, CRRV/src/CRRVTop.scala:71:20]
  assign io_slave_rlast = 1'h0;	// @[<stdin>:2110:10, CRRV/src/CRRVTop.scala:63:20]
  assign io_slave_rid = 4'h0;	// @[<stdin>:2110:10, CRRV/src/CRRVTop.scala:13:26, :14:26, :15:26]
endmodule
